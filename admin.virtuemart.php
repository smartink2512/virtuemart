...
if( $only_page != 1 && $vmLayout == 'extended') {
	...
	echo '<iframe id="vmPage" name="vmPage" src="'.$mosConfig_live_site.'/administrator/index3.php?option=com_virtuemart&page='.$_SESSION['last_page'].'" style="min-width:500px;min-height:800px; border: 1px solid silver;padding:4px;"></iframe>';
