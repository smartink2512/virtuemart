...
<h3><?php echo $browsepage_lbl; ?> 
	...
	<a href="index.php?option=<?php echo JM_COMPONENT_NAME ?>&amp;page=shop.feed&amp;category_id=<?php echo $category_id ?>" title="<?php echo JText::_('JM_FEED_SUBSCRIBE_TOCATEGORY_TITLE') ?>">
