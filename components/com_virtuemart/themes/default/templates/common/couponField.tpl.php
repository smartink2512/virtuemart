...
?>  
	    <form action="<?php echo $mm_action_url . basename( $_SERVER['PHP_SELF']) ?>" method="post" onsubmit="return checkCouponField(this);">
			...
			<input type="submit" value="<?php echo JText::_('JM_COUPON_SUBMIT_BUTTON') ?>" class="button" />
		</form>		
		</td>
	</tr>
</table>
