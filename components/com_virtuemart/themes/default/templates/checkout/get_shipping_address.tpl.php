...
<div class="sectiontableheader" style="width: 100%; align: left; float: left;"> <?php echo JText::_('JM_ORDER_PRINT_CUST_SHIPPING_LBL') ?></div>

<div style="width: 100%; align:left; float:left;">
<?php
$varname = 'JM_CHECKOUT_MSG_' . CHECK_OUT_GET_SHIPPING_ADDR;
