...
if (!empty($this->products) ) {
	...
	echo shopFunctionsF::renderVmSubLayout('products',array($this->productsLayout=>$this->products,'currency'=>$this->currency,'products_per_row'=>$products_per_row,'showRating'=>$this->showRating)); //$this->loadTemplate('products');
}
