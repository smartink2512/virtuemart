...
class VirtueMartViewCart extends VmView {
	...
	private function prepareContinueLink() {
		...
		$continue_link = JRoute::_('index.php?option=com_virtuemart&view=category' . $categoryLink.$menuid);
		...
		$cart_link = JRoute::_('index.php?option=com_virtuemart&view=cart'.$menuid);
