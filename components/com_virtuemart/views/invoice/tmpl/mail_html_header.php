...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
	...
	<tr>
		<?php if ($this->vendor->vendor_letter_header_image>0) { ?>
			<td class="vmdoc-header-image"><img src="<?php echo vUri::root () . $this->vendor->images[0]->file_url ?>" style="width: <?php echo $this->vendor->vendor_letter_header_imagesize; ?>mm;" /></td>
