...
$formObj = &new formFactory( JText::_('JM_TAX_FORM_LBL') );
//Then Start the form
$formObj->startForm();
...
<table class="adminform">
    <tr> 
      <td><b><?php echo JText::_('JM_TAX_FORM_LBL') ?></b></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td align="right" ><?php echo JText::_('JM_TAX_FORM_COUNTRY') ?>:</td>
      <td>
    ...
    <tr> 
      <td align="right" ><?php echo JText::_('JM_TAX_FORM_STATE') ?>:</td>
      <td><?php 
    ...
    <tr> 
      <td align="right" ><?php echo JText::_('JM_TAX_FORM_RATE') ?>:</td>
      <td> 
