...
$formObj = &new formFactory( JText::_('JM_MODULE_FORM_LBL') );
//Then Start the form
$formObj->startForm();
?> 
<table class="adminform">
    <tr> 
      <td width="24%" align="right" ><?php echo JText::_('JM_MODULE_FORM_NAME') ?>:</td>
      <td width="76%" > 
    ...
    <tr> 
      <td width="24%" align="right" ><?php echo JText::_('JM_MODULE_FORM_PERMS') ?>:</td>
      <td width="76%" > 
        <?php
    ...
    <tr> 
      <td width="24%" align="right" ><?php echo JText::_('JM_MODULE_FORM_MENU') ?>:</td>
      <td width="76%">
      	<?php echo ps_html::yesNoSelectList('module_publish', $db->f('module_publish'), 'Y', 'N') ?> 
      </td>
    </tr>
    <tr> 
      <td width="24%" align="right"><?php echo JText::_('JM_MODULE_FORM_ORDER') ?>:</td>
      <td width="76%" > 
    ...
    <tr> 
      <td valign="top" align="right" ><?php echo JText::_('JM_MODULE_FORM_DESCRIPTION') ?>:</td>
      <td valign="top" >&nbsp;</td>
    </tr>
    <tr align="center"> 
