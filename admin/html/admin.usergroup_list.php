...
$listObj->writeSearchHeader(JText::_('JM_USERGROUP_LIST_LBL'), JM_ADMIN_ICON_URL.'icon_48/jm_shoppers_48.png', "admin", "usergroup_list");
...
$columns = Array(  "#" => "", 
					...
					JText::_('JM_USERGROUP_NAME') => "width=\"40%\"",
					JText::_('JM_USERGROUP_LEVEL') => "width=\"20%\"",
