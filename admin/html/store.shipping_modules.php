...
$ps_shipping_method = new vmshippingMethod;
 ...
 <table width="100%" cellspacing="0" cellpadding="4" border="0">
  <tr>
    <td>
      <br />&nbsp;&nbsp;&nbsp;<img src="<?php echo JM_ADMIN_ICON_URL ?>icon_48/jm_ups_48.png" border="0" />
      <br /><br />
    </td>
    <td><span class="sectionname"><?php echo JText::_('JM_SHIPPING_MODULE_LIST_LBL') ?></span></td>
  </tr>
</table>
...
?>
  <table width="100%" class="adminlist">
    <tr> 
      <th width="20">#</th>
      <th width="20"><?php echo ucfirst(JText::_('JM_ENABLED')).'?' ?></th>
      <th class="title"><?php echo JText::_('JM_SHIPPING_MODULE_LIST_NAME') ?></th>
      <th class="title"><?php echo JText::_('JM_SHIPPING_MODULE_LIST_E_VERSION') ?></th>
      <th class="title"><?php echo JText::_('JM_SHIPPING_MODULE_LIST_HEADER_AUTHOR') ?></th>
      <th class="title"><?php echo JText::_('URL') ?></th>
      <th class="title"><?php echo JText::_('CMN_EMAIL') ?></th>
      <th class="title"><?php echo JText::_('JM_PRODUCT_DESC_TITLE') ?></th>
    </tr>
<?php
    $i = 0;
      ...
      <tr class="row<?php echo $i%2 ?>"> 
        ...
        <td><?php 
          if( in_array($row['name'], $PSHOP_SHIPPING_MODULES ) )
            echo "<img src=\"$mosConfig_live_site/administrator/images/tick.png\" border=\"0\" alt=\"" . JText::_('JM_ISSHIP_LIST_PUBLISH_LBL') . "\"  align=\"center\"/>";
        ?></td>
        <td width="19%"><?php
        echo $row["name"];
        echo "<br/>"; 
        ...
        if( $row['name'] != 'no_shipping' ) {
        	echo JText::_('JM_ISSHIP_FORM_UPDATE_LBL')."</a>";
        }
