...
$formObj = &new formFactory( JText::_('JM_ZONE_MOD') );
//Then Start the form
$formObj->startForm();
...
<table class="adminform">
	<tr>
		<td valign="top">
			<div align="right"><strong><?php echo JText::_('JM_ZONE_FORM_NAME_LBL');?>:&nbsp;</strong></div>
		</td>
		<td valign="top">
	...
	<tr>
		<td valign="top">
			<div align="right"><strong><?php echo JText::_('JM_ZONE_FORM_DESC_LBL');?>:&nbsp;</strong></div>
		</td>
		<td valign="top">
	...
	<tr>
	  <td valign="top">
		  <div align="right"><strong><?php echo JText::_('JM_ZONE_FORM_COST_PER_LBL');?>:&nbsp;</strong></div>
	  </td>
	  <td valign="top">
	...
	<tr>
	  <td valign="top">
		  <div align="right"><strong><?php echo JText::_('JM_ZONE_FORM_COST_LIMIT_LBL');?>:&nbsp;</strong></div>
	  </td>
	  <td valign="top">
	...
	<tr>
	  <td><div align="right"><strong><?php echo JText::_('JM_UPS_TAX_CLASS') ?></strong></div></td>
	  <td>
		<?php
		require_once(CLASSPATH.'ps_tax.php');
		ps_tax::list_tax_value("zone_tax_rate", $db->sf("zone_tax_rate")) ;
		echo mm_ToolTip(JText::_('JM_UPS_TAX_CLASS_TOOLTIP')) ?>
	  </td>
	</tr>	
	<tr>
