...
<table width="100%" class="adminlist">
  <tr > 
    <th width="23%"><?php echo JText::_('JM_SHOPPER_LIST_USERNAME') ?></th>
    <th width="46%"><?php echo JText::_('JM_SHOPPER_LIST_NAME') ?></th>
    <th width="31%"><?php echo JText::_('JM_SHOPPER_LIST_GROUP') ?></th>
  </tr>
  <tr> 
    <td colspan="3"> 
      <hr>
