...
$listObj->writeSearchHeader(JText::_('JM_ORDER_EXPORT_MODULE_LIST_LBL'), IMAGEURL."ps_image/modules.gif", $modulename, "export_list");
...
JText::_('JM_ORDER_EXPORT_MODULE_LIST_NAME') => '',
JText::_('JM_ORDER_EXPORT_MODULE_LIST_DESC') => '',
