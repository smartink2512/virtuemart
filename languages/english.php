...
/**
* @version $Id: english.php,v 1.40 2005/09/06 19:28:36 soeren_nb Exp $
...
class phpShopLanguage extends mosAbstractLanguage {
    ...
    var $_PHPSHOP_PRODUCT_FORM_WEIGHT_UOM_DEFAULT = "pounds"; // Changed - Added
    var $_PHPSHOP_PRODUCT_FORM_DIMENSION_UOM_DEFAULT = "inches"; // Changed - Added
    /** Packaging */
    var $_PHPSHOP_PRODUCT_FORM_UNIT = "Unit"; // Changed - Added
    var $_PHPSHOP_PRODUCT_FORM_UNIT_DEFAULT = "piece"; // Changed - Added
    var $_PHPSHOP_PRODUCT_FORM_PACKAGING = "Units in Packaging"; // Changed - Added
    var $_PHPSHOP_PRODUCT_FORM_PACKAGING_DESCRIPTION = "Here you can fill in a number unit in packaging. (max. 65535)"; // Changed - Added
    var $_PHPSHOP_PRODUCT_FORM_BOX = "Units in Box"; // Changed - Added
    var $_PHPSHOP_PRODUCT_FORM_BOX_DESCRIPTION = "Here you can fill in a number unit in box. (max. 65535)"; // Changed - Added
