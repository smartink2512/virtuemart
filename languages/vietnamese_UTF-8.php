...
class phpShopLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_ACCOUNT_TITLE = 'T� i khoản của tôi';
	...
	var $_PHPSHOP_PRODUCT_SEARCH_LBL = 'Tìm sản phẩm';
	...
	var $_PHPSHOP_CART_ADD_TO = 'Thêm v� o giỏ';
	var $_PHPSHOP_CART_NAME = 'Tên';
	var $_PHPSHOP_CART_SKU = 'SKU';
	var $_PHPSHOP_CART_PRICE = 'Giá';
	var $_PHPSHOP_CART_QUANTITY = 'Số lượng';
	var $_PHPSHOP_CART_SUBTOTAL = 'Tổng phụ';
	var $_PHPSHOP_ADD_SHIPTO_1 = 'Thêm mới';
	var $_PHPSHOP_ADD_SHIPTO_2 = 'Địa chỉ giao h� ng';
	var $_PHPSHOP_NO_SEARCH_RESULT = 'Không tìm thấy.<br />';
	var $_PHPSHOP_PRICE_LABEL = 'Giá: ';
	var $_PHPSHOP_ORDER_BUTTON_LABEL = 'Thêm v� o giỏ';
	var $_PHPSHOP_NO_CUSTOMER = 'Bạn chưa đăng ký khách h� ng. Bạn hãy chuẩn bị các thông tin cần thiết cho việc đăng ký.';
	var $_PHPSHOP_DELETE_MSG = 'Bạn có chắc chắn muốn xoá ?';
	var $_PHPSHOP_THANKYOU = 'Cảm ơn đã mua h� ng của chúng tôi.';
	var $_PHPSHOP_NOT_SHIPPED = 'Chưa giao h� ng';
	...
	var $_PHPSHOP_ERROR = 'Lỗi';
	var $_PHPSHOP_MOD_NOT_REG = 'Module chưa đăng ký.';
	var $_PHPSHOP_MOD_ISNO_REG = 'không phải l�  module của phpShop.';
	var $_PHPSHOP_MOD_NO_AUTH = 'Bạn không có quyền truy cập v� o module n� y.';
	var $_PHPSHOP_PAGE_404_1 = 'Không có trang n� y';
	var $_PHPSHOP_PAGE_404_2 = 'Tên file không có. Không tìm thấy file:';
	var $_PHPSHOP_PAGE_403 = 'Không đủ quyền truy cập';
	var $_PHPSHOP_FUNC_NO_EXEC = 'Bạn không có quyền thực thi ';
	var $_PHPSHOP_FUNC_NOT_REG = 'Chức năng chưa đăng ký';
	var $_PHPSHOP_FUNC_ISNO_REG = ' không đúng chức năng của MOS_com_phpShop.';
	...
	var $_PHPSHOP_USER_FORM_SHIPTO_LBL = 'Địa chỉ nhận h� ng';
	var $_PHPSHOP_USER_FORM_ADD_SHIPTO_LBL = 'Thêm địa chỉ';
	var $_PHPSHOP_USER_FORM_NO_SHIPPING_ADDRESSES = 'No shipping addresses.';
	var $_PHPSHOP_USER_FORM_ADDRESS_LABEL = 'Địa chỉ';
	var $_PHPSHOP_USER_FORM_FIRST_NAME = 'Tên';
	var $_PHPSHOP_USER_FORM_LAST_NAME = 'Tên họ';
	var $_PHPSHOP_USER_FORM_MIDDLE_NAME = 'Tên đệm';
	...
	var $_PHPSHOP_USER_FORM_CITY = 'Th� nh phố';
	...
	var $_PHPSHOP_CONTINUE = 'Tiếp tục';
	var $_PHPSHOP_EMPTY_CART = 'Giỏ cuả bạn chưa có gì.';
	...
	var $_PHPSHOP_ISSHIP_LIST_MNU = 'Các phương thức giao h� ng';
	var $_PHPSHOP_ISSHIP_LIST_LBL = 'Active Ship Methods';
	var $_PHPSHOP_ISSHIP_LIST_CARRIER_LBL = 'Phương thức giao h� ng';
	...
	var $_PHPSHOP_ORDER_MOD = 'Mua h� ng';
	var $_PHPSHOP_ORDER_CONFIRM_MNU = 'Kết thúc mua h� ng';
	...
	var $_PHPSHOP_ORDER_LIST_ID = 'Khách h� ng số';
	...
	var $_PHPSHOP_ORDER_ITEM = 'Danh sách h� ng';
	var $_PHPSHOP_ORDER_PRINT_PO_LBL = 'H� ng đã mua';
	var $_PHPSHOP_ORDER_PRINT_PO_NUMBER = 'Số hóa đơn';
	var $_PHPSHOP_ORDER_PRINT_PO_DATE = 'Ng� y mua';
	var $_PHPSHOP_ORDER_PRINT_PO_STATUS = 'Trạng thái h� ng';
	var $_PHPSHOP_ORDER_PRINT_CUST_INFO_LBL = 'Thông tin khách h� ng';
	var $_PHPSHOP_ORDER_PRINT_CUST_BILLING_LBL = 'Thông tin hóa đơn';
	var $_PHPSHOP_ORDER_PRINT_CUST_SHIPPING_LBL = 'Thông tin giao h� ng';
	var $_PHPSHOP_ORDER_PRINT_BILL_TO_LBL = 'Hóa đơn đến';
	var $_PHPSHOP_ORDER_PRINT_SHIP_TO_LBL = 'Vận chuyển đến';
	var $_PHPSHOP_ORDER_PRINT_NAME = 'Tên h� ng';
	...
	var $_PHPSHOP_ORDER_PRINT_CITY = 'Th� nh phố';
	...
	var $_PHPSHOP_ORDER_PRINT_TOTAL = 'Tổng cộng';
	var $_PHPSHOP_ORDER_PRINT_SUBTOTAL = 'Tổng phụ';
	var $_PHPSHOP_ORDER_PRINT_TOTAL_TAX = 'Tiền thuế';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING = 'Lệ phí đóng gói & giao h� ng';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_TAX = 'Shipping Tax';
	var $_PHPSHOP_ORDER_PRINT_PAYMENT_LBL = 'Phương thức thanh toán';
	...
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_CARRIER_LBL = 'Hãng vận tải';
	var $_PHPSHOP_ORDER_PRINT_SHIPPING_MODE_LBL = 'Hình thức vận chuyển';
	...
	var $_PHPSHOP_ORDER_STATUS_P = 'Chưa giải quyết';
	var $_PHPSHOP_ORDER_STATUS_C = 'Xác nhận';
	var $_PHPSHOP_ORDER_STATUS_X = 'Huỷ bỏ';
	...
	var $_PHPSHOP_SHOPPER_LIST_NAME = 'Họ tên';
	...
	var $_PHPSHOP_SHOPPER_FORM_BILLTO_LBL = 'Thông tin khác';
	...
	var $_PHPSHOP_SHOPPER_FORM_FIRST_NAME = 'Tên';
	var $_PHPSHOP_SHOPPER_FORM_LAST_NAME = 'Tên họ';
	var $_PHPSHOP_SHOPPER_FORM_MIDDLE_NAME = 'Tên đệm';
	...
	var $_PHPSHOP_SHOPPER_FORM_CITY = 'Th� nh phố';
	...
	var $_PHPSHOP_PAYMENT_METHOD_LIST_MNU = 'Các phương thức thanh toán';
	...
	var $_PHPSHOP_PAYMENT_METHOD_FORM_MNU = 'Thêm phương thức thanh toán';
	...
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO = 'Thông tin trả tiền';
	...
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_EXDATE = 'Hạn đến';
	var $_PHPSHOP_CHECKOUT_CONF_PAYINFO_COMPORDER = 'Ho� n tất mua h� ng';
	...
	var $_PHPSHOP_I_AGREE_TO_TOS = 'Tôi chấp nhận các quy định của công ty';
	var $_PHPSHOP_LEAVE_BLANK = '(leave BLANK if you have <br />no individual php-file for it!)';
	var $_PHPSHOP_RETURN_LOGIN = 'Khách h� ng: Vui lòng đăng nhập';
	var $_PHPSHOP_NEW_CUSTOMER = 'Bạn l�  khách h� ng mới? Hãy chuẩn bị các thông tin để đăng ký';
	var $_PHPSHOP_ACC_CUSTOMER_ACCOUNT = 'Customer Account:';
	var $_PHPSHOP_ACC_ORDER_INFO = 'Thông tin mua h� ng';
	var $_PHPSHOP_ACC_UPD_BILL = 'Tại đây, bạn có thể cập nhật các thông tin để mua h� ng.';
	var $_PHPSHOP_ACC_UPD_SHIP = 'Tại đây, bạn có thể thêm địa chỉ nhận h� ng.';
	var $_PHPSHOP_ACC_ACCOUNT_INFO = 'Thông tin t� i khoản';
	...
	var $_PHPSHOP_SHIPTO_TEXT = 'Bạn có thể thêm địa chỉ nhận h� ng cho t� i khoản của mình. Bạn hãy tìm một cái tên cho địa chỉ nhận h� ng dưới đây.';
	...
	var $_PHPSHOP_INFO_MSG_CARRIER = 'Shipper (người giao h� ng)';
	...
	var $_PHPSHOP_CHECKOUT_MSG_2 = 'Bạn hãy chọn một địa chỉ để nhận h� ng!';
	var $_PHPSHOP_CHECKOUT_MSG_3 = 'Bạn hãy chọn phương thức giao h� ng!';
	var $_PHPSHOP_CHECKOUT_MSG_4 = 'Bạn hãy chọn phương thức thanh toán!';
	var $_PHPSHOP_CHECKOUT_MSG_99 = 'Vui lòng kiểm tra lại các thông tin đã cung cấp v�  kết thúc mua h� ng!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_SHIP = 'Bạn hãy chọn phương thức giao h� ng.';
	var $_PHPSHOP_CHECKOUT_ERR_OTHER_SHIP = 'Bạn hãy chọn phương thức giao h� ng khác.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_PAYM = 'Bạn hãy chọn phương thức thanh toán.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCNR = 'Bạn hãy điền số Credit Card của bạn.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCNAME = 'Bạn hãy điền tên trên Credit Card.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCDATE = 'Số Credit Card Number bạn đã điền không đúng.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCMON = 'Bạn hãy điền tháng hết hiệu lực của Credit Card.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCYEAR = 'Bạn hãy điền năm hết hiệu lực của Credit Card.';
	var $_PHPSHOP_CHECKOUT_ERR_CCDATE_INV = 'Thời gian hiệu lực của Credit Card sai.';
	var $_PHPSHOP_CHECKOUT_ERR_NO_SHIPTO = 'Bạn hãy chọn địa chỉ giao h� ng tới.';
	var $_PHPSHOP_CHECKOUT_ERR_CCNUM_INV = 'Số t� i khoản không đúng.';
	var $_PHPSHOP_CHECKOUT_ERR_EMPTY_CART = 'Giỏ của bạn không có gì!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CARR = 'Lỗi: Please select a Shipping Carrier!';
	var $_PHPSHOP_CHECKOUT_ERR_RATE_NOT_FOUND = 'Lỗi: The selected Shipping Rate was not found!';
	var $_PHPSHOP_CHECKOUT_ERR_SHIPTO_NOT_FOUND = 'Lỗi: Chưa có địa chỉ nhận h� ng!';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCDATA = 'Lỗi: Chưa có thông tin CreditCard...';
	var $_PHPSHOP_CHECKOUT_ERR_NO_CCNR_FOUND = 'Lỗi: Chưa có số của Credit Card!';
	var $_PHPSHOP_CHECKOUT_ERR_TEST = 'Xin lỗi, Số Credit Card bạn sử dụng l�  số thử nghiệm!';
	...
	var $_PHPSHOP_CHECKOUT_PAYMENT_CC = 'Trả tiền bằng Credit Card';
	var $_PHPSHOP_CHECKOUT_PAYMENT_OTHER = 'phương thức thanh toán khác';
	...
	var $_PHPSHOP_CHECKOUT_CUSTOMER_NOTE = 'Bạn có thể viết ghi chú của mình dưới đây trước khi kết thúc mua h� ng';
	var $_PHPSHOP_ORDER_PRINT_CUSTOMER_NOTE = 'Ghi chú của khách';
	...
	var $_PHPSHOP_DOWNLOADS_TITLE = 'Khu vực Download';
	var $_PHPSHOP_DOWNLOADS_START = 'Bắt đầu Download';
	var $_PHPSHOP_DOWNLOADS_INFO = 'Bạn hãy điền Download-ID trong e-mail bạn đã nhận được từ chúng tôi v�  click \'Bắt đầu Download\'.';
	var $_PHPSHOP_DOWNLOADS_ERR_EXP = 'Xin lỗi, but your Download has expired';
	var $_PHPSHOP_DOWNLOADS_ERR_MAX = 'Xin lỗi, but your maximum number of downloads has been reached';
	var $_PHPSHOP_DOWNLOADS_ERR_INV = 'Sai Download-ID!';
	var $_PHPSHOP_DOWNLOADS_ERR_SEND = 'Không thể gửi tin nhắn cho ';
	var $_PHPSHOP_DOWNLOADS_SEND_MSG = 'Tin nhắn gửi cho ';
	var $_PHPSHOP_DOWNLOADS_SEND_SUBJ = 'Thông tin Download';
	...
	var $_PHPSHOP_REGISTRATION_FORM_NONE = 'Không';
	var $_PHPSHOP_REGISTRATION_FORM_MR = 'Ông';
	var $_PHPSHOP_REGISTRATION_FORM_MRS = 'B� ';
	...
	var $_PHPSHOP_STATISTIC_NEW_ORDERS = 'Mới mua h� ng';
	var $_PHPSHOP_STATISTIC_NEW_CUSTOMERS = 'Khách h� ng mới';
	...
	var $_PHPSHOP_CHECK_OUT_THANK_YOU_PRINT_VIEW = 'In trang n� y';
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_SEARCH_ALL_CATEGORIES = 'Tìm tất cả Categories';
	var $_PHPSHOP_SEARCH_ALL_PRODINFO = 'Tìm tất cả thông tin sản phẩm';
	var $_PHPSHOP_SEARCH_PRODNAME = 'Chỉ tìm tên sản phẩm';
	var $_PHPSHOP_SEARCH_MANU_VENDOR = 'Chỉ tìm nh�  sản xuất/Vendor';
	var $_PHPSHOP_SEARCH_DESCRIPTION = 'Tìm mô tả sản phẩm';
	...
	var $_PHPSHOP_ORDERBY = 'Liệt kê theo';
	...
	var $_PHPSHOP_RATE_NOM = 'Đánh giá';
	var $_PHPSHOP_REVIEWS = 'Khách h� ng nhận xét';
	var $_PHPSHOP_NO_REVIEWS = 'Chưa có nhận xét n� o cho sản phẩm n� y.';
	var $_PHPSHOP_WRITE_FIRST_REVIEW = 'Bạn sẽ l�  người đầu tiên nhận xét cho sản phẩm của chúng tôi...';
	var $_PHPSHOP_REVIEW_LOGIN = 'Vui lòng đăng nhập để nhận xét sản phẩm.';
	var $_PHPSHOP_REVIEW_ERR_RATE = 'Vui lòng đánh giá sản phẩm để ho� n th� nh quá trình nhận xét!';
	var $_PHPSHOP_REVIEW_ERR_COMMENT1 = 'Vui lòng viết v� i dòng nhận xét dưới đây .Tối thiểu: 100 ký tự';
	var $_PHPSHOP_REVIEW_ERR_COMMENT2 = 'Vui lòng nhận xét ngắn gọn. Tối đa: 2000 ký tự';
	var $_PHPSHOP_WRITE_REVIEW = 'Viết nhận xét về sản phẩm n� y!';
	var $_PHPSHOP_REVIEW_RATE = 'Đầu tiên, đánh giá sản phẩm. Vui lòng chọn từ mức 0 (thấp nhất) cho đến 5 sao (tốt nhất).';
	var $_PHPSHOP_REVIEW_COMMENT = 'Tiếp theo, vui lòng viết ngắn gọn đánh giá cho sản phẩm... (từ 100 => 2000 ký tự) ';
	var $_PHPSHOP_REVIEW_COUNT = 'Ký tự: ';
	var $_PHPSHOP_REVIEW_SUBMIT = 'Gửi nhận xét';
	var $_PHPSHOP_REVIEW_ALREADYDONE = 'Bạn đã nhận xét cho sản phẩm n� y. Cảm ơn.';
	var $_PHPSHOP_REVIEW_THANKYOU = 'Cảm ơn đã nhận xét cho sản phẩm của chúng tôi.';
	...
	var $_PHPSHOP_CONTINUE_SHOPPING = 'Mua thêm h� ng';
	var $_PHPSHOP_THANKYOU_SUCCESS = 'Quá trình mua h� ng đã th� nh công!';
	var $_PHPSHOP_ORDER_LINK = 'Xem chi tiết hóa đơn mua h� ng.';
	...
	var $_PHPSHOP_PRODUCT_DISCOUNT_SAVE = 'Bạn tiết kiệm';
	...
	var $_PHPSHOP_MORE_IMAGES = 'Xem thêm hình';
	var $_PHPSHOP_AVAILABLE_IMAGES = 'Available Images for';
	var $_PHPSHOP_BACK_TO_DETAILS = 'Quay lại trang chi tiết sản phẩm';
	...
	var $_PHPSHOP_COUPON_ENTER_HERE = 'Nếu bạn có phiếu mua h� ng, hãy điền mã phiếu dưới đây:';
	...
	var $_PHPSHOP_RELATED_PRODUCTS_HEADING = 'Có thể bạn muốn xem một số sản phẩm khác...';
	...
	var $_PHPSHOP_PARAMETER_SEARCH = 'Tìm kiếm nâng cao sử dụng các tham số';
