...
<strong>verified</strong> PayPal account (when an account is not verified, PayPal does transfer the funds, but they do not fully guarantee the validity of the sale).';
	...
	var $_PHPSHOP_EPAY_PAYMENT_FEE = 'Gebyr p�lagt betalingen: ';
	...
	var $_PHPSHOP_EPAY_PAYMENT_RETRY_PAYMENT = '<br/><br><br><b>Tryk p� nederst�ende link for at fors�g betaling igen:</b><br>';
	...
	var $_PHPSHOP_EPAY_PAYMENT_DECLINE = 'Betalingen blev ikke godkendt af ePay / PBS. Betalingen blev afvist pga. f�lgende fejlkode: ';
	var $_PHPSHOP_EPAY_PAYMENT_LOG_TID = 'Betalingen er oprettet med transaktionsnummer: ';
	var $_PHPSHOP_EPAY_PAYMENT_EPAY_LINK = '. Betalingen kan behandles p�: <a href="https://ssl.ditonlinebetalingssystem.dk/admin" target="_new">www.epay.dk</a>';
	var $_PHPSHOP_EPAY_PAYMENT_CHECKOUT_HEADER = 'Du har nu bekr�ftet ordren og skal nu v�lge hvordan ordren betales. Dette g�res ved at klikke p� den �nskede betalingsmetode nedenfor. Betalingen vil ske i et SSL sikret vindue hos ePay (<a href="http://www.epay.dk" target="_new">www.epay.dk</a>).<br><br>';
	var $_PHPSHOP_EPAY_PAYMENT_CHECKOUT_FOOTER = 'Hvis ikke Standard Betalingsvinduet �bner op automatisk, s� klik p� knappen for at aktivere det. <br><br> Bem�rk! Hvis I benytter en pop-up stopper, skal I holde CTRL tasten nede, mens I trykker p� knappen.';        
	var $_PHPSHOP_EPAY_BUTTON_OPEN_WINDOW = '�BEN BETALINGSVINDUET';
