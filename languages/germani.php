...
/**
* @version $Id: germani.php,v 1.25 2005/06/22 19:50:43 soeren_nb Exp $
...
class phpShopLanguage extends mosAbstractLanguage {
    ...
    var $_PHPSHOP_BROWSE_TITLE= "&Uuml;bersicht";
    ...
    var $_PHPSHOP_NO_CUSTOMER= "Du bist leider noch kein registrierter Kunde. Wir ben&ouml;tigen noch Deine Rechnungsdaten.";
    var $_PHPSHOP_DELETE_MSG= "Soll dieser Datensatz wirklich gel&ouml;scht werden?";
    var $_PHPSHOP_THANKYOU= "Danke f&uuml;r Deine Bestellung.";
    var $_PHPSHOP_NOT_SHIPPED= "Noch nicht geliefert.";
    var $_PHPSHOP_EMAIL_SENDTO= "Eine Best&auml;tigungs-email wurde versandt an";
    var $_PHPSHOP_NO_USER_TO_SELECT= "Es existiert kein MOS-user, <br />den Du zur com_phpshop Nutzerliste hinzuf&uuml;gen k&ouml;nntest.";
    ...
    var $_PHPSHOP_AGREE_TO_TOS= "Vor der Registrierung musst Du den Gesch&auml;ftsbedingungen zustimmen.";
    ...
    var $_PHPSHOP_ACC_UPD_BILL= "Hier kannst Du Deine Rechungsadressdaten &auml;ndern";
    var $_PHPSHOP_ACC_UPD_SHIP= "Hier kannst Du Lieferadressen hinzuf&uuml;gen oder vorhandene &auml;ndern.";
    ...
    var $_PHPSHOP_SHIPTO_TEXT= "Du kannst unbegrenzt Lieferadressen zu Deinem Kundenkonto hinzuf&uuml;gen. Bitte benutze eine Abk&uuml;rzung f&uuml;r die Lieferadresse, um diese sp&auml;ter wiedererkennen zu k&ouml;nnen.";
    ...
    var $_PHPSHOP_ERR_MSG_RATE_NAME_REQ= "Fehler: gebe der Versandkosteneinheit einen Name.";
    ...
    var $_PHPSHOP_CHECKOUT_MSG_2= "Bitte w&auml;hle eine Lieferadresse aus!";
    var $_PHPSHOP_CHECKOUT_MSG_3= "Bitte w&auml;hle eine Versandart aus!";
    var $_PHPSHOP_CHECKOUT_MSG_4= "Bitte w&auml;hle eine Zahlungsweise aus!";
    var $_PHPSHOP_CHECKOUT_MSG_99= "Bitte &uuml;berpr&uuml;fen Sie alle Angaben und best&auml;tigen die Bestellung!";
    
    var $_PHPSHOP_CHECKOUT_ERR_NO_SHIP= "Bitte w&auml;hle eine Versandart aus!";
    var $_PHPSHOP_CHECKOUT_ERR_OTHER_SHIP= "Bitte w&auml;hle eine andere Versandart aus!";
    var $_PHPSHOP_CHECKOUT_ERR_NO_PAYM= "Bitte w&auml;hle eine Zahlungsart!";
    ...
    var $_PHPSHOP_CHECKOUT_ERR_NO_SHIPTO= "Bitte w&auml;hle eine Lieferadresse aus!";
    ...
    var $_PHPSHOP_CHECKOUT_ERR_NO_CARR= "Fehler: Bitte w&auml;hle einen Versender aus!";
    ...
    var $_PHPSHOP_CHECKOUT_PAYMENT_SELECT= "w&auml;hle eine Zahlungsart:";
    ...
    var $_PHPSHOP_PLEASE_SEL_ITEM= "Bitte w&auml;hle einen Artikel aus";
    ...
    var $_PHPSHOP_DOWNLOADS_INFO= "Gib hier Deine pers&ouml;nlich, per e-mail erhaltene Download-ID ein und klicke anschlieﬂend auf 'Download starten'.";
    ...
    var $_PHPSHOP_PAYPAL_THANKYOU= "Danke f&uuml;r Deine Zahlung. 
        Die Transaktion wurde abgeschlossen. Du erh&auml;ltst nun per E-Mail eine Quittung f&uuml;r Deinen Kauf von PayPal. 
    ...
    var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1= "Danke f&uuml;r Deine Bestellung. Deine Bestell-Informationen findest Du nachfolgend.";
    var $_PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER2= "Danke f&uuml;r Dein Vertrauen, wir hoffen Dich bald wieder in unserem Shop begr&uuml;ﬂen zu k&ouml;nnen.";
    ...
    var $_PHPSHOP_CART_ERROR_NO_VALID_QUANTITY= "Bitte eine g&uuml;ltige Menge angeben!";
    ...
    var $_PHPSHOP_CART_STOCK_3= "Bitte klicke hier, um auf eine Warteliste f&uuml;r dieses Produkt gesetzt zu werden.";
    var $_PHPSHOP_CART_SELECT_ITEM= "Bitte w&auml;hle einen Artikel von der Detailseite aus!";
  ...
  #######################################################*/
	...
	var $_PHPSHOP_WAITING_LIST_MESSAGE = "Bitte trage Deine email-Adresse ein, um benachrichtigt zu werden, wenn das Produkt wieder verf&uuml;gbar ist. 
                                                                        Wir werden Deine email-Adresse ausschlieﬂlich zum Zwecke der Benachrichtigung verwenden.
                                                                        <br /><br />Vielen Dank!";
	var $_PHPSHOP_WAITING_LIST_THANKS = "Vielen Dank! <br />Wir werden Dich benachrichtigen, sobald das Produkt wieder verf&uuml;gbar ist.";
  ...
  /**************************Admin.show_cfg.php in apparition order ;-)**************************************/
	...
	/* PAGE 1 */
	var $_PHPSHOP_ADMIN_CFG_AUTORIZE_OR_CYBERCASH = "Bitte w&auml;hle entweder Authorize.net oder CyberCash";
  ...
  var $_PHPSHOP_ADMIN_CFG_REVIEW_EXPLAIN = "Wenn aktiviert, k&ouml;nnen registrierte Nutzer <strong>Produkte bewerten</strong> und <strong>Rezensionen schreiben</strong>.<br />
	...
	var $_PHPSHOP_ADMIN_CFG_AGREE_TERMS_EXPLAIN = "Falls aktiviert, k&ouml;nnen sich Kunden nur im Shop registrieren, wenn diese vorher den Gesch&auml;ftsbedingungen zustimmen.";
...
/* PAGE 3 */
  ...
  var $_PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN = "Die legt die standardm&auml;ﬂige Anzahl von Produkte in einer Tabellenzeile fest. <br />
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_ZONE = "Zonen-Liefermodul, Country Version 1.0<br />
                                                                                                          ...
                                                                                                          zur Verf&uuml;gung oder kontaktiere <a href=\"mailto:zephware@devcompany.com\">ZephWare.com</a>.";
	...
	var $_PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_DISABLE = "Liefermodule NICHT nutzen. Z.B. wenn Downloadbare G&uuml;ter verkauft werden, die nicht ausgeliefert werden m&uuml;ssen.";
	...
	var $_PHPSHOP_ADMIN_CFG_ORDER_ENABLE_DOWNLOADS_EXPLAIN = "W&auml;hle den Bestellstatus aus, bei dem der Kunde &uuml;ber den Download per e-mail benachrichtigt wird.";
  ...
  Die Zeitspanne l&auml;uft ab dem ersten Download. Ist diese abgelaufen, wird die Download-ID deaktiviert.<br />Hinweis : 86400s=24h, 432000=5d.";
	...
	var $_PHPSHOP_ADMIN_CFG_PAYPAL_STATUS_SUCCESS_EXPLAIN = "W&auml;hle den Bestellstatus aus, auf den die Bestellung gesetzt wird, wenn die Zahlung &uuml;ber PayPal erfolgreich war. 
                                                                                                            Falls Du das Download-Feature aktiviert hast, w&auml;hle den Status aus, bei dem der Download aktiviert wird und der Kunde
	...
	var $_PHPSHOP_ADMIN_CFG_PAYPAL_STATUS_FAILED_EXPLAIN = "W&auml;hle an Bestellstatus f&uuml;r fehlgeschlagene PayPal Transaktionen.";
	...
	var $_PHPSHOP_ADMIN_CFG_ENABLE_AUTORIZENET_EXPLAIN = "Anhaken, falls Du Kreditkartenzahlungen &uuml;ber Authorize.net abwickeln willst.";
	var $_PHPSHOP_ADMIN_CFG_ENABLE_AUTORIZENET_TESTMODE = "Test modus?";
	var $_PHPSHOP_ADMIN_CFG_ENABLE_AUTORIZENET_TESTMODE_EXPLAIN = "W&auml;hle 'Ja' w&auml;hrend des Testens und 'Nein', um live Transaktionen zu erm&ouml;glichen.";
	...
	var $_PHPSHOP_ADMIN_CFG_ENABLE_CYBERCASH_EXPLAIN = "Anhaken, falls Du Kreditkartenzahlungen &uuml;ber CyberCash-Zahlungen abwickeln willst. (veraltet!)";
    ...
    var $_PHPSHOP_SEARCH_TEXT1 = "Aus der erste Auswahlliste kann eine Kategorie ausgew&auml;hlt werden, in der dann ausschlieﬂlich gesucht wird. 
    ...
    var $_PHPSHOP_REVIEW_LOGIN = "Bitte melde Dich an, um eine Rezension &uuml;ber dieses Produkt zu schreiben.";
    var $_PHPSHOP_REVIEW_ERR_RATE = "Bitte gib eine Bewertung f&uuml;r das Produkt ab!";
    var $_PHPSHOP_REVIEW_ERR_COMMENT1 = "Bitte hab Verst&auml;ndnis daf&uuml;r, dass f&uuml;r eine Rezension \\n die Eingabe von mindestens 100 Zeichen erforderlich sind.";
    var $_PHPSHOP_REVIEW_ERR_COMMENT2 = "Bitte hab Verst&auml;ndnis daf&uuml;r, dass das Maximum \\n f&uuml;r Rezensionen 2000 Zeichen betr&auml;gt.";
    var $_PHPSHOP_WRITE_REVIEW = "Teile uns Deine Meinung &uuml;ber dieses Produkt mit!";
    var $_PHPSHOP_REVIEW_RATE = "Zun&auml;chst gib bitte eine Bewertung ab. W&auml;hle einen Wert zwischen 0 (schlechtester) and 5 Sternen (bester).";
    ...
    var $_PHPSHOP_REVIEW_ALREADYDONE = "Du hast f&uuml;r dieses Produkt bereits eine Rezension geschrieben. Vielen Dank.";
    ...
    var $_PHPSHOP_ORDER_LINK = "Folge dieser Verkn&uuml;pfung, um Dir die Details der Bestellung anzeigen zu lassen.";
    
    var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_1 = "der Status Deiner Bestellung Nr. {order_id} hat sich ge&auml;ndert.";
    ...
    var $_PHPSHOP_PRODUCT_DISCOUNT_ADDDISCOUNT_TIP = "Du kannst das Rabattformular benutzen, um Rabatte hinzuzuf&uuml;gen!";
...
****************/
    ...
    var $_PHPSHOP_COUPON_CODE_EXISTS = "Dieser Gutschein Code existiert bereits. Bitte w&auml;hle einen anderen.";
    ...
    var $_PHPSHOP_COUPON_CONFIRM_DELETE = "Soll dieser Gutschein wirklich gel&ouml;scht werden?";
    var $_PHPSHOP_COUPON_COMPLETE_ALL_FIELDS = "Bitte f&uuml;lle alle Felder aus!";
    ...
    var $_PHPSHOP_COUPONS_ENABLE_EXPLAIN = "Wenn die Gutschein-Benutzung aktiviert ist, wird es dem Kunden erlaubt, w&auml;hrend des Bestellvorgangs einen Gutschein-Code einzugeben.";
    ...
    var $_PHPSHOP_UPS_PICKUP_METHOD_TOOLTIP = "Gibt an, wie Du die Pakete zu/von UPS gibst/abholen l&auml;sst.";
    var $_PHPSHOP_UPS_PACKAGE_TYPE = "UPS Verpackung?";
    var $_PHPSHOP_UPS_PACKAGE_TYPE_TOOLTIP = "W&auml;hle die standardm&auml;ﬂige Verpackung f&uuml;r UPS.";
    ...
    var $_PHPSHOP_UPS_HANDLING_FEE_TOOLTIP = "Deine Bearbeitungsgeb&uuml;hr f&uuml;r diese Versandmethode.";
    ...
    var $_PHPSHOP_CUSTOMER_CVV2_TOOLTIP = "Bitte gib den 3- oder 4-stelligen Sicherheits-Code ein. (auf der R&uuml;ckseite von Kreditkarten, auf der Vorderseite bei American Express Karten)";
    ...
    var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP1 = "Gib hier Text ein, der dem Kunden zur Verf&uuml;gbarkeit der Produktes angezeit wird.<br />z.B.: 24h, 48 Stunden, 3 - 5 Tage, auf Anfrage.....";
    var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP2 = "Order w&auml;hle ein Bild, um die Verf&uuml;gbarkeit visuell darzustellen.<br />Die Bilder hier sind eine automatische Auflistung aller vorhandenen Bilder im Verzeichnis <i>/components/com_phpshop/shop_image/availability</i><br />";
...
// 	var $_PHPSHOP_PARAMETER_SEARCH_NO_PRODUCT_TYPE = "Es wurden keine Ergebnisse gefunden bzw. Starte eine Suche.";
	...
	var $_PHPSHOP_PARAMETER_SEARCH_CHANGE_PARAMETERS = "Parameters &auml;";
