...
class vmLanguage extends vmAbstractLanguage {
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP2 = 'OR select an Image to be displayed on the Details Page (flypage).<br />The images reside in the directory <i>%s</i><br />';
...
<strong>verified</strong> PayPal account (when an account is not verified, PayPal does transfer the funds, but they do not fully guarantee the validity of the sale).';
	...
	var $_PHPSHOP_EPAY_PAYMENT_FEE = 'Gebyr pεlagt betalingen: ';
	...
	var $_PHPSHOP_EPAY_PAYMENT_RETRY_PAYMENT = '<br/><br><br><b>Tryk pε nederstεende link for at forsψg betaling igen:</b><br>';
	...
	var $_PHPSHOP_EPAY_PAYMENT_DECLINE = 'Betalingen blev ikke godkendt af ePay / PBS. Betalingen blev afvist pga. fψlgende fejlkode: ';
	var $_PHPSHOP_EPAY_PAYMENT_LOG_TID = 'Betalingen er oprettet med transaktionsnummer: ';
	var $_PHPSHOP_EPAY_PAYMENT_EPAY_LINK = '. Betalingen kan behandles pε: <a href="https://ssl.ditonlinebetalingssystem.dk/admin" target="_new">www.epay.dk</a>';
	var $_PHPSHOP_EPAY_PAYMENT_CHECKOUT_HEADER = 'Du har nu bekrζftet ordren og skal nu vζlge hvordan ordren betales. Dette gψres ved at klikke pε den ψnskede betalingsmetode nedenfor. Betalingen vil ske i et SSL sikret vindue hos ePay (<a href="http://www.epay.dk" target="_new">www.epay.dk</a>).<br><br>';
	var $_PHPSHOP_EPAY_PAYMENT_CHECKOUT_FOOTER = 'Hvis ikke Standard Betalingsvinduet εbner op automatisk, sε klik pε knappen for at aktivere det. <br><br> Bemζrk! Hvis I benytter en pop-up stopper, skal I holde CTRL tasten nede, mens I trykker pε knappen.';        
	var $_PHPSHOP_EPAY_BUTTON_OPEN_WINDOW = 'ΕBEN BETALINGSVINDUET';
