...
class phpShopLanguage extends mosAbstractLanguage {
    ...
    var $_PHPSHOP_PRODUCT_FORM_IMAGE_DELETE_LBL = "Skriv \"none\" för att radera nuvarande bild.";
    ...
    var $_PHPSHOP_CART_FEL_NO_NEGATIVE = "Negativa kvantiter är inte tillåtna.";
    var $_PHPSHOP_CART_FEL_NO_VALID_QUANTITY = "Vänligen ange ett giltligt antal för produkten.";
  ...
  #######################################################*/
    ...
    var $_PHPSHOP_ADMIN_CFG_FELPAGE_EXPLAIN = "Detta är standardsidan för felmeddelanden."; 
