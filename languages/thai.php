...
<strong>verified</strong> PayPal account (when an account is not verified, PayPal does transfer the funds, but they do not fully guarantee the validity of the sale).';
	...
	var $_PHPSHOP_EPAY_PAYMENT_FEE = 'Gebyr pๅlagt betalingen: ';
	...
	var $_PHPSHOP_EPAY_PAYMENT_RETRY_PAYMENT = '<br/><br><br><b>Tryk pๅ nederstๅende link for at fors๘g betaling igen:</b><br>';
	...
	var $_PHPSHOP_EPAY_PAYMENT_DECLINE = 'Betalingen blev ikke godkendt af ePay / PBS. Betalingen blev afvist pga. f๘lgende fejlkode: ';
	var $_PHPSHOP_EPAY_PAYMENT_LOG_TID = 'Betalingen er oprettet med transaktionsnummer: ';
	var $_PHPSHOP_EPAY_PAYMENT_EPAY_LINK = '. Betalingen kan behandles pๅ: <a href="https://ssl.ditonlinebetalingssystem.dk/admin" target="_new">www.epay.dk</a>';
	var $_PHPSHOP_EPAY_PAYMENT_CHECKOUT_HEADER = 'Du har nu bekrๆftet ordren og skal nu vๆlge hvordan ordren betales. Dette g๘res ved at klikke pๅ den ๘nskede betalingsmetode nedenfor. Betalingen vil ske i et SSL sikret vindue hos ePay (<a href="http://www.epay.dk" target="_new">www.epay.dk</a>).<br><br>';
	var $_PHPSHOP_EPAY_PAYMENT_CHECKOUT_FOOTER = 'Hvis ikke Standard Betalingsvinduet ๅbner op automatisk, sๅ klik pๅ knappen for at aktivere det. <br><br> Bemๆrk! Hvis I benytter en pop-up stopper, skal I holde CTRL tasten nede, mens I trykker pๅ knappen.';        
	var $_PHPSHOP_EPAY_BUTTON_OPEN_WINDOW = 'ลBEN BETALINGSVINDUET';
