...
$VM_LANG->initModule('common',array (
	...
	'PHPSHOP_MODULE_FORM_MODULE_LABEL' => '����� ������ (��� Topmenu)',
	'PHPSHOP_MODULE_FORM_NAME' => '��� ������',
	'PHPSHOP_MODULE_FORM_PERMS' => '����� ������',
	'PHPSHOP_MODULE_FORM_HEADER' => '����� ������',
	'PHPSHOP_MODULE_FORM_FOOTER' => '������ ����� ������',
	...
	'PHPSHOP_ISSHIP_PING_MNU' => '��������� ������ �����������',
	'PHPSHOP_ISSHIP_PING_LBL' => '���� ������� ����������� ',
	'PHPSHOP_ISSHIP_PING_ERROR_LBL' => '���� ������� ����������� �� ������',
	'PHPSHOP_ISSHIP_PING_GOOD_LBL' => '���� ������� ����������� ����������',
	...
	'PHPSHOP_DOWNLOADS_SEND_SUBJ' => '���������� � ���������',
	'PHPSHOP_DOWNLOADS_SEND_MSG_1' => '���������� ���� ����� ������ ��� ����������',
	'PHPSHOP_DOWNLOADS_SEND_MSG_2' => '����������, ������� ��������� ������������� �������� (Download-ID) � ����� ������� �������� ������: ',
	'PHPSHOP_DOWNLOADS_SEND_MSG_3' => '����������� ���������� ���������� ������� �����: ',
	'PHPSHOP_DOWNLOADS_SEND_MSG_4' => '������� �������� � ������� {expire} ��. ����� ������ ����������. Download until {expire} days after the first download',
	...
	'PHPSHOP_WAITING_LIST_MESSAGE' => '����������, ������� ���� ����� ����������� �����, ����� �� ����� ��������� ��� ����� ����� �������� �� ������. �� �� ����� ���������� ���� ����� ������� ����� � ������������ ��� ��� �����-���� �����, ����� ����������� � ������� ������.<br /><br />�������!',
	...
	'PHPSHOP_ADMIN_CFG_DEBUG_EXPLAIN' => 'DEBUG?             ��������� ������ ���������� ����������. � ���� ������ ����� ������ �������� ���������� ���������� ���������� - DEBUGPAGE. ��� ����� ������� ��� ���������� � ������� ��������, ��������� ���������� ���������� ������, �������� ����� ���� � �.�.',
	'PHPSHOP_ADMIN_CFG_FLYPAGE' => 'FLYPAGE',
	'PHPSHOP_ADMIN_CFG_FLYPAGE_EXPLAIN' => '�������� �� ��������� ��� ����������� ��������� ���������� � ������.',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE' => '������ ���������',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE_EXPLAIN' => '���������� ������ ��������� �� ��������� ��� ����������� ������� � ���� ���������.<br />
                                                                                                      �� ������ ��������� ����� �������, ������� ������������ ����� �������� <br />
                                                                                                      (������� �������� � ����� <strong>COMPONENTPATH/html/templates/</strong> � ���������� � browse_)',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW' => '���������� ������� � ������ �� ���������',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN' => '���������� ���������� ������� � ������ �� ���������.<br />������: ���� �� ���������� 4, �� ������ ��������� ��������� 4 ������ � ������',
	...
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION_EXPLAIN' => '���������� ����� �������� �������� "powered by mambo-phpShop" � ���������.',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD' => '�������� ������ �������� ������ ��������',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_STANDARD' => '����������� ������ �������� � ������������� ������������������� ��������� ��������� � ��������. <strong>�������������!</strong>',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_ZONE' => '������ ��������, ��������� �� ���� ��������. ������ 1.0<br />�� ����������� �� ���� ������, ����������, ����������� �� ���� <a href="http://ZephWare.com">http://ZephWare.com</a><br />������������ ������� ��� ��������� ����������� �� ������: <a href="mailto:zephware@devcompany.com">ZephWare@devcompany.com</a><br />�������� ���� �����, ����� �������� ������ �������� �� �����',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_UPS' => '<<a href="http://www.ups.com" target="_blank">UPS Online(R) Tools</a> ����� ��������� ��������',
	...
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_UPS_USER_ID' => 'ID ������������ UPS',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_UPS_USER_ID_EXPLAIN' => 'ID ������������, ���������� �� UPS',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_UPS_PASSWORD' => '������ UPS',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_UPS_PASSWORD_EXPLAIN' => '������ ��� ������ UPS-��������',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_INTERSHIPPER' => '������ InterShipper. ��������� ������ � ��� ������, �� ������ ������� <a href="http://www.intershipper.com" target="_blank">Intershipper.com</a>',
	...
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR' => '�������� Checkout Bar',
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR_EXPLAIN' => '��������, ���� ������, ����� �� ����� �������� ���������� ������ ����������� Checkout Bar (1 - 2 - 3 - 4 � ��������).',
	...
	'PHPSHOP_ADMIN_CFG_DOWNLOADROOT_EXPLAIN' => '���������� ���� � ����������� ������������ ������. (� ����� - ����!)<br><span class="message">��� ������������ ������ ��������, ����������, ����������� �����, ����������� �� ���� ����� ������ �����.</span>',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_MAX' => '������������ ���-�� ��������',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_MAX_EXPLAIN' => '������������� ���������� ��������, ������� ����� ���� ������� � ��������� ������ �������������� �������� - Download-ID (��� ������ ������)',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_EXPIRE' => '���� �������� ��������',
	'PHPSHOP_ADMIN_CFG_DOWNLOAD_EXPIRE_EXPLAIN' => '���������� ������ ������� <strong>� ��������</strong>, � ������� �������� �������� �������� ��� �������. ����� ������� ���������� � ������ ��������! ����� ����� �������, ������������� �������� (download-ID) ���������� ����������������.<br/> ����������: 86400 ���. = 24 �.',
	'PHPSHOP_ADMIN_CFG_ENABLE_PAYPAL' => '��������� IPN-������� ����� PayPal?',
	'PHPSHOP_ADMIN_CFG_ENABLE_PAYPAL_EXPLAIN' => '��������, ����� ��������� �������� ������������� �������� ������� PayPal.',
	'PHPSHOP_ADMIN_CFG_PAYPAL_EMAIL' => 'E-mail ��� PayPal:',
	'PHPSHOP_ADMIN_CFG_PAYPAL_EMAIL_EXPLAIN' => '��� ������� e-mail ����� ��� �������� PayPal, ����� ������������, ��� e-mail ���������� (receiver_email).',
	'PHPSHOP_ADMIN_CFG_PAYPAL_STATUS_SUCCESS' => '������ ������ ��� �������� ����������',
	'PHPSHOP_ADMIN_CFG_PAYPAL_STATUS_SUCCESS_EXPLAIN' => '�������� ������, ������� ������ ����� ��� �������� �������� ����� ����� PayPal IPN. ���� ���������� ������� ����������� �� ���� ������� - �������� ������, ��� ������� ����������� �������� ������ (��� ������� ������ ����� ���������� �� ����������� ����� � ����������� �������).',
	...
	'PHPSHOP_ADMIN_CFG_ENABLE_AUTORIZENET_EXPLAIN' => '�������� ����� ������������ Authorize.net � phpShop.',
	...
	'PHPSHOP_ADMIN_CFG_AUTORIZENET_USERNAME_EXPLAIN' => '������� ���� Login ID ��� Authorize.net',
	'PHPSHOP_ADMIN_CFG_AUTORIZENET_KEY' => '���� ���������� ��� Authorize.net',
	...
	'PHPSHOP_ADMIN_CFG_ENABLE_CYBERCASH_EXPLAIN' => '��������, ����� ������������ CyberCash � phpShop.',
	'PHPSHOP_ADMIN_CFG_CYBERCASH_MERCHAND' => '�������� CyberCash',
	'PHPSHOP_ADMIN_CFG_CYBERCASH_MERCHAND_EXPLAIN' => '�������� CyberCash - ��� CyberCash Merchant ID',
	'PHPSHOP_ADMIN_CFG_CYBERCASH_MERCHAND_KEY' => '���� �������� CyberCash',
	'PHPSHOP_ADMIN_CFG_CYBERCASH_MERCHAND_KEY_EXPLAIN' => '���� �������� CyberCash ������������ �������� CyberCash',
	'PHPSHOP_ADMIN_CFG_CYBERCASH_URL' => 'URL ������ CyberCash',
	'PHPSHOP_ADMIN_CFG_CYBERCASH_URL_EXPLAIN' => 'URL ������ CyberCash - ��� URL, ��������������� CyberCash ��� ����������� ������������ ��������',
	'PHPSHOP_ADMIN_CFG_CYBERCASH_AUTENTICATIONTYPE' => '��� ����������� CyberCash',
	'PHPSHOP_ADMIN_CFG_CYBERCASH_AUTENTICATIONTYPE_EXPLAIN' => '��� ����������� CyberCash ������������ �������� CyberCash',
	'PHPSHOP_ADVANCED_SEARCH' => '����������� �����',
	'PHPSHOP_SEARCH_ALL_CATEGORIES' => '�� ���� ����������',
	'PHPSHOP_SEARCH_ALL_PRODINFO' => '�� ���� ���������� � ������',
	'PHPSHOP_SEARCH_PRODNAME' => '������ � �������� ������',
	'PHPSHOP_SEARCH_MANU_VENDOR' => '������ � URL ������',
	...
	'PHPSHOP_ORDER_LINK' => '������� ��� ������ ��� ��������� ������������ ������.',
	'PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_1' => '������ ������ ������ � {order_id} ��� ������.',
	'PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_2' => '����� ������:',
	'PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_3' => '����� ����������� ����������� ������, ����������, ��������� �� ���� ������ (��� ���������� � � ��� ������� � ������� Enter):',
	'PHPSHOP_ORDER_STATUS_CHANGE_SEND_SUBJ' => '��������� ������� ������: ��� ����� {order_id}',
	'PHPSHOP_ORDER_LIST_NOTIFY' => '��������� ����������?',
	'PHPSHOP_ORDER_LIST_NOTIFY_ERR' => '����������, ������� �������� ������ ������!',
	'PHPSHOP_SHOPPER_GROUP_FORM_DISCOUNT' => '������ �� ��������� ��� ������ ����������� (� %)',
	'PHPSHOP_SHOPPER_GROUP_FORM_DISCOUNT_TIP' => '������������� �������� � ��������: ���� ������ �� ��������� ���� ��� ���� ������ �����������, �� ���� �� ��������� ����������� �� � %. ������������� �������� ����� ��������������� ������',
	...
	'PHPSHOP_CURRENCY_SYMBOL_TOOLTIP' => '����� �� ������ ������������ HTML-������� (��������, &euro;,&pound;,&yen;,...)',
	'PHPSHOP_CURRENCY_DECIMALS' => '���������� ������',
	'PHPSHOP_CURRENCY_DECIMALS_TOOLTIP' => '���������� ���������� ������ ����� ������� (����� ���� 0)<br><b>���� ���� ����� ������� ���������� ���������� ������, ���������� ����������.</b>',
	'PHPSHOP_CURRENCY_DECIMALSYMBOL' => '���������� �����������',
	'PHPSHOP_CURRENCY_DECIMALSYMBOL_TOOLTIP' => '������ ������������, ��� ���������� �����������',
	'PHPSHOP_CURRENCY_THOUSANDS' => '����������� �����',
	'PHPSHOP_CURRENCY_THOUSANDS_TOOLTIP' => '������ ������������, ��� ���������� ����� (����� ���� ������)',
	'PHPSHOP_CURRENCY_POSITIVE_DISPLAY' => '������������� ������',
	'PHPSHOP_CURRENCY_POSITIVE_DISPLAY_TOOLTIP' => '������, ������������ ��� ����������� ������������� �������� ����.<br>(������ Symb ������������� ������ ������)',
	'PHPSHOP_CURRENCY_NEGATIVE_DISPLAY' => '������������� ������',
	'PHPSHOP_CURRENCY_NEGATIVE_DISPLAY_TOOLTIP' => '������, ������������ ��� ����������� ������������� �������� ����.<br>(������ Symb ������������� ������ ������)',
	'PHPSHOP_OTHER_LISTS' => '������ ������ �������',
	'PHPSHOP_MORE_IMAGES' => '���������� ������ ��������',
	...
	'PHPSHOP_FILES_LIST_THUMBNAIL_IMG' => '��������� ��������',
	'PHPSHOP_FILES_FORM' => '��������� ���� ���',
	...
	'PHPSHOP_FILES_FORM_AUTO_THUMBNAIL' => '������������� ������� ��������� ��������?',
	...
	'PHPSHOP_FILES_IMAGE_RESIZE_SUCCESS' => '��������� �������� ���� ������� �������!',
	'PHPSHOP_FILES_IMAGE_RESIZE_FAILURE' => '�� ������� ������� ��������� ��������!',
	'PHPSHOP_FILES_UPLOAD_FAILURE' => '������ �������� �����/��������',
	'PHPSHOP_FILES_FULLIMG_DELETE_FAILURE' => '���������� ������� ������� ��������.',
	'PHPSHOP_FILES_FULLIMG_DELETE_SUCCESS' => '������� �������� ������� �������.',
	'PHPSHOP_FILES_THUMBIMG_DELETE_FAILURE' => '���������� ������� ��������� �������� (��������, ��� �� ����������): ',
	'PHPSHOP_FILES_THUMBIMG_DELETE_SUCCESS' => '��������� �������� ������� �������.',
	...
	'PHPSHOP_COUPON_EDIT_HELP_TEXT' => 'ٸ������ �� ���� ������, ����� �������� ���. ��� �������� ���� ������ �������� ��� � ������� �������:',
	'PHPSHOP_COUPON_CODE_HEADER' => '���',
	'PHPSHOP_COUPON_PERCENT_TOTAL' => '���������� ��� ����������',
	'PHPSHOP_COUPON_TYPE' => '��� ������',
	'PHPSHOP_COUPON_TYPE_TOOLTIP' => '������� ����� ��������� ����� ����� ������������� ��� ��������� ������ � ������. ���������� ����� ����� ���� ����������� ��� �����, ��� ������� ����������.',
	...
	'PHPSHOP_PAYMENT_AN_RECURRING_TOOLTIP' => '�������, ������ �� �� recurring billings.',
	...
	'PHPSHOP_PAYMENT_CVV2' => '����� ���� Request/Capture (CVV2/CVC2/CID) �� ��������� ��������',
	...
	'PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP2' => '��� �������� ��������, ������� ����� ������������ ����� �� �������� ������������ (������) ������.<br />�������� ��������� � ����� <i>%s</i><br />',
...
<strong>������</strong>,XL[+1.99],M,S[-2.99];<strong>����</strong>,�������,������,Ƹ����[=24.00];���������,..,..</pre>
	...
	'PHPSHOP_PRODUCT_FORM_CUSTOM_ATTRIBUTE_LIST' => '������ ����������� ���������',
	'PHPSHOP_PRODUCT_FORM_CUSTOM_ATTRIBUTE_LIST_EXAMPLES' => '<h4>������ ������� ������ ����������� ���������:</h4>
        <pre><strong>   ��������;��������������;</strong>...<br />
����� �������� ��� �������������� ���� �������� � ��������������, ������������ ��� ����������.</pre>',
	'PHPSHOP_MULTISELECT' => '��� ������ ����������, ��������� CTRL, ��������� �����',
	'PHPSHOP_ADMIN_CFG_ENABLE_EPN' => '��������� ������� �����  eProcessingNetwork.com?',
	'PHPSHOP_ADMIN_CFG_ENABLE_EPN_EXPLAIN' => '��������, ����� ������������ eProcessingNetwork.com � phpShop.',
	'PHPSHOP_ADMIN_CFG_ENABLE_EPN_TESTMODE' => '�������� ����� ?',
	'PHPSHOP_ADMIN_CFG_ENABLE_EPN_TESTMODE_EXPLAIN' => '�������� \\\'��\\\' ��� ��������� ������ ������������. �������� \\\'���\\\' ��� ��������� �������� ����������.',
	...
	'PHPSHOP_RELATED_PRODUCTS_TIP' => '�� ������ ������� ������������� (���������) ������ ��������� ���� ������. ������ �������� ���� ��� ��������� ������� � ������ � ��� ������  <strong>�������������� ��������</strong>.',
	...
	'PHPSHOP_PRODUCT_TYPE_FORM_BROWSEPAGE' => '�������� ����������� ���� ������ (Browse Page)',
	...
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_MULTISELECT' => '��������� �������� ���������<br />��������� ��������?<br />(���� �������� ������ - <br />����� ����� ������� ������ ����)',
	'PHPSHOP_PRODUCT_TYPE_PARAMETER_FORM_VALUES_DESCRIPTION' => '<strong>���� ����� ��� ������ ��������, �� �������� ����� ��������� ������ ��������� ��������.<BR />������ ��� ��������� ��������:</strong> �����;������;�������;...',
	...
	'PHPSHOP_PARAMETER_SEARCH_IS_LIKE' => '�����',
	...
	'PHPSHOP_CSV_SELECT_FIELD_ORDERING' => '������� ����������� ����� CSV-�����',
