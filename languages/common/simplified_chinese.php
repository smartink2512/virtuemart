...
$VM_LANG->initModule('common',array (
	...
	'PHPSHOP_CATEGORY' => '���',
	'PHPSHOP_CATEGORIES' => '���',
	'PHPSHOP_SELECT_CATEGORY' => 'ѡ��һ��Ŀ¼:',
	'PHPSHOP_ADMIN' => '����',
	'PHPSHOP_PRODUCT' => '��Ʒ',
	'PHPSHOP_LIST' => '�б�',
	'PHPSHOP_ALL' => '����',
	'PHPSHOP_LIST_ALL_PRODUCTS' => '�г�������Ʒ',
	'PHPSHOP_VIEW' => '�鿴',
	'PHPSHOP_SHOW' => '��ʾ',
	'PHPSHOP_ADD' => '���',
	'PHPSHOP_UPDATE' => '����',
	...
	'PHPSHOP_RANDOM' => '����Ʒ',
	'PHPSHOP_LATEST' => '���²�Ʒ',
	'PHPSHOP_HOME_TITLE' => '��ҳ',
	'PHPSHOP_CART_TITLE' => '���ﳵ',
	'PHPSHOP_CHECKOUT_TITLE' => '����',
	'PHPSHOP_LOGIN_TITLE' => '��¼',
	'PHPSHOP_LOGOUT_TITLE' => 'ע��',
	'PHPSHOP_BROWSE_TITLE' => '���',
	'PHPSHOP_SEARCH_TITLE' => '����',
	'PHPSHOP_ACCOUNT_TITLE' => '�ʺ�ά��',
	'PHPSHOP_NAVIGATION_TITLE' => '����',
	'PHPSHOP_DEPARTMENT_TITLE' => '����',
	'PHPSHOP_INFO' => '��Ϣ',
	'PHPSHOP_BROWSE_LBL' => '���',
	'PHPSHOP_PRODUCTS_LBL' => '��Ʒ',
	'PHPSHOP_PRODUCT_LBL' => '��Ʒ',
	'PHPSHOP_SEARCH_LBL' => '����',
	'PHPSHOP_FLYPAGE_LBL' => '��Ʒ����',
	'PHPSHOP_PRODUCT_SEARCH_LBL' => '��Ʒ����',
	'PHPSHOP_PRODUCT_NAME_TITLE' => '��Ʒ���',
	'PHPSHOP_PRODUCT_CATEGORY_TITLE' => '��Ʒ���',
	'PHPSHOP_PRODUCT_DESC_TITLE' => '��Ʒ����',
	'PHPSHOP_CART_SHOW' => '�ҵĹ��ﳵ',
	'PHPSHOP_CART_ADD_TO' => '���빺�ﳵ',
	'PHPSHOP_CART_NAME' => '��Ʒ��',
	'PHPSHOP_CART_SKU' => 'SKU',
	'PHPSHOP_CART_PRICE' => '�۸�',
	'PHPSHOP_CART_QUANTITY' => '��',
	'PHPSHOP_CART_SUBTOTAL' => 'С��',
	'PHPSHOP_ADD_SHIPTO_1' => '����µ�',
	'PHPSHOP_ADD_SHIPTO_2' => '�����ַ',
	'PHPSHOP_NO_SEARCH_RESULT' => 'û���ҵ������ѯ�Ĳ�Ʒ��<BR>',
	'PHPSHOP_PRICE_LABEL' => '�۸�: ',
	'PHPSHOP_ORDER_BUTTON_LABEL' => '���빺�ﳵ',
	'PHPSHOP_NO_CUSTOMER' => '��û��ע���Ϊ��Ա�����ṩ���֧����Ϣ��',
	'PHPSHOP_DELETE_MSG' => '��ȷ��Ҫɾ��˼�¼��?',
	'PHPSHOP_THANKYOU' => '��л��Ķ�����',
	'PHPSHOP_NOT_SHIPPED' => '��δ����',
	'PHPSHOP_EMAIL_SENDTO' => 'ȷ���ʼ��ѷ���',
	'PHPSHOP_ERROR' => '����',
	'PHPSHOP_MOD_NOT_REG' => 'ģ��δע�ᡣ',
	'PHPSHOP_MOD_ISNO_REG' => '������ȷ���̳�ģ�顣',
	'PHPSHOP_MOD_NO_AUTH' => '����Ȩ�����ģ�顣',
	'PHPSHOP_PAGE_404_1' => 'ҳ�治����',
	'PHPSHOP_PAGE_404_2' => '�ṩ���ļ�����ڣ��޷��ҵ��ļ�:',
	'PHPSHOP_PAGE_403' => 'û���㹻�Ľ���Ȩ��',
	'PHPSHOP_FUNC_NO_EXEC' => '����Ȩִ��',
	'PHPSHOP_FUNC_NOT_REG' => '�˹���δע��',
	'PHPSHOP_FUNC_ISNO_REG' => '������ȷ���̳����ܡ�',
	'PHPSHOP_ADMIN_MOD' => '����',
	'PHPSHOP_USER_LIST_MNU' => '��ʾ��Ա�б�',
	'PHPSHOP_USER_LIST_LBL' => '��Ա�б�',
	'PHPSHOP_USER_LIST_USERNAME' => '��Ա���',
	'PHPSHOP_USER_LIST_FULL_NAME' => '����',
	'PHPSHOP_USER_LIST_GROUP' => '��',
	'PHPSHOP_USER_FORM_MNU' => '��ӻ�Ա',
	'PHPSHOP_USER_FORM_LBL' => '���/���»�Ա��Ϣ',
	'PHPSHOP_USER_FORM_BILLTO_LBL' => '������Ϣ',
	'PHPSHOP_USER_FORM_SHIPTO_LBL' => '�ͻ��ַ',
	'PHPSHOP_USER_FORM_ADD_SHIPTO_LBL' => '��ӵ�ַ',
	'PHPSHOP_USER_FORM_NO_SHIPPING_ADDRESSES' => 'No shipping addresses.',
	'PHPSHOP_USER_FORM_ADDRESS_LABEL' => '��ַ����',
	'PHPSHOP_USER_FORM_FIRST_NAME' => '��',
	'PHPSHOP_USER_FORM_LAST_NAME' => '��',
	'PHPSHOP_USER_FORM_MIDDLE_NAME' => '����',
	'PHPSHOP_USER_FORM_TITLE' => '�ƺ�',
	'PHPSHOP_USER_FORM_USERNAME' => '��Ա���',
	'PHPSHOP_USER_FORM_PASSWORD_1' => '����',
	'PHPSHOP_USER_FORM_PASSWORD_2' => 'ȷ������',
	'PHPSHOP_USER_FORM_PERMS' => 'Ȩ��',
	'PHPSHOP_USER_FORM_CUSTOMER_NUMBER' => 'Customer Number / ID',
	'PHPSHOP_USER_FORM_COMPANY_NAME' => '��˾��',
	'PHPSHOP_USER_FORM_ADDRESS_1' => '��ַ1',
	'PHPSHOP_USER_FORM_ADDRESS_2' => '��ַ2',
	'PHPSHOP_USER_FORM_CITY' => '����',
	'PHPSHOP_USER_FORM_STATE' => 'ʡ��/����',
	'PHPSHOP_USER_FORM_ZIP' => '�ʱ�',
	'PHPSHOP_USER_FORM_COUNTRY' => '���',
	'PHPSHOP_USER_FORM_PHONE' => '�绰',
	'PHPSHOP_USER_FORM_PHONE2' => 'Mobile Phone',
	'PHPSHOP_USER_FORM_FAX' => '����',
	'PHPSHOP_USER_FORM_EMAIL' => 'Email',
	'PHPSHOP_MODULE_LIST_MNU' => '��ʾģ���б�',
	'PHPSHOP_MODULE_LIST_LBL' => 'ģ���б�',
	'PHPSHOP_MODULE_LIST_NAME' => 'ģ����',
	'PHPSHOP_MODULE_LIST_PERMS' => 'ģ�����',
	'PHPSHOP_MODULE_LIST_FUNCTIONS' => '����',
	'PHPSHOP_MODULE_LIST_ORDER' => '��ʾ�����б�',
	'PHPSHOP_MODULE_FORM_MNU' => '���ģ��',
	'PHPSHOP_MODULE_FORM_LBL' => 'ģ����Ϣ',
	'PHPSHOP_MODULE_FORM_MODULE_LABEL' => 'ģ�����(���ڶ����˵�)',
	'PHPSHOP_MODULE_FORM_NAME' => 'ģ����',
	'PHPSHOP_MODULE_FORM_PERMS' => 'ģ�����',
	'PHPSHOP_MODULE_FORM_HEADER' => 'ģ��ͷ',
	'PHPSHOP_MODULE_FORM_FOOTER' => 'ģ���',
	'PHPSHOP_MODULE_FORM_MENU' => '�ڹ���˵�����ʾģ��?',
	'PHPSHOP_MODULE_FORM_ORDER' => '��ʾ˳��',
	'PHPSHOP_MODULE_FORM_DESCRIPTION' => 'ģ������',
	'PHPSHOP_MODULE_FORM_LANGUAGE_CODE' => '���Դ���',
	'PHPSHOP_MODULE_FORM_LANGUAGE_file' => '�����ļ�',
	'PHPSHOP_FUNCTION_LIST_MNU' => '��ʾ�����',
	'PHPSHOP_FUNCTION_LIST_LBL' => '�����б�',
	'PHPSHOP_FUNCTION_LIST_NAME' => '������',
	'PHPSHOP_FUNCTION_LIST_CLASS' => '����',
	'PHPSHOP_FUNCTION_LIST_METHOD' => '�෽��',
	'PHPSHOP_FUNCTION_LIST_PERMS' => '����',
	'PHPSHOP_FUNCTION_FORM_MNU' => '��Ӻ���',
	'PHPSHOP_FUNCTION_FORM_LBL' => '������Ϣ',
	...
	'PHPSHOP_CURRENCY_LIST_MNU' => '��ʾ����б�',
	'PHPSHOP_CURRENCY_LIST_LBL' => '����б�',
	'PHPSHOP_CURRENCY_LIST_ADD' => '��ӻ��',
	'PHPSHOP_CURRENCY_LIST_NAME' => '�����',
	'PHPSHOP_CURRENCY_LIST_CODE' => '��Ҵ���',
	'PHPSHOP_COUNTRY_LIST_MNU' => '��ʾ����б�',
	'PHPSHOP_COUNTRY_LIST_LBL' => '����б�',
	'PHPSHOP_COUNTRY_LIST_ADD' => '��ӹ��',
	'PHPSHOP_COUNTRY_LIST_NAME' => '�����',
	'PHPSHOP_COUNTRY_LIST_3_CODE' => '��Ҵ���(3)',
	'PHPSHOP_COUNTRY_LIST_2_CODE' => '��Ҵ���(2)',
	...
	'PHPSHOP_ADDRESS' => '��ַ',
	'PHPSHOP_CONTINUE' => '����',
	'PHPSHOP_EMPTY_CART' => '��Ĺ��ﳵ���ڻ��ǿյġ�',
	'PHPSHOP_ISSHIPPING_MOD' => 'InterShipper',
	'PHPSHOP_ISSHIP_PING_MNU' => 'Ping InterShipper�ķ�����',
	'PHPSHOP_ISSHIP_PING_LBL' => 'InterShipper-Server Ping ',
	'PHPSHOP_ISSHIP_PING_ERROR_LBL' => 'InterShipper Ping��ͨ',
	'PHPSHOP_ISSHIP_PING_GOOD_LBL' => 'InterShipper Ping�ɹ�',
	'PHPSHOP_ISSHIP_PING_CARRIER_LBL' => '���乤��',
	'PHPSHOP_ISSHIP_PING_RESPONSE_LBL' => '��!<BR>ʱ��',
	'PHPSHOP_ISSHIP_PING_TIME_LBL' => '��',
	'PHPSHOP_ISSHIP_LIST_MNU' => '��ʾ����ʽ',
	'PHPSHOP_ISSHIP_LIST_LBL' => '���õķ���ʽ',
	'PHPSHOP_ISSHIP_LIST_CARRIER_LBL' => '����ʽ',
	'PHPSHOP_ISSHIP_LIST_PUBLISH_LBL' => '����',
	'PHPSHOP_ISSHIP_LIST_RATE_LBL' => '�����',
	'PHPSHOP_ISSHIP_LIST_LEAD_LBL' => '����ʱ��',
	'PHPSHOP_ISSHIP_LIST_CHARGE_F_LBL' => 'ͳһ����',
	'PHPSHOP_ISSHIP_LIST_CHARGE_P_LBL' => '�ٷֱ�',
	'PHPSHOP_ISSHIP_LIST_DAYS_LBL' => '����',
	'PHPSHOP_ISSHIP_LIST_HEAVY_LBL' => '����',
	'PHPSHOP_ISSHIP_FORM_MNU' => 'ȷ�����䷽ʽ',
	'PHPSHOP_ISSHIP_FORM_ADD_LBL' => '������䷽ʽ',
	'PHPSHOP_ISSHIP_FORM_UPDATE_LBL' => 'ȷ�����䷽ʽ',
	'PHPSHOP_ISSHIP_FORM_REFRESH_LBL' => 'ˢ��',
	'PHPSHOP_ISSHIP_FORM_CARRIER_LBL' => '���䷽ʽ',
	'PHPSHOP_ISSHIP_FORM_PUBLISH_LBL' => '����',
	'PHPSHOP_ISSHIP_FORM_HANDLING_LBL' => '�����',
	'PHPSHOP_ISSHIP_FORM_LEAD_LBL' => '����ʱ��',
	'PHPSHOP_ISSHIP_FORM_CHARGE_F_LBL' => 'ͳһ����',
	'PHPSHOP_ISSHIP_FORM_CHARGE_P_LBL' => '�ٷֱ�',
	'PHPSHOP_ISSHIP_FORM_DAYS_LBL' => '����',
	'PHPSHOP_ISSHIP_FORM_HEAVY_LBL' => '����',
	'PHPSHOP_ORDER_MOD' => '����',
	'PHPSHOP_ORDER_CONFIRM_MNU' => 'ȷ������',
	'PHPSHOP_ORDER_CANCEL_MNU' => 'ȡ��',
	'PHPSHOP_ORDER_PRINT_MNU' => '��ӡ����',
	'PHPSHOP_ORDER_DELETE_MNU' => 'ɾ��',
	'PHPSHOP_ORDER_LIST_MNU' => '��ʾ�����б�',
	'PHPSHOP_ORDER_LIST_LBL' => '�����б�',
	'PHPSHOP_ORDER_LIST_ID' => '������',
	'PHPSHOP_ORDER_LIST_CDATE' => '��������',
	'PHPSHOP_ORDER_LIST_MDATE' => '����޸�',
	'PHPSHOP_ORDER_LIST_STATUS' => '״̬',
	'PHPSHOP_ORDER_LIST_TOTAL' => 'С��',
	'PHPSHOP_ORDER_ITEM' => 'Item����',
	'PHPSHOP_ORDER_PRINT_PO_LBL' => '����',
	'PHPSHOP_ORDER_PRINT_PO_NUMBER' => '������',
	'PHPSHOP_ORDER_PRINT_PO_DATE' => '��������',
	'PHPSHOP_ORDER_PRINT_PO_STATUS' => '����״̬',
	'PHPSHOP_ORDER_PRINT_CUST_INFO_LBL' => '�ͻ���Ϣ',
	'PHPSHOP_ORDER_PRINT_CUST_BILLING_LBL' => '������Ϣ',
	'PHPSHOP_ORDER_PRINT_CUST_SHIPPING_LBL' => '�ͻ���Ϣ',
	'PHPSHOP_ORDER_PRINT_BILL_TO_LBL' => '����',
	'PHPSHOP_ORDER_PRINT_SHIP_TO_LBL' => '����',
	'PHPSHOP_ORDER_PRINT_NAME' => '����',
	'PHPSHOP_ORDER_PRINT_COMPANY' => '��˾',
	'PHPSHOP_ORDER_PRINT_ADDRESS_1' => '��ַ1',
	'PHPSHOP_ORDER_PRINT_ADDRESS_2' => '��ַ2',
	'PHPSHOP_ORDER_PRINT_CITY' => '����',
	'PHPSHOP_ORDER_PRINT_STATE' => 'ʡ��/����',
	'PHPSHOP_ORDER_PRINT_ZIP' => '�ʱ�',
	'PHPSHOP_ORDER_PRINT_COUNTRY' => '���',
	'PHPSHOP_ORDER_PRINT_PHONE' => '�绰',
	'PHPSHOP_ORDER_PRINT_FAX' => '����',
	'PHPSHOP_ORDER_PRINT_EMAIL' => 'Email',
	'PHPSHOP_ORDER_PRINT_ITEMS_LBL' => '��Ʒ����',
	'PHPSHOP_ORDER_PRINT_QUANTITY' => '��',
	'PHPSHOP_ORDER_PRINT_QTY' => '��',
	'PHPSHOP_ORDER_PRINT_SKU' => 'SKU',
	'PHPSHOP_ORDER_PRINT_PRICE' => '�۸�',
	'PHPSHOP_ORDER_PRINT_TOTAL' => '�ܼ�',
	'PHPSHOP_ORDER_PRINT_SUBTOTAL' => 'С��',
	'PHPSHOP_ORDER_PRINT_TOTAL_TAX' => '˰���ܼ�',
	'PHPSHOP_ORDER_PRINT_SHIPPING' => '����',
	'PHPSHOP_ORDER_PRINT_SHIPPING_TAX' => '����˰��',
	'PHPSHOP_ORDER_PRINT_PAYMENT_LBL' => '���ʽ',
	'PHPSHOP_ORDER_PRINT_ACCOUNT_NAME' => '�ʺ���',
	'PHPSHOP_ORDER_PRINT_ACCOUNT_NUMBER' => '�ʺ�',
	'PHPSHOP_ORDER_PRINT_EXPIRE_DATE' => '����ʱ��',
	'PHPSHOP_ORDER_PRINT_PAYMENT_LOG_LBL' => '�����¼',
	'PHPSHOP_ORDER_PRINT_SHIPPING_LBL' => '������Ϣ',
	'PHPSHOP_ORDER_PRINT_PAYINFO_LBL' => '������Ϣ',
	'PHPSHOP_ORDER_PRINT_SHIPPING_CARRIER_LBL' => '���乤��',
	'PHPSHOP_ORDER_PRINT_SHIPPING_MODE_LBL' => '����ģʽ',
	'PHPSHOP_ORDER_PRINT_SHIPPING_DATE_LBL' => '��������',
	'PHPSHOP_ORDER_PRINT_SHIPPING_PRICE_LBL' => '�������',
	'PHPSHOP_ORDER_STATUS_LIST_MNU' => '��ʾ����״̬����',
	'PHPSHOP_ORDER_STATUS_FORM_MNU' => '��Ӷ���״̬����',
	...
	'PHPSHOP_PRODUCT_MOD' => '��Ʒ',
	'PHPSHOP_CURRENT_PRODUCT' => '������Ʒ',
	'PHPSHOP_CURRENT_ITEM' => '������Ŀ',
	'PHPSHOP_PRODUCT_INVENTORY_LBL' => '��Ʒ���',
	'PHPSHOP_PRODUCT_INVENTORY_MNU' => '�鿴���',
	'PHPSHOP_PRODUCT_INVENTORY_PRICE' => '�۸�',
	'PHPSHOP_PRODUCT_INVENTORY_STOCK' => '��',
	'PHPSHOP_PRODUCT_INVENTORY_WEIGHT' => '��',
	'PHPSHOP_PRODUCT_LIST_MNU' => '��ʾ��Ʒ�б�',
	'PHPSHOP_PRODUCT_LIST_LBL' => '��Ʒ�б�',
	'PHPSHOP_PRODUCT_LIST_NAME' => '��Ʒ��',
	...
	'PHPSHOP_PRODUCT_FORM_MNU' => '�����Ʒ',
	'PHPSHOP_PRODUCT_FORM_EDIT_PRODUCT' => '�༭��Ʒ',
	'PHPSHOP_PRODUCT_FORM_SHOW_FLYPAGE' => '�鿴��Ʒ����',
	'PHPSHOP_PRODUCT_FORM_ADD_ITEM_MNU' => '�����Ʒ',
	'PHPSHOP_PRODUCT_FORM_ADD_ANOTHER_ITEM_MNU' => '�����һ����Ʒ',
	'PHPSHOP_PRODUCT_FORM_NEW_PRODUCT_LBL' => '������Ʒ',
	'PHPSHOP_PRODUCT_FORM_UPDATE_PRODUCT_LBL' => '������Ʒ',
	'PHPSHOP_PRODUCT_FORM_PRODUCT_INFO_LBL' => '��Ʒ��Ϣ',
	'PHPSHOP_PRODUCT_FORM_PRODUCT_STATUS_LBL' => '��Ʒ״̬',
	'PHPSHOP_PRODUCT_FORM_PRODUCT_DIM_WEIGHT_LBL' => '��Ʒ������',
	'PHPSHOP_PRODUCT_FORM_PRODUCT_IMAGES_LBL' => '��ƷͼƬ',
	'PHPSHOP_PRODUCT_FORM_NEW_ITEM_LBL' => '������Ŀ',
	'PHPSHOP_PRODUCT_FORM_UPDATE_ITEM_LBL' => '������Ŀ',
	'PHPSHOP_PRODUCT_FORM_ITEM_INFO_LBL' => '��Ŀ��Ϣ',
	'PHPSHOP_PRODUCT_FORM_ITEM_STATUS_LBL' => '��Ŀ״̬',
	'PHPSHOP_PRODUCT_FORM_ITEM_DIM_WEIGHT_LBL' => '��Ŀ��������',
	'PHPSHOP_PRODUCT_FORM_ITEM_IMAGES_LBL' => '��ĿͼƬ',
	'PHPSHOP_PRODUCT_FORM_RETURN_LBL' => '������һ����Ʒ',
	'PHPSHOP_PRODUCT_FORM_IMAGE_UPDATE_LBL' => 'Ҫ��������ͼƬ����������ͼƬ�ĵ�ַ��',
	'PHPSHOP_PRODUCT_FORM_IMAGE_DELETE_LBL' => '���� ',
	'PHPSHOP_PRODUCT_FORM_PRODUCT_ITEMS_LBL' => '��ƷItems',
	'PHPSHOP_PRODUCT_FORM_ITEM_ATTRIBUTES_LBL' => 'Item����',
	'PHPSHOP_PRODUCT_FORM_DELETE_PRODUCT_MSG' => '��ȷ��Ҫɾ����ص���Ʒ����Ʒ��?',
	'PHPSHOP_PRODUCT_FORM_DELETE_ITEM_MSG' => '����ɾ�����Ʒ��?',
	'PHPSHOP_PRODUCT_FORM_VENDOR' => '����',
	'PHPSHOP_PRODUCT_FORM_MANUFACTURER' => '������',
	'PHPSHOP_PRODUCT_FORM_SKU' => 'SKU',
	'PHPSHOP_PRODUCT_FORM_NAME' => '��Ʒ��',
	'PHPSHOP_PRODUCT_FORM_URL' => 'URL',
	'PHPSHOP_PRODUCT_FORM_CATEGORY' => '���',
	'PHPSHOP_PRODUCT_FORM_PRICE_GROSS' => '���ۼ�',
	'PHPSHOP_PRODUCT_FORM_PRICE_NET' => 'Product Price (Net)',
	'PHPSHOP_PRODUCT_FORM_DESCRIPTION' => '���ҳ����',
	'PHPSHOP_PRODUCT_FORM_S_DESC' => '�������',
	'PHPSHOP_PRODUCT_FORM_IN_STOCK' => '�п��',
	'PHPSHOP_PRODUCT_FORM_ON_ORDER' => '�Ѷ���',
	'PHPSHOP_PRODUCT_FORM_AVAILABLE_DATE' => '��Ч����',
	'PHPSHOP_PRODUCT_FORM_SPECIAL' => '�ؼ۳���',
	'PHPSHOP_PRODUCT_FORM_DISCOUNT_TYPE' => '�ۿ�����',
	'PHPSHOP_PRODUCT_FORM_PUBLISH' => '����?',
	'PHPSHOP_PRODUCT_FORM_LENGTH' => '��',
	'PHPSHOP_PRODUCT_FORM_WIDTH' => '��',
	'PHPSHOP_PRODUCT_FORM_HEIGHT' => '��',
	'PHPSHOP_PRODUCT_FORM_DIMENSION_UOM' => '����λ',
	'PHPSHOP_PRODUCT_FORM_WEIGHT' => '��',
	'PHPSHOP_PRODUCT_FORM_WEIGHT_UOM' => '����λ',
	'PHPSHOP_PRODUCT_FORM_THUMB_IMAGE' => '����ͼ',
	'PHPSHOP_PRODUCT_FORM_FULL_IMAGE' => '����ͼƬ',
	...
	'PHPSHOP_PRODUCT_DISPLAY_ADD_PRODUCT_LBL' => '��Ʒ��ӽ��',
	'PHPSHOP_PRODUCT_DISPLAY_UPDATE_PRODUCT_LBL' => '��Ʒ���½��',
	'PHPSHOP_PRODUCT_DISPLAY_ADD_ITEM_LBL' => '��Ʒ��ӽ��',
	'PHPSHOP_PRODUCT_DISPLAY_UPDATE_ITEM_LBL' => '��Ʒ���½��',
	'PHPSHOP_PRODUCT_CSV_UPLOAD' => '��CSV�ϴ�',
	'PHPSHOP_PRODUCT_FOLDERS' => '��Ʒ�ļ���',
	'PHPSHOP_CATEGORY_LIST_MNU' => '����б�',
	'PHPSHOP_CATEGORY_LIST_LBL' => '�����',
	'PHPSHOP_CATEGORY_FORM_MNU' => '������',
	'PHPSHOP_CATEGORY_FORM_LBL' => '�����Ϣ',
	...
	'PHPSHOP_ATTRIBUTE_LIST_MNU' => '�����б�',
	'PHPSHOP_ATTRIBUTE_LIST_LBL' => '����',
	'PHPSHOP_ATTRIBUTE_LIST_NAME' => '������',
	'PHPSHOP_ATTRIBUTE_LIST_ORDER' => '�����б�',
	'PHPSHOP_ATTRIBUTE_FORM_MNU' => '�������',
	'PHPSHOP_ATTRIBUTE_FORM_LBL' => '����',
	'PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_PRODUCT' => 'Ϊ��Ʒ����µ�����',
	'PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_PRODUCT' => '������Ʒ����',
	'PHPSHOP_ATTRIBUTE_FORM_NEW_FOR_ITEM' => '�½���Ʒ����',
	'PHPSHOP_ATTRIBUTE_FORM_UPDATE_FOR_ITEM' => '������Ʒ����',
	'PHPSHOP_ATTRIBUTE_FORM_NAME' => '������',
	'PHPSHOP_ATTRIBUTE_FORM_ORDER' => '����˳��',
	'PHPSHOP_PRICE_LIST_MNU' => '����б�',
	'PHPSHOP_PRICE_LIST_LBL' => '�۸���',
	'PHPSHOP_PRICE_LIST_FOR_LBL' => '�۸�-',
	'PHPSHOP_PRICE_LIST_GROUP_NAME' => '����',
	'PHPSHOP_PRICE_LIST_PRICE' => '�۸�',
	'PHPSHOP_PRODUCT_LIST_CURRENCY' => '���',
	'PHPSHOP_PRICE_FORM_MNU' => '��Ӽ۸�',
	'PHPSHOP_PRICE_FORM_LBL' => '�۸���Ϣ',
	'PHPSHOP_PRICE_FORM_NEW_FOR_PRODUCT' => '�½���Ʒ�۸�',
	'PHPSHOP_PRICE_FORM_UPDATE_FOR_PRODUCT' => '������Ʒ�۸�',
	'PHPSHOP_PRICE_FORM_NEW_FOR_ITEM' => '�½���Ʒ�۸�',
	'PHPSHOP_PRICE_FORM_UPDATE_FOR_ITEM' => '������Ʒ�۸�',
	'PHPSHOP_PRICE_FORM_PRICE' => '�۸�',
	'PHPSHOP_PRICE_FORM_CURRENCY' => '���',
	'PHPSHOP_PRICE_FORM_GROUP' => '�����Ա��',
	'PHPSHOP_REPORTBASIC_MOD' => '����',
	'PHPSHOP_RB_INDIVIDUAL' => '���2�Ʒ�б�',
	'PHPSHOP_RB_SALE_TITLE' => '���۱���',
	'PHPSHOP_RB_SALES_PAGE_TITLE' => '���ۻ����',
	'PHPSHOP_RB_INTERVAL_TITLE' => '����ʱ����',
	'PHPSHOP_RB_INTERVAL_MONTHLY_TITLE' => 'ÿ��',
	'PHPSHOP_RB_INTERVAL_WEEKLY_TITLE' => 'ÿ��',
	'PHPSHOP_RB_INTERVAL_DAILY_TITLE' => 'ÿ��',
	'PHPSHOP_RB_THISMONTH_BUTTON' => '����',
	'PHPSHOP_RB_LASTMONTH_BUTTON' => '����',
	'PHPSHOP_RB_LAST60_BUTTON' => '���60��',
	'PHPSHOP_RB_LAST90_BUTTON' => '���90��',
	'PHPSHOP_RB_START_DATE_TITLE' => '��ʼ��',
	'PHPSHOP_RB_END_DATE_TITLE' => '������',
	'PHPSHOP_RB_SHOW_SEL_RANGE' => '��ʾѡ��Χ�ڵ���Ʒ',
	'PHPSHOP_RB_REPORT_FOR' => '������� ',
	'PHPSHOP_RB_DATE' => '����',
	'PHPSHOP_RB_ORDERS' => '����',
	'PHPSHOP_RB_TOTAL_ITEMS' => '�����Ʒ����',
	'PHPSHOP_RB_REVENUE' => '����',
	'PHPSHOP_RB_PRODLIST' => '��Ʒ�б�',
	'PHPSHOP_SHOP_MOD' => '�̳�',
	'PHPSHOP_PRODUCT_THUMB_TITLE' => '����ͼ',
	'PHPSHOP_PRODUCT_PRICE_TITLE' => '�۸�',
	'PHPSHOP_ORDER_STATUS_P' => 'Ϊ���',
	'PHPSHOP_ORDER_STATUS_C' => 'ȷ��',
	'PHPSHOP_ORDER_STATUS_X' => 'ȡ��',
	'PHPSHOP_ORDER_BUTTON' => '����',
	'PHPSHOP_SHOPPER_MOD' => '������',
	'PHPSHOP_SHOPPER_LIST_MNU' => '��ʾ�����Ա�б�',
	'PHPSHOP_SHOPPER_LIST_LBL' => '�����Ա�б�',
	'PHPSHOP_SHOPPER_LIST_USERNAME' => '��Ա��',
	'PHPSHOP_SHOPPER_LIST_NAME' => 'ȫ��',
	'PHPSHOP_SHOPPER_LIST_GROUP' => '��',
	'PHPSHOP_SHOPPER_FORM_MNU' => '��ӹ����Ա',
	'PHPSHOP_SHOPPER_FORM_LBL' => '�����Ա��Ϣ',
	'PHPSHOP_SHOPPER_FORM_BILLTO_LBL' => '������Ϣ',
	'PHPSHOP_SHOPPER_FORM_ADDRESS_INFO_LBL' => '��Ϣ',
	'PHPSHOP_SHOPPER_FORM_SHIPTO_LBL' => '�ͻ���Ϣ',
	'PHPSHOP_SHOPPER_FORM_ADD_SHIPTO_LBL' => '��ӵ�ַ',
	'PHPSHOP_SHOPPER_FORM_ADDRESS_LABEL' => '��ַ����',
	...
	'PHPSHOP_SHOPPER_FORM_TITLE' => '�ƺ�',
	'PHPSHOP_SHOPPER_FORM_SHOPPERNAME' => '����ʱʹ�õĻ�Ա��',
	'PHPSHOP_SHOPPER_FORM_PASSWORD_1' => '����',
	'PHPSHOP_SHOPPER_FORM_PASSWORD_2' => 'ȷ������',
	'PHPSHOP_SHOPPER_FORM_GROUP' => '�����Ա��',
	'PHPSHOP_SHOPPER_FORM_COMPANY_NAME' => '��˾��',
	'PHPSHOP_SHOPPER_FORM_ADDRESS_1' => '��ַ1',
	'PHPSHOP_SHOPPER_FORM_ADDRESS_2' => '��ַ2',
	'PHPSHOP_SHOPPER_FORM_CITY' => '����',
	'PHPSHOP_SHOPPER_FORM_STATE' => 'ʡ��/����',
	'PHPSHOP_SHOPPER_FORM_ZIP' => '�ʱ�',
	'PHPSHOP_SHOPPER_FORM_COUNTRY' => '���',
	'PHPSHOP_SHOPPER_FORM_PHONE' => '�绰',
	...
	'PHPSHOP_SHOPPER_GROUP_LIST_MNU' => '�г����Ա��',
	'PHPSHOP_SHOPPER_GROUP_LIST_LBL' => '�����Ա���б�',
	'PHPSHOP_SHOPPER_GROUP_LIST_NAME' => '����',
	'PHPSHOP_SHOPPER_GROUP_LIST_DESCRIPTION' => '������',
	'PHPSHOP_SHOPPER_GROUP_FORM_LBL' => '�����Ա����',
	'PHPSHOP_SHOPPER_GROUP_FORM_MNU' => '��ӻ�Ա��',
	'PHPSHOP_SHOPPER_GROUP_FORM_NAME' => '����',
	'PHPSHOP_SHOPPER_GROUP_FORM_DESC' => '������',
	'PHPSHOP_STORE_MOD' => '�̳�',
	'PHPSHOP_STORE_FORM_MNU' => '�༭�̳�',
	'PHPSHOP_STORE_FORM_LBL' => '�̳���Ϣ',
	'PHPSHOP_STORE_FORM_CONTACT_LBL' => 'jϵ��Ϣ',
	'PHPSHOP_STORE_FORM_FULL_IMAGE' => '����ͼƬ',
	'PHPSHOP_STORE_FORM_UPLOAD' => '�ϴ�ͼƬ',
	'PHPSHOP_STORE_FORM_STORE_NAME' => '�̳����',
	'PHPSHOP_STORE_FORM_COMPANY_NAME' => '�̳�����˾',
	'PHPSHOP_STORE_FORM_ADDRESS_1' => '��ַ1',
	'PHPSHOP_STORE_FORM_ADDRESS_2' => '��ַ2',
	'PHPSHOP_STORE_FORM_CITY' => '����',
	'PHPSHOP_STORE_FORM_STATE' => 'ʡ��/����',
	'PHPSHOP_STORE_FORM_COUNTRY' => '���',
	'PHPSHOP_STORE_FORM_ZIP' => '�ʱ�',
	'PHPSHOP_STORE_FORM_PHONE' => '�绰',
	'PHPSHOP_STORE_FORM_CURRENCY' => '���',
	'PHPSHOP_STORE_FORM_CATEGORY' => '�̳Ƿ���',
	'PHPSHOP_STORE_FORM_LAST_NAME' => '��',
	'PHPSHOP_STORE_FORM_FIRST_NAME' => '��',
	'PHPSHOP_STORE_FORM_MIDDLE_NAME' => '����',
	'PHPSHOP_STORE_FORM_TITLE' => '�ƺ�',
	'PHPSHOP_STORE_FORM_PHONE_1' => '�绰',
	'PHPSHOP_STORE_FORM_PHONE_2' => '�绰',
	'PHPSHOP_STORE_FORM_FAX' => '����',
	'PHPSHOP_STORE_FORM_EMAIL' => 'Email',
	'PHPSHOP_STORE_FORM_IMAGE_PATH' => 'ͼƬ·��',
	'PHPSHOP_STORE_FORM_DESCRIPTION' => '����',
	'PHPSHOP_PAYMENT' => '֧��',
	'PHPSHOP_PAYMENT_METHOD_LIST_MNU' => '�г�֧����ʽ',
	'PHPSHOP_PAYMENT_METHOD_LIST_LBL' => '֧����ʽ�б�',
	'PHPSHOP_PAYMENT_METHOD_LIST_NAME' => '����',
	'PHPSHOP_PAYMENT_METHOD_LIST_CODE' => '����',
	'PHPSHOP_PAYMENT_METHOD_LIST_DISCOUNT' => '�ۿ�',
	'PHPSHOP_PAYMENT_METHOD_LIST_SHOPPER_GROUP' => '�����Ա��',
	'PHPSHOP_PAYMENT_METHOD_LIST_ENABLE_PROCESSOR' => '֧����ʽ',
	'PHPSHOP_PAYMENT_METHOD_FORM_MNU' => '���֧����ʽ',
	'PHPSHOP_PAYMENT_METHOD_FORM_LBL' => '֧����ʽ��',
	'PHPSHOP_PAYMENT_METHOD_FORM_NAME' => '֧���?��',
	'PHPSHOP_PAYMENT_METHOD_FORM_SHOPPER_GROUP' => '�����Ա��',
	'PHPSHOP_PAYMENT_METHOD_FORM_DISCOUNT' => '�ۿ�',
	'PHPSHOP_PAYMENT_METHOD_FORM_CODE' => '����',
	'PHPSHOP_PAYMENT_METHOD_FORM_LIST_ORDER' => '����˳��',
	'PHPSHOP_PAYMENT_METHOD_FORM_ENABLE_PROCESSOR' => '֧����ʽ',
	'PHPSHOP_TAX_MOD' => '˰��',
	'PHPSHOP_TAX_RATE' => '˰��',
	'PHPSHOP_TAX_LIST_MNU' => '˰�ʱ�',
	'PHPSHOP_TAX_LIST_LBL' => '˰�ʱ�',
	'PHPSHOP_TAX_LIST_STATE' => 'ʡ�ݻ����˰��',
	'PHPSHOP_TAX_LIST_COUNTRY' => '���˰��',
	'PHPSHOP_TAX_LIST_RATE' => '˰��',
	'PHPSHOP_TAX_FORM_MNU' => '���˰��',
	'PHPSHOP_TAX_FORM_LBL' => '���˰����Ϣ',
	'PHPSHOP_TAX_FORM_STATE' => 'ʡ�ݻ����˰��',
	'PHPSHOP_TAX_FORM_COUNTRY' => '���˰��',
	'PHPSHOP_TAX_FORM_RATE' => '˰��',
	'PHPSHOP_VENDOR_MOD' => '����',
	'PHPSHOP_VENDOR_ADMIN' => '����',
	'PHPSHOP_VENDOR_LIST_MNU' => '��ʾ�����б�',
	'PHPSHOP_VENDOR_LIST_LBL' => '�����б�',
	'PHPSHOP_VENDOR_LIST_VENDOR_NAME' => '������',
	'PHPSHOP_VENDOR_LIST_ADMIN' => '����',
	'PHPSHOP_VENDOR_FORM_MNU' => '�������',
	'PHPSHOP_VENDOR_FORM_LBL' => '�����Ϣ',
	'PHPSHOP_VENDOR_FORM_INFO_LBL' => '������Ϣ',
	'PHPSHOP_VENDOR_FORM_CONTACT_LBL' => 'jϵ��Ϣ',
	'PHPSHOP_VENDOR_FORM_FULL_IMAGE' => '����ͼƬ',
	'PHPSHOP_VENDOR_FORM_UPLOAD' => '�ϴ�ͼƬ',
	'PHPSHOP_VENDOR_FORM_STORE_NAME' => '����������',
	'PHPSHOP_VENDOR_FORM_COMPANY_NAME' => '����˾���',
	'PHPSHOP_VENDOR_FORM_ADDRESS_1' => '��ַ1',
	'PHPSHOP_VENDOR_FORM_ADDRESS_2' => '��ַ2',
	'PHPSHOP_VENDOR_FORM_CITY' => '����',
	'PHPSHOP_VENDOR_FORM_STATE' => 'ʡ��/����',
	'PHPSHOP_VENDOR_FORM_COUNTRY' => '���',
	'PHPSHOP_VENDOR_FORM_ZIP' => '�ʱ�',
	'PHPSHOP_VENDOR_FORM_PHONE' => '�绰',
	'PHPSHOP_VENDOR_FORM_CURRENCY' => '���',
	'PHPSHOP_VENDOR_FORM_CATEGORY' => '�������',
	'PHPSHOP_VENDOR_FORM_LAST_NAME' => '��',
	'PHPSHOP_VENDOR_FORM_FIRST_NAME' => '��',
	'PHPSHOP_VENDOR_FORM_MIDDLE_NAME' => '�м���',
	'PHPSHOP_VENDOR_FORM_TITLE' => 'ְ��',
	'PHPSHOP_VENDOR_FORM_PHONE_1' => '�绰1',
	'PHPSHOP_VENDOR_FORM_PHONE_2' => '�绰2',
	'PHPSHOP_VENDOR_FORM_FAX' => '����',
	'PHPSHOP_VENDOR_FORM_EMAIL' => 'Email',
	'PHPSHOP_VENDOR_FORM_IMAGE_PATH' => 'ͼƬ·��',
	'PHPSHOP_VENDOR_FORM_DESCRIPTION' => '����',
	'PHPSHOP_VENDOR_CAT_LIST_MNU' => '�г��������',
	'PHPSHOP_VENDOR_CAT_LIST_LBL' => '��������б�',
	...
	'PHPSHOP_MANUFACTURER_CAT_FORM_INFO_LBL' => '�����Ϣ',
	'PHPSHOP_MANUFACTURER_CAT_FORM_NAME' => '������',
	'PHPSHOP_MANUFACTURER_CAT_FORM_DESCRIPTION' => '���˵��',
	'PHPSHOP_HELP_MOD' => '����',
	'PHPSHOP_CART_ACTION' => '����',
	'PHPSHOP_CART_UPDATE' => '����',
	'PHPSHOP_CART_DELETE' => 'ɾ��',
	'PHPSHOP_PRODUCT_PRICETAG' => '�۸�',
	'PHPSHOP_PRODUCT_CALL' => '�绰����',
	'PHPSHOP_PRODUCT_PREVIOUS' => '��һ��',
	'PHPSHOP_PRODUCT_NEXT' => '��һ��',
	'PHPSHOP_CART_TAX' => '˰��',
	'PHPSHOP_CART_SHIPPING' => '�ͻ�',
	'PHPSHOP_CART_TOTAL' => '����',
	'PHPSHOP_CHECKOUT_NEXT' => '��һ��',
	'PHPSHOP_CHECKOUT_REGISTER' => 'ע��',
	'PHPSHOP_CHECKOUT_CONF_BILLINFO' => '������Ϣ',
	'PHPSHOP_CHECKOUT_CONF_COMPANY' => '��˾',
	'PHPSHOP_CHECKOUT_CONF_NAME' => '����',
	'PHPSHOP_CHECKOUT_CONF_ADDRESS' => '��ַ',
	'PHPSHOP_CHECKOUT_CONF_PHONE' => '�绰',
	...
	'PHPSHOP_CHECKOUT_CONF_PAYINFO' => '������Ϣ',
	'PHPSHOP_CHECKOUT_CONF_PAYINFO_NAMECARD' => '���ÿ��ϵ�����',
	'PHPSHOP_CHECKOUT_CONF_PAYINFO_METHOD' => '���ʽ',
	'PHPSHOP_CHECKOUT_CONF_PAYINFO_CCNUM' => '���ÿ���',
	'PHPSHOP_CHECKOUT_CONF_PAYINFO_EXDATE' => '����ʱ��',
	'PHPSHOP_CHECKOUT_CONF_PAYINFO_COMPORDER' => '��ɶ���',
	'PHPSHOP_CHECKOUT_CONF_PAYINFO_REQINFO' => '��ѡ�����ÿ�����ʱ�ı�����Ϣ',
	'PHPSHOP_ZONE_MOD' => '�������ͷ�',
	'PHPSHOP_ZONE_LIST_MNU' => '�г����',
	'PHPSHOP_ZONE_FORM_MNU' => '��ӵ���',
	'PHPSHOP_ZONE_ASSIGN_MNU' => '�������',
	'PHPSHOP_ZONE_ASSIGN_COUNTRY_LBL' => '���',
	'PHPSHOP_ZONE_ASSIGN_CURRENT_LBL' => '���е���',
	'PHPSHOP_ZONE_ASSIGN_ASSIGN_LBL' => '���䵽����',
	'PHPSHOP_ZONE_ASSIGN_UPDATE_LBL' => '����',
	'PHPSHOP_ASSIGN_ZONE_PG_LBL' => '�������',
	'PHPSHOP_ZONE_FORM_NAME_LBL' => '������',
	'PHPSHOP_ZONE_FORM_DESC_LBL' => '��������',
	'PHPSHOP_ZONE_FORM_COST_PER_LBL' => 'ÿ����Ʒ�ĵ����˷�',
	'PHPSHOP_ZONE_FORM_COST_LIMIT_LBL' => '��������޶�',
	'PHPSHOP_ZONE_LIST_LBL' => '�����б�',
	'PHPSHOP_ZONE_LIST_NAME_LBL' => '������',
	'PHPSHOP_ZONE_LIST_DESC_LBL' => '��������',
	'PHPSHOP_ZONE_LIST_COST_PER_LBL' => 'ÿ����Ʒ�ĵ����˷�',
	'PHPSHOP_ZONE_LIST_COST_LIMIT_LBL' => '��������޶�',
	'PHPSHOP_LOGIN_FIRST' => '���ȵ�¼��ע��.<br>лл.',
	'PHPSHOP_STORE_FORM_TOS' => '�������',
	'PHPSHOP_AGREE_TO_TOS' => '������Ƚ������ǵķ�����',
	'PHPSHOP_I_AGREE_TO_TOS' => '��ͬ��˷������',
	'PHPSHOP_LEAVE_BLANK' => '(�����û�з�����һ��5�PHP�ļ������)',
	'PHPSHOP_RETURN_LOGIN' => '��ע��ͻ������¼',
	'PHPSHOP_NEW_CUSTOMER' => '�¿ͻ������ṩ��ĸ�����Ϣ',
	'PHPSHOP_ACC_CUSTOMER_ACCOUNT' => '�ͻ��ʺ�:',
	'PHPSHOP_ACC_ORDER_INFO' => '֧����Ϣ',
	'PHPSHOP_ACC_UPD_BILL' => '�ڴ�����Ը������֧����Ϣ.',
	'PHPSHOP_ACC_UPD_SHIP' => '�����������ӻ��޸�֧����Ϣ.',
	'PHPSHOP_ACC_ACCOUNT_INFO' => '�����ʻ���Ϣ',
	'PHPSHOP_ACC_SHIP_INFO' => '�ͻ���Ϣ',
	'PHPSHOP_ACC_NO_ORDERS' => 'û�п���ʾ�Ķ���',
	'PHPSHOP_ACC_BILL_DEF' => '- Ĭ�� (�븶����Ϣһ��)',
	'PHPSHOP_SHIPTO_TEXT' => '�������Ӷ���ͻ��ַ. ��Ϊ��ѡ���ͻ��ַȡһ����ʵı�������.',
	'PHPSHOP_CONFIG' => '����',
	'PHPSHOP_USERS' => '��Ա',
	'PHPSHOP_IS_CC_PAYMENT' => '�Ƿ�ʹ�����ÿ�֧��?',
	'PHPSHOP_SHIPPING_MOD' => '�������',
	'PHPSHOP_SHIPPING_MENU_LABEL' => '����',
	'PHPSHOP_CARRIER_LIST_MNU' => '������',
	'PHPSHOP_CARRIER_LIST_LBL' => '�������б�',
	'PHPSHOP_RATE_LIST_MNU' => '���䵥��',
	'PHPSHOP_RATE_LIST_LBL' => '���䵥���б�',
	'PHPSHOP_CARRIER_LIST_NAME_LBL' => '���',
	'PHPSHOP_CARRIER_LIST_ORDER_LBL' => '�б�˳��',
	'PHPSHOP_CARRIER_FORM_MNU' => '��ӷ�����',
	'PHPSHOP_CARRIER_FORM_LBL' => '���/�༭������',
	'PHPSHOP_RATE_FORM_MNU' => '������䵥��',
	'PHPSHOP_RATE_FORM_LBL' => '���/�༭���䵥��',
	'PHPSHOP_RATE_FORM_NAME' => '���䵥��˵��',
	'PHPSHOP_RATE_FORM_CARRIER' => '������',
	'PHPSHOP_RATE_FORM_COUNTRY' => '���',
	'PHPSHOP_RATE_FORM_ZIP_START' => '�ʱ���ʼ��ֵ',
	'PHPSHOP_RATE_FORM_ZIP_END' => '�ʱ������ֵ',
	'PHPSHOP_RATE_FORM_WEIGHT_START' => '��С��',
	'PHPSHOP_RATE_FORM_WEIGHT_END' => '�����',
	'PHPSHOP_RATE_FORM_VALUE' => '����',
	'PHPSHOP_RATE_FORM_PACKAGE_FEE' => '��İ�����',
	'PHPSHOP_RATE_FORM_CURRENCY' => '���',
	'PHPSHOP_RATE_FORM_VAT_ID' => '��ֵ˰����',
	'PHPSHOP_RATE_FORM_LIST_ORDER' => '�б�˳��',
	'PHPSHOP_SHIPPING_RATE_LIST_CARRIER_LBL' => '������',
	'PHPSHOP_SHIPPING_RATE_LIST_RATE_NAME' => '���䵥��˵��',
	'PHPSHOP_SHIPPING_RATE_LIST_RATE_WSTART' => '���� ...',
	'PHPSHOP_SHIPPING_RATE_LIST_RATE_WEND' => '... ��',
	'PHPSHOP_CARRIER_FORM_NAME' => '���乫˾',
	'PHPSHOP_CARRIER_FORM_LIST_ORDER' => '�б�˳��',
	'PHPSHOP_ERR_MSG_CARRIER_EXIST' => '����: ����������Ѿ�����',
	'PHPSHOP_ERR_MSG_CARRIER_ID_REQ' => '����: ��ѡ��һ�����',
	'PHPSHOP_ERR_MSG_CARRIER_INUSE' => '����: Ҫɾ����ǰ�ļ۸����ٱ���һ�����䵥��',
	'PHPSHOP_ERR_MSG_CARRIER_NOTFOUND' => '����: û���ҵ��÷�����',
	'PHPSHOP_ERR_MSG_RATE_CARRIER_ID_REQ' => '����: ��ѡ��һ�����',
	'PHPSHOP_ERR_MSG_RATE_CARRIER_ID_INV' => '����: û���ҵ��÷�����',
	'PHPSHOP_ERR_MSG_RATE_NAME_REQ' => '����: ��Ҫ��Ӽ۸�˵��',
	'PHPSHOP_ERR_MSG_RATE_COUNTRY_CODE_INV' => '����: �����Ҳ���ȷ������ҿ�����";"�ָ�',
	'PHPSHOP_ERR_MSG_RATE_WEIGHT_START_REQ' => '����: ��Ҫ�����С��',
	'PHPSHOP_ERR_MSG_RATE_WEIGHT_END_REQ' => '����: ��Ҫ��д�����',
	'PHPSHOP_ERR_MSG_RATE_WEIGHT_STARTEND_INV' => '����: ��С������С�������',
	'PHPSHOP_ERR_MSG_RATE_WEIGHT_VALUE_REQ' => '����: ��Ҫ������䵥��',
	'PHPSHOP_ERR_MSG_RATE_CURRENCY_ID_INV' => '����: ��ѡ��һ�ֻ��',
	'PHPSHOP_ERR_MSG_RATE_ID_REQ' => '����: ��Ҫ��д���䵥��',
	'PHPSHOP_INFO_MSG_PLEASE_SELECT' => '��ѡ��',
	'PHPSHOP_INFO_MSG_CARRIER' => '������',
	'PHPSHOP_INFO_MSG_SHIPPING_METHOD' => '���䵥��',
	'PHPSHOP_INFO_MSG_SHIPPING_PRICE' => '�۸�',
	'PHPSHOP_INFO_MSG_VAT_ZERO_LBL' => '0 (-��-)',
	'PHPSHOP_PAYMENT_FORM_CC' => '���ÿ�',
	'PHPSHOP_PAYMENT_FORM_USE_PP' => '����֧��',
	'PHPSHOP_PAYMENT_FORM_BANK_DEBIT' => '���л��',
	'PHPSHOP_PAYMENT_FORM_AO' => '�������',
	'PHPSHOP_CHECKOUT_MSG_2' => '��ѡ���ͻ��ַ',
	'PHPSHOP_CHECKOUT_MSG_3' => '��ѡ���ͻ�ʽ',
	'PHPSHOP_CHECKOUT_MSG_4' => '��ѡ��֧����ʽ',
	'PHPSHOP_CHECKOUT_MSG_99' => '��鿴������������ݲ�ȷ����Ķ���',
	'PHPSHOP_CHECKOUT_ERR_NO_SHIP' => '��ѡ���ͻ�ʽ',
	'PHPSHOP_CHECKOUT_ERR_OTHER_SHIP' => '��ѡ�������ͻ�ʽ',
	'PHPSHOP_CHECKOUT_ERR_NO_PAYM' => '��ѡ��֧����ʽ',
	'PHPSHOP_CHECKOUT_ERR_NO_CCNR' => '���������ÿ�����',
	'PHPSHOP_CHECKOUT_ERR_NO_CCNAME' => '������ֿ�������.',
	'PHPSHOP_CHECKOUT_ERR_NO_CCDATE' => '���ÿ����벻��ȷ',
	'PHPSHOP_CHECKOUT_ERR_NO_CCMON' => '���������ÿ��Ĺ����·�',
	'PHPSHOP_CHECKOUT_ERR_NO_CCYEAR' => '���������ÿ��Ĺ������',
	'PHPSHOP_CHECKOUT_ERR_CCDATE_INV' => '���ÿ��Ĺ���ʱ�䲻��ȷ',
	'PHPSHOP_CHECKOUT_ERR_NO_SHIPTO' => '��ѡ���ͻ��ַ',
	'PHPSHOP_CHECKOUT_ERR_CCNUM_INV' => '�ʻ����벻��ȷ',
	'PHPSHOP_CHECKOUT_ERR_EMPTY_CART' => '��Ĺ��ﳵ�ǿյ�',
	'PHPSHOP_CHECKOUT_ERR_NO_CARR' => '����: ��ѡ�����䷽ʽ',
	'PHPSHOP_CHECKOUT_ERR_RATE_NOT_FOUND' => '����: û���ҵ���ѡ������䵥��',
	'PHPSHOP_CHECKOUT_ERR_SHIPTO_NOT_FOUND' => '����: û���ҵ�����ͻ��ַ',
	'PHPSHOP_CHECKOUT_ERR_NO_CCDATA' => '����: û�����ÿ�����',
	'PHPSHOP_CHECKOUT_ERR_NO_CCNR_FOUND' => '����: ���ÿ�����û���ҵ�!',
	'PHPSHOP_CHECKOUT_ERR_TEST' => '�Բ�������ʹ�õ��ǲ��������ÿ�!',
	'PHPSHOP_CHECKOUT_ERR_NO_USER_DATA' => 'û���ҵ����û�!',
	'PHPSHOP_CHECKOUT_ERR_NO_BA_HOLDER_NAME' => '��û���ṩ���п�����',
	'PHPSHOP_CHECKOUT_ERR_NO_IBAN' => '��û���ṩ���IBAN.',
	'PHPSHOP_CHECKOUT_ERR_NO_BA_NUM' => '��û���ṩ�����ʺ�',
	'PHPSHOP_CHECKOUT_ERR_NO_BANK_SORT' => '��û���ṩ����������',
	'PHPSHOP_CHECKOUT_ERR_NO_BANK_NAME' => '�㻹û���ṩ�������.',
	'PHPSHOP_CHECKOUT_ERR_NO_VALID_STEP' => '���������һ����ȷ�Ĳ���!',
	'PHPSHOP_CHECKOUT_MSG_LOG' => '������Ϣ��¼�Ժ���.<BR>',
	'PHPSHOP_CHECKOUT_ERR_MIN_POV' => '��С����Ŀǰ��δ�ﵽ.',
	'PHPSHOP_CHECKOUT_ERR_MIN_POV2' => '���ǵ���С������:',
	'PHPSHOP_CHECKOUT_PAYMENT_CC' => '���ÿ�֧��',
	'PHPSHOP_CHECKOUT_PAYMENT_OTHER' => '����֧������',
	'PHPSHOP_CHECKOUT_PAYMENT_SELECT' => '��ѡ�����֧������:',
	'PHPSHOP_STORE_FORM_MPOV' => ' �̵��ܽ������ٵĶ������',
	'PHPSHOP_ACCOUNT_BANK_TITLE' => '�����ʻ���Ϣ',
	'PHPSHOP_ACCOUNT_LBL_BANK_ACCOUNT_NR' => '�ʺ�',
	...
	'PHPSHOP_MODULES' => 'ģ��',
	'PHPSHOP_FUNCTIONS' => '����',
	'PHPSHOP_SPECIAL_PRODUCTS' => '�ر��Ʒ',
	'PHPSHOP_CHECKOUT_CUSTOMER_NOTE' => '�����Ը�⣬�����¶�����¼',
	'PHPSHOP_ORDER_PRINT_CUSTOMER_NOTE' => '�ͻ�����',
	'PHPSHOP_INCLUDING_TAX' => '(��˰ $tax % tax)',
	'PHPSHOP_PLEASE_SEL_ITEM' => '��ѡ��һ����Ʒ',
	'PHPSHOP_PRODUCT_FORM_ITEM_LBL' => '��Ʒ',
	'PHPSHOP_DOWNLOADS_TITLE' => '��������',
	'PHPSHOP_DOWNLOADS_START' => '��ʼ����',
	'PHPSHOP_DOWNLOADS_INFO' => '����������EMAIL���յ�������ID������ʼ���ء�.',
	'PHPSHOP_DOWNLOADS_ERR_EXP' => '�Բ����������ʱ���ѹ���',
	'PHPSHOP_DOWNLOADS_ERR_MAX' => '�Բ������Ѿ��ﵽ��������ش���',
	'PHPSHOP_DOWNLOADS_ERR_INV' => '��Ч������ID!',
	'PHPSHOP_DOWNLOADS_ERR_SEND' => '���ܷ�����Ϣ��',
	'PHPSHOP_DOWNLOADS_SEND_MSG' => '��Ϣ�Ѿ����͵�',
	'PHPSHOP_DOWNLOADS_SEND_SUBJ' => '������ϢDownload-Info',
	'PHPSHOP_DOWNLOADS_SEND_MSG_1' => '�㶩�����ļ��Ѿ�׼��������',
	'PHPSHOP_DOWNLOADS_SEND_MSG_2' => '�������������������������ID',
	'PHPSHOP_DOWNLOADS_SEND_MSG_3' => 'ÿ���ļ��������ش�����: ',
	'PHPSHOP_DOWNLOADS_SEND_MSG_4' => '�ڵ�һ�����غ�ĵ�{expire}��ֹͣ����',
	'PHPSHOP_DOWNLOADS_SEND_MSG_5' => '����?',
	'PHPSHOP_DOWNLOADS_SEND_MSG_6' => '�ṩ������Ϣ���� ',
	'PHPSHOP_PRODUCT_FORM_DOWNLOADABLE' => '�����ص���Ʒ?',
	...
	'PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER1' => '��л��Ļݹ�!��Ľ�����Ϣ����.',
	'PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER2' => '��л��Ĺ��.',
	'PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER3' => '����?',
	'PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER4' => '���µĶ����Ѿ��յ�.',
	'PHPSHOP_CHECKOUT_EMAIL_SHOPPER_HEADER5' => 'ͨ������t�Ӳ鿴������Ϣ.',
	'PHPSHOP_CART_ERROR_NO_NEGATIVE' => '�����?��.',
	'PHPSHOP_CART_ERROR_NO_VALID_QUANTITY' => '������һ����Ч����Ʒ��.',
	'PHPSHOP_CART_STOCK_1' => 'ѡ�����������. ',
	'PHPSHOP_CART_STOCK_2' => '����������$product_in_stock��Ʒ����',
	'PHPSHOP_CART_STOCK_3' => '���˴�����Ʒ��ӵ��ȴ��е�.',
	'PHPSHOP_CART_SELECT_ITEM' => '�����Ʒ��ϸ������ѡ��һ���ʽ������!',
	...
	'PHPSHOP_AFFILIATE_EMAIL_MNU' => '���ʹ������ʼ�',
	'PHPSHOP_AFFILIATE_EMAIL_LBL' => '���ʹ������ʼ�',
	...
	'PHPSHOP_DELIVERY_TIME' => 'ͨ��������',
	'PHPSHOP_DELIVERY_INFORMATION' => '������Ϣ',
	'PHPSHOP_MORE_CATEGORIES' => '�������',
	'PHPSHOP_AVAILABILITY' => '��Ч',
	'PHPSHOP_CURRENTLY_NOT_AVAILABLE' => '���ֲ�Ʒ����û�п��',
	'PHPSHOP_PRODUCT_AVAILABLE_AGAIN' => '�ٴι�Ӧʱ��: ',
	'PHPSHOP_STATISTIC_SUMMARY' => 'ժҪ',
	'PHPSHOP_STATISTIC_STATISTICS' => 'ͳ��',
	'PHPSHOP_STATISTIC_CUSTOMERS' => '�˿�',
	'PHPSHOP_STATISTIC_ACTIVE_PRODUCTS' => '����Ĳ�Ʒ',
	'PHPSHOP_STATISTIC_INACTIVE_PRODUCTS' => '����Ļ�Ʒ',
	...
	'PHPSHOP_WAITING_LIST_THANKS' => '��л��ĵȴ� <br />���д�����ǽ�����֪ͨ��',
	'PHPSHOP_WAITING_LIST_NOTIFY_ME' => '������',
	'PHPSHOP_CHECK_OUT_THANK_YOU_PRINT_VIEW' => '��ӡ��ͼ',
	'PHPSHOP_ADMIN_CFG_AUTORIZE_OR_CYBERCASH' => '����ѡAuthorize.net����CyberCash�е�һ��',
	'PHPSHOP_ADMIN_CFG_FILE_STATUS' => ' �����ļ�״̬:',
	'PHPSHOP_ADMIN_CFG_FILE_STATUS_WRITEABLE' => '��д',
	'PHPSHOP_ADMIN_CFG_FILE_STATUS_UNWRITEABLE' => '����д',
	'PHPSHOP_ADMIN_CFG_GLOBAL' => 'ȫ��',
	'PHPSHOP_ADMIN_CFG_PATHANDURL' => '·�����ַ',
	'PHPSHOP_ADMIN_CFG_SITE' => 'վ��',
	'PHPSHOP_ADMIN_CFG_SHIPPING' => '�ͻ�',
	'PHPSHOP_ADMIN_CFG_CHECKOUT' => '����',
	'PHPSHOP_ADMIN_CFG_DOWNLOADABLEGOODS' => '����',
	'PHPSHOP_ADMIN_CFG_PAYEMENTOPTIONS' => '֧��',
	'PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE' => '������Ŀ¼',
	'PHPSHOP_ADMIN_CFG_USE_ONLY_AS_CATALOGUE_EXPLAIN' => '�����ѡ����������ȡ�����й��ﳵ���ܡ�',
	'PHPSHOP_ADMIN_CFG_SHOW_PRICES' => '��ʾ�۸�',
	'PHPSHOP_ADMIN_CFG_PRICES_INCLUDE_TAX' => '��ʾ��˰�ۣ�',
	'PHPSHOP_ADMIN_CFG_PRICES_INCLUDE_TAX_EXPLAIN' => '���ۼ۸��Ƿ�˰�����ñ�־��',
	'PHPSHOP_ADMIN_CFG_SHOW_PRICES_EXPLAIN' => 'ѡ������ʾ�۸� ���ʹ����Ŀ¼����, ��Щ����¿��ܲ���Ҫ��ҳ������ʾ�۸�',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX' => 'ʵ��˰��',
	'PHPSHOP_ADMIN_CFG_VIRTUAL_TAX_EXPLAIN' => '�⽫��������Ʒ�Ƿ�˰�� �޸� ps_checkout.php->calc_order_taxable()���Զ��塣',
	'PHPSHOP_ADMIN_CFG_TAX_MODE' => '˰��ģʽ:',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_SHIP' => '���ڹ����ߵ�ַ',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_VENDOR' => '���������ߵ�ַ',
	'PHPSHOP_ADMIN_CFG_TAX_MODE_EXPLAIN' => '�⽫���˼���˰���ʱ����ú���˰��: 
                                                ��ȡ������������˿ͷֱ�4���ĸ��ҡ�
                                                ',
	'PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE' => '���ö���˰��?',
	'PHPSHOP_ADMIN_CFG_MULTI_TAX_RATE_EXPLAIN' => '����������۵���Ʒ˰�ʲ�ͬ�Ļ���ѡ���� (����˵ͼ����7%��˰�ʣ���������Ʒ��16%��˰��)',
	'PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE' => '����˰��/�˷�֮ǰ��ȥ�ۿ�?',
	'PHPSHOP_ADMIN_CFG_REVIEW' => '���ÿͻ��<�ϵͳ',
	'PHPSHOP_ADMIN_CFG_REVIEW_EXPLAIN' => '������õĻ�, �㽫����˿� <strong>�<۲�Ʒ</strong> �Լ� <strong>׫д����</strong> �� <br />
                                                                                ����˿Ϳ���д�����ǵ����飬Ϊ��Ĺ˿��ṩ�ο��� <br />',
	'PHPSHOP_ADMIN_CFG_SUBSTRACT_PAYEMENT_BEFORE_EXPLAIN' => '�趨�����4�����˰��/�˷�֮ǰ��ȥ�ۿۻ���֮���ټ�ȥ�ۿۡ�',
	'PHPSHOP_ADMIN_CFG_ACCOUNT_CAN_BE_BLANK' => '�ͻ������������ǵ������ʻ���Ϣ?',
	'PHPSHOP_ADMIN_CFG_ACCOUNT_CAN_BE_BLANK_EXPLAIN' => '�����Ĺ˿�Ը����ע���ʱ����д���ǵ������˻���Ϣ�Ļ���ѡ����',
	'PHPSHOP_ADMIN_CFG_CAN_SELECT_STATE' => '�˿Ϳ���ѡ����/����?',
	'PHPSHOP_ADMIN_CFG_CAN_SELECT_STATE_EXPLAIN' => '�����Ĺ˿�Ը����ע���ʱ����д���ǵĹ��/����Ļ���ѡ����',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS' => '����ͬ��������?',
	'PHPSHOP_ADMIN_CFG_AGREE_TERMS_EXPLAIN' => '�����������Ĺ˿�ע���ʱ��ͬ�������ѡ����',
	'PHPSHOP_ADMIN_CFG_CHECK_STOCK' => '�����?',
	'PHPSHOP_ADMIN_CFG_CHECK_STOCK_EXPLAIN' => '�������û�����Ʒ��ӵ����ﳵ��ʱ���Ƿ�����ȼ���
                                                                                          ��������ˣ��̳���������˿���ӳ���������Ʒ��',
	'PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE' => '���ô����̳���?',
	'PHPSHOP_ADMIN_CFG_ENABLE_AFFILIATE_EXPLAIN' => '��������̳���̨���ô����̵Ļ����⽫�����̳�ǰ�����ô����̸��١�',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT' => '�����ʼ���ʽ:',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_TEXT' => '�ı��ʼ�',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_HTML' => 'HTML�ʼ�',
	'PHPSHOP_ADMIN_CFG_MAIL_FORMAT_EXPLAIN' => '�������Ķ���ȷ���ʼ����Ժ��ַ�ʽͶ��:<br />
                                                                                        <ul><li>�򵥵��ı��ʼ�</li>
                                                                                        <li>�����Ǵ���ͼƬ��HTML�ʼ���</li></ul>',
	'PHPSHOP_ADMIN_CFG_FRONTENDAMDIN' => '����Ǻ�̨�û�ʹ��ǰ�˹������?',
	'PHPSHOP_ADMIN_CFG_FRONTENDAMDIN_EXPLAIN' => '������������Ϊ��Щ�޷����ʺ�̨�������(����.Registered��Editor)���̳�����Ա����ǰ̨���?',
	'PHPSHOP_ADMIN_CFG_URLSECURE' => 'SECUREURL',
	'PHPSHOP_ADMIN_CFG_URLSECURE_EXPLAIN' => 'վ��İ�ȫ��ַ. (https��ͷ�� �Է�б�ܽ�β)',
	'PHPSHOP_ADMIN_CFG_PAGEPATH' => 'PAGEPATH',
	'PHPSHOP_ADMIN_CFG_HOMEPAGE' => 'HOMEPAGE',
	'PHPSHOP_ADMIN_CFG_HOMEPAGE_EXPLAIN' => '��ҳ����Ĭ������»ᱻ����',
	'PHPSHOP_ADMIN_CFG_ERRORPAGE' => 'ERRORPAGE',
	'PHPSHOP_ADMIN_CFG_ERRORPAGE_EXPLAIN' => '��ҳ���ڳ��ʱ��Ĭ�ϼ���',
	'PHPSHOP_ADMIN_CFG_DEBUGPAGE' => 'DEBUGPAGE',
	'PHPSHOP_ADMIN_CFG_DEBUGPAGE_EXPLAIN' => '��ҳ���ڵ���ʱ��Ĭ�ϼ���',
	'PHPSHOP_ADMIN_CFG_DEBUG' => '���� ?',
	'PHPSHOP_ADMIN_CFG_DEBUG_EXPLAIN' => '����?  	   	��򿪵��Ե����. �⽫��ѵ���ҳ����ʾ��ÿ����ҳ��ĵײ�������Ϣ���̳����Խ׶ηǳ����á�',
	'PHPSHOP_ADMIN_CFG_FLYPAGE' => '��Ʒ����',
	'PHPSHOP_ADMIN_CFG_FLYPAGE_EXPLAIN' => '������ʾ��Ʒ�����Ĭ��ҳ��.',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE' => 'Ŀ¼ģ��',
	'PHPSHOP_ADMIN_CFG_CATEGORY_TEMPLATE_EXPLAIN' => '�ⶨ������Ŀ¼����ʾ��ƷĬ�ϵ�Ŀ¼ģ�塣<br />
                                                                                                      ������޸�����ģ���Դ�����ģ���ļ���<br />
                                                                                                      (λ��<strong>COMPONENTPATH/html/templates/</strong> Ŀ¼���棬����ԡ�browse_����ʼ)',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW' => 'ÿ����Ĭ����Ʒ��Ŀ',
	'PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN' => '���ﶨ����ÿ������ʾ��Ʒ����Ŀ <br />
                                                                                                      ���磬���������Ϊ4,��ôĿ¼ģ���оͻ���ÿ����ʾ�ĸ���Ʒ��',
	'PHPSHOP_ADMIN_CFG_NOIMAGEPAGE' => '����ͼƬ����ͼƬ',
	'PHPSHOP_ADMIN_CFG_NOIMAGEPAGE_EXPLAIN' => '����Ʒ��ͼƬ����ʱ����ʾ��ͼƬ��',
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION' => '��ʾ�űꡰpowered by mambo-phpShop�� ?',
	'PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION_EXPLAIN' => '��ʾһ��powered-by-mambo-phpShop�Ľű�ͼƬ��',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD' => 'ѡ���̳��ͻ�ʽ',
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_STANDARD' => 'ʹ�������õ����������˷ѵı�׼�ͻ�ģ�顣<strong>�Ƽ� !</strong>',
	...
	'PHPSHOP_ADMIN_CFG_STORE_SHIPPING_METHOD_DISABLE' => 'ȡ���ͻ�ģ��ѡ��',
	...
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR' => '���ý�����',
	'PHPSHOP_ADMIN_CFG_ENABLE_CHECKOUTBAR_EXPLAIN' => '��������ڹ˿ͽ��˹������ʾ���ʽ����(��ʾ1-2-3-4��ͼƬ�����)��ѡ����',
	'PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS' => '��ʾ���̵�Ľ��ʽ����',
	'PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_STANDARD' => '<strong>��׼��� :</strong><br/>
               1. ȷ���ͻ��ַ<br />
              2. ȷ���ͻ�ʽ<br />
              3. ȷ��֧����ʽ<br />
              4. ��ɶ���',
	'PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_2' => '<strong>��̶�</strong><br/>
               1.  ȷ���ͻ��ַ<br />
              2. ȷ��֧����ʽt<br />
              3. ��ɶ���',
	'PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_3' => '<strong>�����:</strong><br/>
               1. ȷ���ͻ�ʽ<br />
              2. ȷ��֧����ʽ<br />
              3. ��ɶ���',
	'PHPSHOP_ADMIN_CFG_CHECKOUT_PROCESS_4' => '<strong>�����:</strong><br/>
               1. ȷ��֧����ʽ<br />
              2. ��ɶ���',
	'PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS' => '��������',
	'PHPSHOP_ADMIN_CFG_ENABLE_DOWNLOADS_EXPLAIN' => 'ѡ�������������ع��ܡ����������ۿ�������Ʒ�����',
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).',
	...
	'PHPSHOP_SEARCH_ALL_CATEGORIES' => 'ѡ������Ŀ¼',
	'PHPSHOP_SEARCH_ALL_PRODINFO' => '����������Ʒ��Ϣ',
	'PHPSHOP_SEARCH_PRODNAME' => 'ֻ������Ʒ���',
	'PHPSHOP_SEARCH_MANU_VENDOR' => 'ֻ����������/������',
	'PHPSHOP_SEARCH_DESCRIPTION' => 'ֻ������Ʒ����',
	'PHPSHOP_SEARCH_AND' => '��',
	'PHPSHOP_SEARCH_NOT' => '��',
	'PHPSHOP_SEARCH_TEXT1' => '��һ����-�б���������ѡ����ƷĿ¼����������Χ�� 
        �ڶ�����-�б����Խ��������Χ���Ƶ���Ʒ��Ϣ�ض�λ�á� (����˵��Ʒ���)�� 
        ������ѡ�����������������ؼ��֣��Ա�����Ϊ�������Ӧ����Ϣ�� ',
	'PHPSHOP_SEARCH_TEXT2' => ' �������Ӷ��������ؼ��ֲ����á��롱�����ǡ����������������������ʡ�
        ѡ���롱 ��ζ��ͬʱ��}��ؼ�����Ʒ����������������֮�С�
        ��ѡ�񡰷ǡ�����ζ��������������а��һ��ؼ��ֶ��(�ڶ���ؼ��ֵ���Ʒ��',
	'PHPSHOP_ORDERBY' => 'Order by',
	'PHPSHOP_CUSTOMER_RATING' => '�˿�ƽ���<�',
	'PHPSHOP_TOTAL_VOTES' => '�����<�',
	'PHPSHOP_CAST_VOTE' => '��ͶƱ',
	'PHPSHOP_RATE_BUTTON' => '�<�',
	'PHPSHOP_RATE_NOM' => '�<�',
	'PHPSHOP_REVIEWS' => '�˿�����',
	'PHPSHOP_NO_REVIEWS' => '����Ʒ�������ۡ�',
	'PHPSHOP_WRITE_FIRST_REVIEW' => '���ǵ�һ��Ϊ����Ʒ׫д���۵Ĺ˿͡�',
	'PHPSHOP_REVIEW_LOGIN' => '���½��׫д���ۡ�',
	'PHPSHOP_REVIEW_ERR_RATE' => '���<۴˲�Ʒ������������',
	'PHPSHOP_REVIEW_ERR_COMMENT1' => '���ٶ�д�������ۣ���������: %s',
	'PHPSHOP_REVIEW_ERR_COMMENT2' => '���������ۣ��������: %s',
	'PHPSHOP_WRITE_REVIEW' => 'Ϊ����Ʒ׫д����',
	'PHPSHOP_REVIEW_RATE' => '����: ��Դ���Ʒ����<ۡ�����0(���)��5(���)֮������<ۡ�',
	'PHPSHOP_REVIEW_COMMENT' => '���������һ�����ۡ�(�������� %s���������:%s ) ',
	'PHPSHOP_REVIEW_COUNT' => '����: ',
	'PHPSHOP_REVIEW_SUBMIT' => '�ύ����',
	'PHPSHOP_REVIEW_ALREADYDONE' => '��л��׫д�˴���Ʒ�����ۡ�',
	'PHPSHOP_REVIEW_THANKYOU' => '��л����<�',
	'PHPSHOP_COMMENT' => '����',
	'PHPSHOP_CREDITCARD_FORM_LBL' => '���/�༭���ÿ�����',
	'PHPSHOP_CREDITCARD_NAME' => '���ÿ����',
	'PHPSHOP_CREDITCARD_CODE' => '���ÿ���д����',
	'PHPSHOP_CREDITCARD_TYPE' => '���ÿ�����',
	'PHPSHOP_CREDITCARD_LIST_LBL' => '���ÿ��б�',
	'PHPSHOP_UDATE_ADDRESS' => '���µ�ַ',
	'PHPSHOP_CONTINUE_SHOPPING' => '������',
	'PHPSHOP_THANKYOU_SUCCESS' => '��Ķ����Ѿ��ɹ��ύ',
	'PHPSHOP_ORDER_LINK' => '����t�Ӳ鿴��������',
	'PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_1' => '��ĵ� {order_id}�Ŷ���״̬�Ѿ��ı䡣',
	'PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_2' => '�µ�״̬��:',
	'PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_3' => '��������t���Բ鿴����ϸ��:',
	'PHPSHOP_ORDER_STATUS_CHANGE_SEND_SUBJ' => '���״̬: ��ĵ� {order_id}�Ŷ���',
	'PHPSHOP_ORDER_LIST_NOTIFY' => '���ѹ˿�?',
	'PHPSHOP_ORDER_LIST_NOTIFY_ERR' => '���ȸı䶩��״̬!',
	'PHPSHOP_SHOPPER_GROUP_FORM_DISCOUNT' => 'Ĭ�Ϲ˿�����ۿ� (�԰ٷֱȵ���ʽ)',
	'PHPSHOP_SHOPPER_GROUP_FORM_DISCOUNT_TIP' => '��ֵX��ζ��:��Ʒ�����ڸ���˿�û��ָ���۸�Ļ�����ô����Ĭ�ϼ۸��������X%����ֵ�����෴Ч��',
	'PHPSHOP_PRODUCT_DISCOUNT_LBL' => '��Ʒ�ۿ�',
	'PHPSHOP_PRODUCT_DISCOUNT_LIST_LBL' => '��Ʒ�ۿ��б�',
	'PHPSHOP_PRODUCT_DISCOUNT_ADDEDIT' => '���/�༭��Ʒ�ۿ�',
	'PHPSHOP_PRODUCT_DISCOUNT_AMOUNT' => '�ۿ�',
	'PHPSHOP_PRODUCT_DISCOUNT_AMOUNT_TIP' => '�����ۿ�',
	'PHPSHOP_PRODUCT_DISCOUNT_AMOUNTTYPE' => '�ۿ�����',
	'PHPSHOP_PRODUCT_DISCOUNT_ISPERCENT' => '�ٷֱ�',
	'PHPSHOP_PRODUCT_DISCOUNT_ISTOTAL' => '�ܹ�',
	'PHPSHOP_PRODUCT_DISCOUNT_ISPERCENT_TIP' => '���ǰٷֱ��ۿۻ����ܹ��ۿ�?',
	'PHPSHOP_PRODUCT_DISCOUNT_STARTDATE' => '�ۿ���ʼ����',
	'PHPSHOP_PRODUCT_DISCOUNT_STARTDATE_TIP' => 'ָ���ۿ���ʼ����',
	'PHPSHOP_PRODUCT_DISCOUNT_ENDDATE' => '�ۿ۽�������',
	'PHPSHOP_PRODUCT_DISCOUNT_ENDDATE_TIP' => 'ָ���ۿ۽�������',
	'PHPSHOP_PRODUCT_DISCOUNT_ADDDISCOUNT_TIP' => '�����ʹ����Ʒ�ۿ۱�������ۿۣ�',
	'PHPSHOP_PRODUCT_DISCOUNT_SAVE' => '���ʡ��',
	'PHPSHOP_FLYPAGE_ENLARGE_IMAGE' => '�鿴ȫ�ߴ�ͼƬ',
	...
	'PHPSHOP_MULTISELECT' => '��STRG-Key ������ѡ',
