...
class vmLanguage extends vmAbstractLanguage {
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).';
	...
	var $_PHPSHOP_REVIEW_ERR_COMMENT1 = 'Napiöte delöÌ hodnocenÌ, minim·lnÏ %s znak˘';
	var $_PHPSHOP_REVIEW_ERR_COMMENT2 = 'HodnocenÌ je p¯Ìliö dlouhÈ, povoleno je maxim·lnÏ %s znak˘';
	...
	var $_PHPSHOP_REVIEW_COMMENT = 'NynÌ napiöte hodnocenÌ ....(min. %s, max. %s znak˘) ';
	...
	var $_PHPSHOP_PRODUCT_FORM_AVAILABILITY_TOOLTIP2 = 'NEBO vyberte obr·zek, kter˝ bude zobrazen na str·nce detailnÌho popisu zboûÌ .<br />Obr·zky jsou umÌstÏny v adres·¯i <i>%s</i><br />';
...
<strong>verified</strong> PayPal account (when an account is not verified, PayPal does transfer the funds, but they do not fully guarantee the validity of the sale).';
	...
	var $_PHPSHOP_EPAY_PAYMENT_FEE = 'Gebyr pÂlagt betalingen: ';
	var $_PHPSHOP_EPAY_PAYMENT_CALLBACK = '<b>Ordre betalingsinfo blev opdateret via callback!</b>';
	var $_PHPSHOP_EPAY_PAYMENT_ORDER_COMMENT = 'Betalingen blev godkendt af ePay / PBS. \nBetalingen har fÂet f¯lgende transaktionsnummer i ePay.: ';
	var $_PHPSHOP_EPAY_PAYMENT_RETRY_PAYMENT = '<br/><br><br><b>Tryk pÂ nederstÂende link for at fors¯g betaling igen:</b><br>';
	...
	var $_PHPSHOP_EPAY_PAYMENT_EPAY_LINK = '. Betalingen kan behandles pÂ: <a href="https://ssl.ditonlinebetalingssystem.dk/admin" target="_new">www.epay.dk</a>';
	var $_PHPSHOP_EPAY_PAYMENT_CHECKOUT_HEADER = 'Du har nu bekrÊftet ordren og skal nu vÊlge hvordan ordren betales. Dette g¯res ved at klikke pÂ den ¯nskede betalingsmetode nedenfor. Betalingen vil ske i et SSL sikret vindue hos ePay (<a href="http://www.epay.dk" target="_new">www.epay.dk</a>).<br><br>';
	var $_PHPSHOP_EPAY_PAYMENT_CHECKOUT_FOOTER = 'Hvis ikke Standard Betalingsvinduet Âbner op automatisk, sÂ klik pÂ knappen for at aktivere det. <br><br> BemÊrk! Hvis I benytter en pop-up stopper, skal I holde CTRL tasten nede, mens I trykker pÂ knappen.';        
