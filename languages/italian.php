...
class phpShopLanguage extends vmAbstractLanguage {
	...
	var $_PHPSHOP_PRODUCT_FORM_IMAGE_DELETE_LBL = 'Digita ';
	...
	var $_PHPSHOP_RETURN_LOGIN = 'Già nostro cliente? Fai il Login';
	...
	var $_PHPSHOP_CART_STOCK_1 = 'La quantità selezionata eccede la disponibilit&grave; di magazzino.';
  ...
  e che sono amministratori del negozio (es. Registered / Editor).';
	...
	var $_PHPSHOP_ADMIN_CFG_URL_EXPLAIN = 'L\'URL del tuo sito. Di solito à è quella corrispondente alla instalalzione di Mambo (con lo slash alla fine!)';
	...
	var $_PHPSHOP_ADMIN_CFG_HOMEPAGE_EXPLAIN = 'Questa &grave; la pagina che verrà caricata come predefinita.';
	...
	var $_PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN = 'Definisci il numero di prodotti per riga. <br />
                                                                                                      Esempio: se lo imposti a 4, il modello di categoria mostrerà 4 prodotti per riga';
	var $_PHPSHOP_ADMIN_CFG_NOIMAGEPAGE = '\"no image\" image';
	var $_PHPSHOP_ADMIN_CFG_NOIMAGEPAGE_EXPLAIN = 'Questa immagine verrà mostrata quando al prodotto non &grave; stata associata alcuna immagine.';
	...
	var $_PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION = 'Mostra in pià di pagina ';
	var $_PHPSHOP_ADMIN_CFG_SHOWPHPSHOP_VERSION_EXPLAIN = 'Visualizza un\'immagine powered-by-mambo-phpShop nel pià di pagina.';
  ...
  Qusto intervallo inizia col primo download! Quando l\'intervallo scade, il download-ID viene disabilitato.<br />N.B. : 86400s=24h.';
	...
	var $_PHPSHOP_ADMIN_CFG_PAYPAL_STATUS_SUCCESS_EXPLAIN = 'Seleziona lo stato dell\'ordine al quale il vero ordine è impostato se la procedura PayPal IPN &grave; andata a buon fine. Se vendi prodotti scaricabili: 
  seleziona lo stato che abilita il download (al ciente sar&grave; subito notificato via e-mail il link per il download).';
	...
	var $_PHPSHOP_SEARCH_TEXT2 = ' Puoi ulteriormete affinare la ricerca aggiungendo una seconda parola chiave e selezionando gli operatori AND o NOT. 
        AND comporta che entrambe le parole devono essere presenti affinch´ il prodotto venga visualizzato nei risultati. 
	...
	var $_PHPSHOP_CURRENCY_DECIMALS_TOOLTIP = 'Numero di decimali visualizzati (ouò essere 0)<br><b>Arrotonda se il valore ha un numero di decimali diverso</b>';
	...
	var $_PHPSHOP_CURRENCY_THOUSANDS_TOOLTIP = 'Carattere usato per separare le migliaia (può vuoto)';
	...
	var $_PHPSHOP_COUPON_CODE_EXISTS = 'Codice coupon già utilizzato. Riprova.';
	...
	var $_PHPSHOP_UPS_HANDLING_FEE_TOOLTIP = 'Le spese per il trattamento di questa modalitàd i consegna.';
	...
	var $_PHPSHOP_PRODUCT_FORM_FILENAME_TOOLTIP = 'N.B.: Qui puoi inserire un nome di file. <strong>Se inserisci un nome file qui, non verrà caricato nessun file!!! Dovrai caricarlo manualmente via FTP!</strong>.';
