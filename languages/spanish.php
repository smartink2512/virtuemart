...
class phpShopLanguage extends mosAbstractLanguage {
    ...
    var $_PHPSHOP_USER_FORM_LBL = "Añadir/Actualizar Información de Usuario";
    var $_PHPSHOP_USER_FORM_BILLTO_LBL = "Información de Cuenta A ";
    var $_PHPSHOP_USER_FORM_SHIPTO_LBL = "Dirección de Envío";
    var $_PHPSHOP_USER_FORM_ADD_SHIPTO_LBL = "Añadir Dirección";
    var $_PHPSHOP_USER_FORM_ADDRESS_LABEL = "Dirección";
    ...
    var $_PHPSHOP_USER_FORM_COMPANY_NAME = "Compañía";
    ...
    var $_PHPSHOP_ORDER_PRINT_ITEMs_LBL = "Pedir Artículos";
    ...
    var $_PHPSHOP_PRODUCT_FORM_CATEGORY2 = "Categoría 2";
    ...
    var $_PHPSHOP_USER_FORM_ADDRESS_INFO_LBL = "Información Usario A";
    var $_PHPSHOP_USER_FORM_shipto_LBL = "Dirección de Envío";
    var $_PHPSHOP_USER_FORM_ADD_shipto_LBL = "Añadir Dirección de Envío";
    ...
    var $_PHPSHOP_DOWNLOADS_SEND_MSG_6 = "Información de descarga por  "; // e.g. Download-Info by "Storename"
...
/* PAGE 3 */
  ...
  select the status which enables the download (then the customer is instantly notified about the download via e-mail).";
    ...
    var $_PHPSHOP_ORDER_STATUS_CHANGE_SEND_MSG_1 = "El estado de su número de pedido {order_id} ha cambiado.";
