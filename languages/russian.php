<?php
defined( '_VALID_MOS' ) or die( 'Прямой доступ к данной странице запрещен.' ); 
/**
* @версия $Id: russian.php,v 1.2 2005/09/01 19:58:07 soeren_nb Exp $
* @пакет mambo-phpShop
* @субпакет languages
*
* @copyright (C) 2005 Soeren Eberhardt
* @copyright (C) 2005 Ru-Mambo, Фёдоров Александр, (будут указаны все переводившие)
* @license http://www.gnu.org/copyleft/gpl.html GNU/GPL
*
* mambo-phpShop - свободное программное обеспечение.
* mambo-phpShop поставляется без каких-либо гарантий.
*
...
class phpShopLanguage extends mosAbstractLanguage {
   ...
   var $_PHPSHOP_ISSHIP_PING_TIME_LBL = "сек.";
    ...
    /*#####################
    MODULE SHOPPER - МОДУЛЬ ПОКУПАТЕЛЯ
    #####################*/
    ...
    /*#####################
    MODULE TAX - МОДУЛЬ НАЛОГОВ И СБОРОВ
    #####################*/
    ...
    /*#####################
    MODULE VENDOR - Модуль поставщика-продавца - пока альфа-версия,
                    Саурон просил не использовать  по возможности.
    #####################*/
    ...
    /*#####################
    MODULE MANUFACTURER - МОДУЛЬ ПРОИЗВОДИТЕЛЯ
    #####################*/

    # Некоторые обозначения
    var $_PHPSHOP_MANUFACTURER_MOD = "Производитель"; //Manufacturer
    var $_PHPSHOP_MANUFACTURER_ADMIN = "Производители"; //Manufacturers
    
    
    // Manufacturer List
    var $_PHPSHOP_MANUFACTURER_LIST_MNU = "Список производителей"; //List Manufacturers
    var $_PHPSHOP_MANUFACTURER_LIST_LBL = "Список производителей"; //Manufacturer List
    var $_PHPSHOP_MANUFACTURER_LIST_MANUFACTURER_NAME = "Название производителя"; //Manufacturer Name
    var $_PHPSHOP_MANUFACTURER_LIST_ADMIN = "Администрирование"; //Admin
    
    // Manufacturer Form
    var $_PHPSHOP_MANUFACTURER_FORM_MNU = "Добавить производителя"; //Add Manufacturer
    var $_PHPSHOP_MANUFACTURER_FORM_LBL = "Добавить информацию"; //Add Information
    var $_PHPSHOP_MANUFACTURER_FORM_INFO_LBL = "Информация производителя"; //Manufacturer Information
    var $_PHPSHOP_MANUFACTURER_FORM_NAME = "Название производителя"; //Manufacturer Name
    var $_PHPSHOP_MANUFACTURER_FORM_CATEGORY = "Категория производителя"; //Manufacturer Category
    var $_PHPSHOP_MANUFACTURER_FORM_EMAIL = "Email";
    var $_PHPSHOP_MANUFACTURER_FORM_URL = "Ссылка на сайт производителя"; //URL to Manufacturer Homepage
    var $_PHPSHOP_MANUFACTURER_FORM_DESCRIPTION = "Описание"; //Description
    
    
    // Manufacturer Category List
    var $_PHPSHOP_MANUFACTURER_CAT_LIST_MNU = "Список категорий производителей"; //List Manufacturer Categories
    var $_PHPSHOP_MANUFACTURER_CAT_LIST_LBL = "Список категорий производителей"; //Manufacturer Category List
    var $_PHPSHOP_MANUFACTURER_CAT_NAME = "Название категории"; //Category Name
    var $_PHPSHOP_MANUFACTURER_CAT_DESCRIPTION = "Описание категории"; //Category Description
    var $_PHPSHOP_MANUFACTURER_CAT_MANUFACTURERS = "Производители"; //Manufacturers
    
    // Manufacturer Category Form
    var $_PHPSHOP_MANUFACTURER_CAT_FORM_MNU = "Добавить категорию производителя"; //Add Manufacturer Category
    var $_PHPSHOP_MANUFACTURER_CAT_FORM_LBL = "Форма категории производителя"; //Manufacturer Category Form
    var $_PHPSHOP_MANUFACTURER_CAT_FORM_INFO_LBL = "Информация о категории"; //Category Information
    var $_PHPSHOP_MANUFACTURER_CAT_FORM_NAME = "Название категории"; //Category Name
    var $_PHPSHOP_MANUFACTURER_CAT_FORM_DESCRIPTION = "Описание категории"; //Category Description
    /*#####################
    Modul HELP
    #####################*/
    ...
    /*#####################################################
     MODULE SHIPPING - МОДУЛЬ ДОСТАВКИ
    #######################################################*/
    ...
    /*#####################################################
     END: MODULE SHIPPING - КОНЕЦ МОДУЛЯ ДОСТАВКИ
    #######################################################*/
    ...
    var $_PHPSHOP_DOWNLOADS_SEND_MSG_6 = "Информация о загрузках: "; // e.g. Download-Info by "Storename"
  ...
  /*#####################################################
    MODULE AFFILIATE - Модуль партнерских программ
  #######################################################*/
    ...
    //Лист ожидания: файл /administrator/components/com_phpshop/html/shop.waiting_list.php
    ...
    //Оформление заказа: file /administrator/components/com_phpshop/html/checkout.thankyou.php
...
/* PAGE 3 */
  ...
  var $_PHPSHOP_ADMIN_CFG_PRODUCTS_PER_ROW_EXPLAIN = "Определяет количество товаров в строке по умолчанию.<br />Пример: Если Вы установите 4, то шаблон категории отобразит 4 товара в строке";
    ...
    var $_PHPSHOP_ADMIN_CFG_NOIMAGEPAGE = "Картинка \"изображение отсутствует\"";
...
/* FILE & IMAGE PROCESSING */
	...
	<h4>Примеры формата списка атрибутов:</h4>
    <pre>
...
Будут показаны два дополнительных поля Название и Принадлежности, обязательные для заполнения.</pre>";
    ...
    var $_PHPSHOP_PARAMETERS_SEARCH  = "Поиск по параметрам";
