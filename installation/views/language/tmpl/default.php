...
<form action="index.php" method="post" id="adminForm" class="form-validate">
	<div id="installer">
		<div class="m">
			...
			<div class="install-text error"><strong>
					<?php echo "This step is important. VirtueMart will create its tables according to the language selected now. The language selected should be main front end language. "; ?></strong>
			</div>
