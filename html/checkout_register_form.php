...
/**
* @version $Id: checkout_register_form.php,v 1.16 2005/09/01 19:58:06 soeren_nb Exp $
* @package mambo-phpShop
* @subpackage HTML
* @copyright (C) 2004 Miro
*
        ...
        if (MUST_AGREE_TO_TOS == '1') { 
          if (!$my->id) echo "else"; ?>
            ...
            if (!form.agreed.checked) {
                alert( "<?php echo $PHPSHOP_LANG->_PHPSHOP_AGREE_TO_TOS ?>" );
                return false;
            }
        <?php 
        }
...
if (empty($my->id)) { ?>
  <br/>
    <fieldset>
      <legend><span class="sectiontableheader"><?php echo $PHPSHOP_LANG->_PHPSHOP_ORDER_PRINT_CUST_INFO_LBL ?></span></legend>
...
<?php 
  ...
  <br/>
  <fieldset>
    <legend class="sectiontableheader"><?php echo $PHPSHOP_LANG->_PHPSHOP_SHOPPER_FORM_BILLTO_LBL ?></legend>
...
?>
    ...
    <br/>    
      <fieldset>
        ...
        <div style="float:left;width:30%;text-align:right;"><?php echo "<label for=\"bank_account_holder\">".$PHPSHOP_LANG->_PHPSHOP_ACCOUNT_LBL_BANK_ACCOUNT_HOLDER."</label>" ?>:</div>
    ...
    <br/><br/>
        ...
        <div style="float:left;width:30%;text-align:right;"><?php echo "<label for=\"bank_account_nr\">".$PHPSHOP_LANG->_PHPSHOP_ACCOUNT_LBL_BANK_ACCOUNT_NR."</label>" ?>:</div>
    ...
    <br/><br/>
        ...
        <div style="float:left;width:30%;text-align:right;"><?php echo "<label for=\"bank_sort_code\">".$PHPSHOP_LANG->_PHPSHOP_ACCOUNT_LBL_BANK_SORT_CODE."</label>" ?>:</div>
    ...
    <br/><br/>
        ...
        <div style="float:left;width:30%;text-align:right;"><?php echo "<label for=\"bank_name\">".$PHPSHOP_LANG->_PHPSHOP_ACCOUNT_LBL_BANK_NAME."</label>" ?>:</div>
    ...
    <br/><br/>
        ...
        <div style="float:left;width:30%;text-align:right;"><?php echo "<label for=\"bank_account_type\">".$PHPSHOP_LANG->_PHPSHOP_ACCOUNT_LBL_ACCOUNT_TYPE."</label>" ?>:</div>
        <div style="float:left;width:60%;">
    ...
    <br/><br/> 
        <div style="float:left;width:30%;text-align:right;"><?php echo "<label for=\"bank_iban\">".$PHPSHOP_LANG->_PHPSHOP_ACCOUNT_LBL_BANK_IBAN."</label>" ?>:</div>
  ...
  if (MUST_AGREE_TO_TOS == '1') {
    ...
    <div style="<?php if (stristr($missing,'agreed')) echo "border:red solid 1px;"; ?>" >
      <input type="checkbox" id="agreed" name="agreed" value="1" class="inputbox" />
        ...
        document.write('<label for="agreed"><a href="javascript:void window.open(\'<?php echo $mosConfig_live_site ?>/index2.php?option=com_phpshop&page=shop.tos&pop=1\', \'win2\', \'status=no,toolbar=no,scrollbars=yes,titlebar=no,menubar=no,resizable=yes,width=640,height=480,directories=no,location=no\');">');
        document.write('<?php echo $PHPSHOP_LANG->_PHPSHOP_I_AGREE_TO_TOS ?></a></label>');
        //]]></script>
        <noscript><label for="agreed"><a target="_blank" href="<?php echo $mosConfig_live_site ?>/index.php?option=com_phpshop&page=shop.tos" title="<?php echo $PHPSHOP_LANG->_PHPSHOP_I_AGREE_TO_TOS ?>">
        <?php echo $PHPSHOP_LANG->_PHPSHOP_I_AGREE_TO_TOS ?></a></label></noscript>
