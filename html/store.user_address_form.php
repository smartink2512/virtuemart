...
/**
* @version $Id: store.user_address_form.php,v 1.2 2005/01/27 19:34:04 soeren_nb Exp $
...
<?php if ($user_info_id) {
   $q = "SELECT * from #__users, #__pshop_user_info ";
   $q .= "where (#__pshop_user_info.user_info_id='$user_info_id' OR";
   $q .= " (#__users.user_info_id='$user_info_id') ";
    $q .= "AND #__pshop_auth_user_vendor.vendor_id='$ps_vendor_id'";
   $db->query($q);
   $db->next_record();
}
?> 
