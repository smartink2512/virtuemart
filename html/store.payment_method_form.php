...
/**
*
* @version $Id: store.payment_method_form.php 485 2006-11-15 21:27:57 +0100 (Mi, 15 Nov 2006) gregdev $
* @package VirtueMart
* @subpackage html
...
<table class="adminform">
    ...
    <tr class="row0"> 
      <td class="labelcell"><?php echo $VM_LANG->_PHPSHOP_PAYMENT_METHOD_FORM_ENABLE_PROCESSOR ?>:</td>
      <td width="69%" >
      <?php 
          ...
          $payment_types = array( "" => $VM_LANG->_PHPSHOP_PAYMENT_FORM_CC, 
                              ...
                              "P" => $VM_LANG->_VM_PAYMENT_FORM_FORMBASED );
          $i = 0;
    ...
    <tr class="row1"> 
      <td class="labelcell"><?php echo $VM_LANG->_PHPSHOP_PAYMENT_METHOD_FORM_DISCOUNT ?>:</td>
      <td width="69%" > 
        <input type="text" class="inputbox" name="payment_method_discount" size="6"  value="<?php $db->sp("payment_method_discount"); ?>" />
        <?php echo mm_ToolTip( $VM_LANG->_VM_PAYMENT_METHOD_DISCOUNT_TIP ); ?>
      </td>
    </tr>
    
    <tr class="row1"> 
      <td class="labelcell"><?php echo $VM_LANG->_PHPSHOP_PRODUCT_DISCOUNT_AMOUNTTYPE ?>:</div></td>
      <td width="69%"> 
        ...
        <label for="payment_method_discount_is_percent0"><?php echo $VM_LANG->_PHPSHOP_PRODUCT_DISCOUNT_ISPERCENT ?></label>&nbsp;&nbsp;&nbsp;
        ...
        <label for="payment_method_discount_is_percent1"><?php echo $VM_LANG->_PHPSHOP_PRODUCT_DISCOUNT_ISTOTAL ?></label>
      </td>
    </tr>
    <tr class="row1"> 
    	<td class="labelcell"><?php echo $VM_LANG->_VM_PAYMENT_METHOD_DISCOUNT_MAX_AMOUNT ?>:</td>
    	<td ><input type="text" name="payment_method_discount_max_amount" value="<?php $db->sp('payment_method_discount_max_amount') ?>" size="5" /></td>
   	</tr>
   	
    <tr class="row1"> 
    	<td class="labelcell"><?php echo $VM_LANG->_VM_PAYMENT_METHOD_DISCOUNT_MIN_AMOUNT ?>:</td>
    	<td ><input type="text" name="payment_method_discount_min_amount" value="<?php $db->sp('payment_method_discount_min_amount') ?>" size="5" /></td>
   	</tr>
   	
    <tr class="row0"> 
      <td class="labelcell"><?php echo $VM_LANG->_PHPSHOP_PAYMENT_METHOD_FORM_LIST_ORDER ?>:</td>
      <td width="69%" > 
...
<?php
        ...
        echo '<br />
<strong>'.$VM_LANG->_VM_PAYMENT_EXTRAINFO.':';
...
function check() {
   if (document.adminForm.enable_processor[0].checked == true || document.adminForm.enable_processor[1].checked == true) {
      document.getElementById('accepted_creditcards1').innerHTML = '<strong><?php echo $VM_LANG->_VM_PAYMENT_ACCEPTED_CREDITCARDS ?>:';
