...
/**
*
* @version $Id: admin.user_list.php,v 1.2 2005/09/27 17:51:26 soeren_nb Exp $
* @package VirtueMart
* @subpackage html
...
function saveUser( $option ) {
	...
	if ( $supers == 1 && $_POST["block"] ) {
		mosRedirect( "index2.php?option=com_virtuemart&page=admin.user_list", "You cannot block the only Superadministrator!" );
	}
