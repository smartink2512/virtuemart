...
$listObj->writeSearchHeader($PHPSHOP_LANG->_PHPSHOP_MODULE_LIST_LBL, IMAGEURL."ps_image/modules.gif", "admin", "module_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					$PHPSHOP_LANG->_PHPSHOP_MODULE_LIST_NAME => "",
					$PHPSHOP_LANG->_PHPSHOP_MODULE_LIST_PERMS => "",
					$PHPSHOP_LANG->_PHPSHOP_MODULE_LIST_FUNCTIONS => "",
					$PHPSHOP_LANG->_PHPSHOP_MODULE_LIST_ORDER => "",
					_E_REMOVE => "width=\"5%\""
				);
...
while ($db->next_record()) {
	...
	$tmp_cell = "<a href=\"".$sess->url($_SERVER['PHP_SELF']."?page=$modulename.function_list&module_id=" . $db->f("module_id"))."\">". $PHPSHOP_LANG->_PHPSHOP_LIST ."</a>";
    $listObj->addCell( $tmp_cell );
