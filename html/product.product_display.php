...
/**
*
* @version $Id: product.product_display.php,v 1.2 2005/09/27 17:51:26 soeren_nb Exp $
* @package VirtueMart
* @subpackage html
...
?>
<div align="center">
  <a href="<?php echo $_SERVER['PHP_SELF']."?option=com_virtuemart&page=product.product_list&limitstart=$limitstart&keyword=$keyword" ?>">
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr> 
    <td width="21%" height="18" valign="top"  align="right"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_VENDOR ?>:</td>
    <td width="79%" height="18" valign="top"> <?php print $ps_vendor->get_name($db->f("vendor_id")); ?></td>
  </tr>
  <tr> 
    <td width="21%" height="17" valign="top"  align="right"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_SKU ?>:</td>
    <td width="79%" height="17" valign="top"> <?php $db->p("product_sku"); ?></td>
  </tr>
  <tr> 
    <td width="21%" valign="top"  align="right"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_NAME ?>:</td>
    <td width="79%" valign="top"> <?php $db->p("product_name"); ?></td>
  </tr>
  <tr> 
    <td width="21%" valign="top"  align="right"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_URL ?>:</td>
    <td width="79%" valign="top"> <?php $db->p("product_url"); ?></td>
  </tr>
  <tr> 
    <td width="21%" valign="top"  align="right"> <?php if(!$product_parent_id) { 
                                                        echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_CATEGORY ?>:<?php } ?></td>
...
?></td>
  ...
  <tr> 
    <td width="21%" align="right"  valign="top"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_S_DESC ?>:</td>
    <td width="79%"><?php $db->p("product_s_desc"); ?></td>
  </tr>
  <tr> 
    <td width="21%" align="right"  valign="top"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_DESCRIPTION ?>:</td>
  ...
  <tr> 
    <td width="21%" align="right" > <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_IN_STOCK ?>:</td>
    <td width="79%" valign="top"> <?php $db->p("product_in_stock"); ?></td>
  </tr>
  <tr> 
    <td width="21%" align="right" > <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_AVAILABLE_DATE ?>:</td>
    <td width="79%" valign="top"> <?php
...
?></td>
  ...
  <tr> 
    <td width="21%" align="right" > <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_SPECIAL ?>:</td>
    <td width="79%" valign="top"> <?php $db->p("product_special"); ?></td>
  </tr>
  <tr> 
    <td width="21%" align="right" height="17" > <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_DISCOUNT_TYPE ?>:</td>
    <td width="79%" valign="top" height="17"> <?php $db->p("product_discount_id"); ?></td>
  </tr>
  <tr> 
    <td width="21%" align="right" height="17" > <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_PUBLISH ?>:</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr> 
    <td colspan="2"><b><?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_ITEM_ATTRIBUTES_LBL ?></b></td>
  </tr>
  <?php
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr valign="top"> 
    <td width="21%" height="19"  align="right"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_LENGTH ?>:</td>
    <td width="79%" height="19"> <?php 
echo $db->f("product_length") . " " . $db->f("product_lwh_uom"); 
?></td>
  </tr>
  <tr valign="top"> 
    <td width="21%" height="19"  align="right"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_WIDTH ?>:</td>
    <td width="79%" height="19"> <?php
echo $db->f("product_width") . " " . $db->f("product_lwh_uom"); 
?></td>
  </tr>
  <tr valign="top"> 
    <td width="21%"  align="right"> <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_HEIGHT ?>:</td>
    <td width="79%"> <?php
...
?></td>
  ...
  <tr> 
    <td width="21%" align="right" > <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_WEIGHT ?>:</td>
    <td width="79%"><?php
...
?></td>
  ...
  <tr> 
    <td width="21%" align="right" > <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_THUMB_IMAGE ?>:</td>
  ...
  <tr> 
    <td width="21%" align="right" > <?php echo $VM_LANG->_PHPSHOP_PRODUCT_FORM_FULL_IMAGE ?>:</td>
