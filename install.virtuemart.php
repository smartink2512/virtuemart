...
// Check for some VirtueMart Tables. When they exist,
// offer an Upgrade
$database->setQuery( "SHOW TABLES LIKE '".$mosConfig_dbprefix."_{vm}_%'" );
...
<table width="100%" border="0">
  <tr>
    ...
    <div id="ctr" align="center">
          ...
          <div id="stepbar">
            <div>
              <a href="http://www.VirtueMart.net" target="_blank">
              <img border="0" align="right" src="components/com_virtuemart/cart.gif" alt="Cart" />
              </a><br/>
            </div>
          ...
          <?php
          if( $installation == "new" ) { ?>
            <tr><td colspan="3" class="error">Let's prepare the database now (the Installation Script hasn't found existing VirtueMart/VirtueMart Tables, so let's do a fresh installation).</td></tr>
            <tr>
          ...
          <tr><td colspan="3" class="error">[UPDATE MODE]<br/>The Installation Script has found existing VirtueMart Tables, so let's update your Database.</td></tr>
            <tr>
              <td align="left" colspan="3">
                If you're upgrading from VirtueMart, version <strong>1.2 RC2</strong> or <strong>Mambo eCommerce Edition</strong> you'll have to click on this link!<br />
                ...
                /administrator/components/com_virtuemart/sql</pre> of your VirtueMart Installation. You can run these Scripts with <a href="http://mamboforge.net/projects/mosphpmyadmin/" target="_blank">phpMyAdmin for Mambo/Joomla</a>.
