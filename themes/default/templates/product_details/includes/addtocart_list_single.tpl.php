...
<!-- Output The heading -->
    ...
    <span style="float: left;width: 20%;"><?php echo $VM_LANG->_PHPSHOP_PRODUCT_DESC_TITLE ?></span >
    <?php //Ouput Each Attribute Heading
    foreach($headings as $key => $value) { ?>
        <span style="float: left;width: 15%;" ><?php echo $headings[$key] ?></span>
    <?php } ?>
...
foreach($product['attrib_value'] as $attribute) { ?>
    <span class="vmChildDetail<?php echo $cls_suffix ?>" style="float: left;width :15%;" />
