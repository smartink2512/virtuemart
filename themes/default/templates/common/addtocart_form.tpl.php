...
<form action="<?php echo $mm_action_url ?>index.php" method="post" name="addtocart" id="addtocart<?php echo $i ?>">
    <label for="quantity_<?php echo $i ?>"><?php echo $VM_LANG->_PHPSHOP_CART_QUANTITY ?>:</label>
    <input id="quantity_<?php echo $i ?>" class="inputbox" type="text" size="3" name="quantity" value="1" />
