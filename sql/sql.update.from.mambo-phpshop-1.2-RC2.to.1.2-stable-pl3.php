...
('', 138, 'Hidalgo', 'HGO', 'HI'),  ('', 138, 'Jalisco', 'JAL', 'JA'),  ('', 138, 'M�xico (Estado de)', 'EDM', 'EM'),
('', 138, 'Michoac�n', 'MCN', 'MI'),  ('', 138, 'Morelos', 'MOR', 'MO'),  ('', 138, 'Nayarit', 'NAY', 'NY'),
('', 138, 'Nuevo Le�n', 'NUL', 'NL'),  ('', 138, 'Oaxaca', 'OAX', 'OA'),  ('', 138, 'Puebla', 'PUE', 'PU'),
('', 138, 'Quer�taro', 'QRO', 'QU'),  ('', 138, 'Quintana Roo', 'QUR', 'QR'),  ('', 138, 'San Luis Potos�', 'SLP', 'SP'),
('', 138, 'Sinaloa', 'SIN', 'SI'),  ('', 138, 'Sonora', 'SON', 'SO'),  ('', 138, 'Tabasco', 'TAB', 'TA'),
('', 138, 'Tamaulipas', 'TAM', 'TM'),  ('', 138, 'Tlaxcala', 'TLX', 'TX'),  ('', 138, 'Veracruz', 'VER', 'VZ'),
('', 138, 'Yucat�n', 'YUC', 'YU'),  ('', 138, 'Zacatecas', 'ZAC', 'ZA'),

('', 30, 'Acre', 'ACR', 'AC'),  ('', 30, 'Alagoas', 'ALG', 'AL'),  ('', 30, 'Amap�', 'AMP', 'AP'),
('', 30, 'Amazonas', 'AMZ', 'AM'),  ('', 30, 'Bah�a', 'BAH', 'BA'),  ('', 30, 'Cear�', 'CEA', 'CE'),
('', 30, 'Distrito Federal', 'DFB', 'DF'),  ('', 30, 'Espirito Santo', 'ESS', 'ES'),  ('', 30, 'Goi�s', 'GOI', 'GO'),
('', 30, 'Maranh�o', 'MAR', 'MA'),  ('', 30, 'Mato Grosso', 'MAT', 'MT'),
('', 30, 'Mato Grosso do Sul', 'MGS', 'MS'),  ('', 30, 'Minas Gera�s', 'MIG', 'MG'),  ('', 30, 'Paran�', 'PAR', 'PR'),
('', 30, 'Para�ba', 'PRB', 'PB'),  ('', 30, 'Par�', 'PAB', 'PA'),  ('', 30, 'Pernambuco', 'PER', 'PR'),
('', 30, 'Piau�', 'PIA', 'PI'),  ('', 30, 'Rio Grande do Norte', 'RGN', 'RN'),  ('', 30, 'Rio Grande do Sul', 'RGS', 'RS'),
('', 30, 'Rio de Janeiro', 'RDJ', 'RJ'),  ('', 30, 'Rond�nia', 'RON', 'RO'),
('', 30, 'Roraima', 'ROR', 'RR'),  ('', 30, 'Santa Catarina', 'SAC', 'SC'),  ('', 30, 'Sergipe', 'SER', 'SE'),
('', 30, 'S�o Paulo', 'SAP', 'SP'),  ('', 30, 'Tocantins', 'TOC', 'TO'),  
