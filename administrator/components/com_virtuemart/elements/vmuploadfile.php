 ...
 */
class JElementVmUploadfile extends JElement {
	...
	function fetchElement ($name, $value, &$node, $control_name) {
		...
		function fetchElement ($name, $value, &$node, $control_name) {
			...
			$class .= ' multiple="true" size="5" data-placeholder="'.vmText::_('COM_VIRTUEMART_DRDOWN_SELECT_SOME_OPTIONS').'"';
