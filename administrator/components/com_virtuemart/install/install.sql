...
CREATE TABLE IF NOT EXISTS `#__virtuemart_customs` (
  ...
  `custom_value` varchar(20000) COMMENT 'defaut value',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_product_customfields` (
  ...
  `customfield_value` varchar(2000) COMMENT 'field value',
  `customfield_price` decimal(15,6) COMMENT 'price',
  `disabler` INT(1) UNSIGNED,
  `override` INT(1) UNSIGNED,
  `customfield_param` varchar(18000) COMMENT 'Param for Plugins',
  `published` tinyint(1) NOT NULL DEFAULT '1',
  `created_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
