...
CREATE TABLE IF NOT EXISTS `#__virtuemart_calcs` (
  ...
  `calc_value` decimal(10,6) NOT NULL DEFAULT '0.0000' COMMENT 'The Amount',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_coupons` (
  ...
  `coupon_value` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `coupon_start_date` datetime,
  `coupon_expiry_date` datetime,
  `coupon_value_valid` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `published` tinyint(1) NOT NULL DEFAULT '1',
  `created_on` datetime NOT NULL default '0000-00-00 00:00:00',
  `created_by` int(11) NOT NULL DEFAULT '0',
  `modified_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_orders` (
  ...
  `order_pass` char(8),
  `order_total` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `order_salesPrice` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `order_billTaxAmount` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `order_billDiscountAmount` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `order_discountAmount` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `order_subtotal` decimal(15,6),
  `order_tax` decimal(10,6),
  `order_shipment` decimal(10,6),
  `order_shipment_tax` decimal(10,6),
  `order_payment` decimal(10,6),
  `order_payment_tax` decimal(10,6),
  `coupon_discount` decimal(12,6) NOT NULL DEFAULT '0.00',
  `coupon_code` char(32),
  `order_discount` decimal(12,6) NOT NULL DEFAULT '0.00',
  `order_currency` smallint(1),
  `order_status` char(1),
  `user_currency_id` smallint(1),
  `user_currency_rate` DECIMAL(10,6) NOT NULL DEFAULT '1.00000',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_order_items` (
  ...
  `product_item_price` decimal(15,6),
  `product_tax` decimal(15,6),
  `product_basePriceWithTax` decimal(15,6),
  `product_final_price` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `product_subtotal_discount` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `product_subtotal_with_tax` decimal(15,6) NOT NULL DEFAULT '0.00000',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_order_calc_rules` (
  ...
  `calc_amount` decimal(15,6) NOT NULL DEFAULT '0.00000',
  `calc_value` decimal(15,6) NOT NULL DEFAULT '0.00000',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_product_customfields` (
  ...
  `custom_price` decimal(15,6) COMMENT 'price',
  `disabler` INT(1) UNSIGNED NULL DEFAULT NULL,
  `override` INT(1) UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_product_prices` (
  ...
  `override` tinyint(1),
  `product_override_price` decimal(15,6),
