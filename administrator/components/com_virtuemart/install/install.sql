...
CREATE TABLE IF NOT EXISTS `#__virtuemart_products` (
  ...
  `product_params` varchar(40000),
  `hits` int(11) unsigned,
  `intnotes` varchar(40000),
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_product_customfields` (
  ...
  `custom_value` varchar(16000) COMMENT 'field value',
  `custom_price` char(255) COMMENT 'price',
  `custom_param` varchar(40000) COMMENT 'Param for Plugins',
  `published` tinyint(1) NOT NULL DEFAULT '1',
  `created_on` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_worldzones` (
  ...
  `zone_description` varchar(40000),
