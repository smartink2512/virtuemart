...
CREATE TABLE IF NOT EXISTS `#__virtuemart_customs` (
  ...
  `custom_value` varchar(7000) COMMENT 'default value',
  ...
  `custom_params` varchar(12000)  NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__virtuemart_product_customfields` (
  ...
  `customfield_value` varchar(7000) COMMENT 'field value',
  ...
  `customfield_params` varchar(12000) NOT NULL DEFAULT '' COMMENT 'Param for Plugins',
  `product_sku` char(64),
  `product_gtin` char(64),
  `product_mpn` char(64),
  `published` tinyint(1) NOT NULL DEFAULT '1',
