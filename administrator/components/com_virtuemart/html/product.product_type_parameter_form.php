...
$title = JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_LBL')."<br>";
$title .= JText::_('JM_PRODUCT_TYPE_LBL') . ": ". $db->f("product_type_name"); 
...
if (!$product_type_id || !$db->f("product_type_name")) {
	...
	echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_NOT_FOUND');
	echo " <a href=\"".$_SERVER['PHP_SELF']."?option=com_jmart&page=product.product_type_list\"> [";
	echo JText::_('JM_PRODUCT_TYPE_LIST_LBL')." ]</a>";
	echo "</span>";
}
else {
...
?> 
  ...
  <table class="adminform">
    <tr> 
      <td width="25%" nowrap><div align="right"><?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_NAME') ?>
        <?php echo mm_ToolTip(JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_NAME_DESCRIPTION')) ?> :</div>
      </td>
      <td width="75%">
    ...
    <tr>
      <td valign="top"><div align="right"><?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_LABEL') ?>:</div></td>
      <td width="75%">
		<textarea class="inputbox" name="parameter_label" cols="60" rows="3" ><?php $db->sp("parameter_label") ?></textarea>
      </td>
    </tr>
    <tr> 
      <td width="25%" nowrap valign="top"><div align="right"><?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_DESCRIPTION') ?>:</div></td>
    ...
    <tr>
      <td><div align="right"><?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE') ?>: </div></td>
      <td valign="top">
        <select class="inputbox" name="parameter_type">
	  <option value="I" <?php if ($parameter_type == "I") echo "selected=\"selected\""; ?> > 
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_INTEGER') ?>
	  </option>
	  <option value="T" <?php if ($parameter_type == "T") echo "selected=\"selected\""; ?> > 
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_TEXT') ?>
	  </option>
	  <option value="S" <?php if ($parameter_type == "S") echo "selected=\"selected\""; ?> > 
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_SHORTTEXT') ?>
	  </option>
	  <option value="F" <?php if ($parameter_type == "F") echo "selected=\"selected\""; ?> > 
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_FLOAT') ?>
	  </option>
	  <option value="C" <?php if ($parameter_type == "C") echo "selected=\"selected\""; ?> > 
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_CHAR') ?>
	  </option>
	  <option value="D" <?php if ($parameter_type == "D") echo "selected=\"selected\""; ?> > 
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_DATETIME') ?>
	  </option>
	  <option value="A" <?php if ($parameter_type == "A") echo "selected=\"selected\""; ?> > 
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_DATE') ?>
	  </option>
	  <option value="M" <?php if ($parameter_type == "M") echo "selected=\"selected\""; ?> >
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_TIME') ?>
	  </option>
	  <option value="V" <?php if ($parameter_type == "V") echo "selected=\"selected\""; ?> >
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_MULTIVALUE') ?>
	  </option>
	  <option value="B" <?php if ($parameter_type == "B") echo "selected=\"selected\""; ?> > 
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_TYPE_BREAK') ?>
	  </option>
	</select>
    ...
    <tr> 
      <td width="25%" nowrap valign="top"><div align="right">
        <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_VALUES') ?>:</div>
      </td>
      <td width="75%" valign="top">
    ...
    <tr>
      <td>&nbsp;</td>
      <td><?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_VALUES_DESCRIPTION') ?></td>
    </tr>
    <tr> 
      <td width="25%" nowrap valign="top"><div align="right">
        <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_MULTISELECT') ?>:</div>
      </td>
      <td width="75%" valign="top">
    ...
    <tr> 
      <td width="25%" nowrap valign="top"><div align="right">
        <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_DEFAULT') ?>:</div></td>
      <td width="75%" valign="top">
	...
	<tr>
	  <td>&nbsp;</td>
	  <td>
	    <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_DEFAULT_HELP_TEXT') ?>
	  </td>
	</tr>
    <tr> 
      <td width="25%" nowrap valign="top"><div align="right">
        <?php echo JText::_('JM_PRODUCT_TYPE_PARAMETER_FORM_UNIT') ?>:</div></td>
      <td width="75%" valign="top">
