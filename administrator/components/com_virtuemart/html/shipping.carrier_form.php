...
$formObj = &new formFactory( JText::_('VM_CARRIER_FORM_LBL') );
//Then Start the form
$formObj->startForm();
...
<table class="adminform">
	<tr>
		<td width="21%" ><div align="right"><?php echo JText::_('VM_CARRIER_FORM_NAME') ?>:</div></td>
	...
	<tr>
		<td width="21%" ><div align="right"><?php echo JText::_('VM_CARRIER_FORM_LIST_ORDER') ?>:</div></td>
