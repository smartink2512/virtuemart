...
$formObj = &new formFactory( JText::_('JM_ORDER_STATUS_FORM_LBL') );
//Then Start the form
$formObj->startForm();
...
<table class="adminform">
    ...
    <tr> 
      <td class="labelcell"><?php echo JText::_('JM_ORDER_STATUS_FORM_CODE') ?>:</td>
      <td> 
    ...
    <tr> 
      <td class="labelcell"><?php echo JText::_('JM_ORDER_STATUS_FORM_NAME') ?>:</td>
      <td> 
        <input type="text" class="inputbox" name="order_status_name" value="<?php $db->sp("order_status_name") ?>" size="25" />
      </td>
    </tr>
    <tr> 
      <td class="labelcell"><?php echo JText::_('JM_MANUFACTURER_FORM_DESCRIPTION') ?>:</td>
      <td> 
       	<?php editorArea( 'order_status_description', $db->sf("order_status_description"), 'order_status_description', 500, 250, 75, 25 ); ?>
      </td>
    </tr>
    <tr> 
      <td class="labelcell"><?php echo JText::_('JM_ORDER_STATUS_FORM_LIST_ORDER') ?>:</td>
      <td> 
