...
$listObj->writeSearchHeader(JText::_('JM_SHOPPER_GROUP_LIST_LBL'), JM_ADMIN_ICON_URL."icon_48".DS."jm_shop_users_48.png", $modulename, "shopper_group_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					JText::_('JM_SHOPPER_GROUP_LIST_NAME') => 'width="30%"',
					JText::_('JM_PRODUCT_FORM_VENDOR') => '',
					JText::_('JM_SHOPPER_GROUP_LIST_DESCRIPTION') => '',
					JText::_('JM_DEFAULT') => '',
