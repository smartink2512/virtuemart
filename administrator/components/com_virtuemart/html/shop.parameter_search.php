...
$pathway[] = $vm_mainframe->vmPathwayItem( JText::_('JM_ADVANCED_SEARCH'), $sess->url($mm_action_url.basename($_SERVER['PHP_SELF']).'?page=shop.parameter_search'));
$pathway[] = $vm_mainframe->vmPathwayItem( JText::_('JM_PARAMETER_SEARCH'));
$vm_mainframe->vmAppendPathway($pathway);
?>
<h2><?php echo JText::_('JM_PARAMETER_SEARCH') ?></h2>

<table width="100%" border="0" cellpadding="2" cellspacing="0">
<tr>
	<td><?php echo JText::_('JM_PARAMETER_SEARCH_TEXT1') ?></td>
</tr>
<tr>
	<td>&nbsp;</td>
</tr>
...
<?php
	...
	if ($db->num_rows() == 0) {
		echo JText::_('JM_PARAMETER_SEARCH_NO_PRODUCT_TYPE');
	}
?>
	</td>
</tr>
