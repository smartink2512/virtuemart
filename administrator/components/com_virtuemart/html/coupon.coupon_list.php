...
$listObj->writeSearchHeader(JText::_('JM_COUPON_LIST'), IMAGEURL."ps_image/percentage.png", $modulename, "coupon_list");
...
$columns = Array(  "#" => "width=\"20\"",
					...
					JText::_('JM_COUPON_CODE_HEADER') => '',
					JText::_('JM_COUPON_PERCENT_TOTAL') => '',
					JText::_('JM_COUPON_TYPE') => '',
					JText::_('JM_COUPON_VALUE_HEADER') => '',
					JText::_('JM_COUPON_VALUE_VALID_AT') => '',
...
while ($db->next_record()) {
	...
	$tmp_cell = $db->f("percent_or_total")=='total' ? JText::_('JM_COUPON_TOTAL') : JText::_('JM_COUPON_PERCENT');
	$listObj->addCell( $tmp_cell );

    $tmp_cell = $db->f("coupon_type")=='gift' ? JText::_('JM_COUPON_TYPE_GIFT') : JText::_('JM_COUPON_TYPE_PERMANENT');
	$listObj->addCell( $tmp_cell );
