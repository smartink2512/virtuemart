...
if ($product_parent_id == $vars["product_parent_id"]) {
  if ($func == "productAdd") {
    $action = JText::_('JM_PRODUCT_DISPLAY_ADD_ITEM_LBL'); 
  } else {
    $action = JText::_('JM_PRODUCT_DISPLAY_UPDATE_ITEM_LBL'); 
  }
  ...
  $product_parent_id ="";
  if ($func == "productAdd") {
    $action = JText::_('JM_PRODUCT_DISPLAY_ADD_PRODUCT_LBL'); 
  } else {
    $action = JText::_('JM_PRODUCT_DISPLAY_UPDATE_PRODUCT_LBL'); 
  }
...
?>
<div align="center">
  <a href="<?php echo $_SERVER['PHP_SELF']."?option=com_jmart&page=product.product_list" ?>">
      <h4>&gt;&gt;<?php echo JText::_('JM_PRODUCT_LIST_LBL') ?>&lt;&lt;</h4>
  </a>
</div>
...
<div style="width:90%;float:left;">
	<fieldset>
		...
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_SKU') ?>:</div>
		<div class="formField" > <?php $db->p("product_sku"); ?></div>
	  
	  
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_NAME') ?>:</div>
		<div class="formField" > <?php $db->p("product_name"); ?></div>
	  
	  
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_URL') ?>:</div>
		<div class="formField"><?php $db->p("product_url"); ?></div>
	  
	<?php
		if(!$product_parent_id) { ?>
			<div class="formLabel"><?php echo JText::_('JM_PRODUCT_FORM_CATEGORY') .": "; ?></div>
			<div class="formField" > <?php echo $ps_product_category->get_name($product_id); ?></div>
	<?php
		}
	?>
	  
		<div class="formLabel"><?php echo JText::_('JM_PRODUCT_FORM_VENDOR') ?>:</div>
		<div class="formField"><?php print $hVendor->get_name($db->f("vendor_id")); ?></div>
		
		<div class="formLabel"><?php echo JText::_('JM_PRODUCT_FORM_MANUFACTURER') ?>:</div>
	...
	<br style="clear:both;"/>
	<br style="clear:both;"/>
		<div class="formLabel"><?php echo JText::_('JM_PRODUCT_FORM_PRICE_NET') ?>:</div>
		<div class="formField"><?php echo $GLOBALS['CURRENCY_DISPLAY']->getFullValue( $price['product_price'] ); ?></div>
	<br style="clear:both;" />
	<br style="clear:both;" />
		<div class="formLabel" > <?php echo JText::_('JM_PRODUCT_FORM_S_DESC') ?>:</div>
		<div class="formField"><?php $db->p("product_s_desc"); ?></div>
	  
	  
		<div class="formLabel" > <?php echo JText::_('JM_PRODUCT_FORM_DESCRIPTION') ?>:</div>
...
<div style="width:45%;float:left;">
	<fieldset>
		<legend><strong><?php echo $status_label ?></strong></legend>
			...
			<div class="formLabel"><?php echo JText::_('JM_PRODUCT_FORM_IN_STOCK') ?>:</div>
			<div class="formField" ><?php $db->p("product_in_stock"); ?></div>
		  
		  
			<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_AVAILABLE_DATE') ?>:</div>
		...
		?></div>
			...
			<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_SPECIAL') ?>:</div>
			<div class="formField" > <?php $db->p("product_special"); ?></div>
		  
		  
			<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_DISCOUNT_TYPE') ?>:</div>
			<div class="formField" > <?php 
			...
			<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_PUBLISH') ?>:</div>
...
<div style="width:45%;float:left;">
	<fieldset>
		...
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_LENGTH') ?>:</div>
		<div class="formField" > <?php echo $db->f("product_length") . " " . $db->f("product_lwh_uom"); ?></div>
	  
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_WIDTH') ?>:</div>
		<div class="formField" > <?php echo $db->f("product_width") . " " . $db->f("product_lwh_uom"); ?></div>
	  
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_HEIGHT') ?>:</div>
		<div class="formField"> <?php echo $db->f("product_height") . " " . $db->f("product_lwh_uom"); ?></div>
		
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_WEIGHT') ?>:</div>
...
<div style="width:90%;">
	<fieldset>
		<legend><strong><?php echo JText::_('JM_PRODUCT_FORM_ITEM_ATTRIBUTES_LBL') ?></strong></legend>
...
<div style="width:90%;float:left;">
	<fieldset>
		...
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_THUMB_IMAGE') ?>:</div>
		<div class="formField">
			<?php ImageHelper::displayImage($db->f("product_thumb_image"), 'product', "", false); ?>
			<?php /*$ps_product->show_image($db->f("product_thumb_image"), "", 0);*/ ?>
		</div>
	  
		<div class="formLabel"> <?php echo JText::_('JM_PRODUCT_FORM_FULL_IMAGE') ?>:</div>
		<div class="formField">
			<?php ImageHelper::displayImage($db->f("product_thumb_image"), 'product', "", false); ?>
