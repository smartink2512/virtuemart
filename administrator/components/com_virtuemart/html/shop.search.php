...
$mainframe->setPageTitle( JText::_('JM_ADVANCED_SEARCH') );
$mainframe->appendPathWay( JText::_('JM_ADVANCED_SEARCH') );

?>
<h2><?php echo JText::_('JM_ADVANCED_SEARCH') ?></h2>

<br/>
<a href="<?php echo $sess->url( $mm_action_url.basename($_SERVER['PHP_SELF']).'?page=shop.parameter_search' ) ?>">
	<h3><?php echo JText::_('JM_PARAMETER_SEARCH') ?></h3>
</a>
<br/>
...
<br />
	...
	<td>
            ...
            <select class="inputbox" name="search_op">
                <option value="and"><?php echo JText::_('JM_SEARCH_AND') ?></option>
                <option value="and not"><?php echo JText::_('JM_SEARCH_NOT') ?></option>
            </select>
            <br /><br />
            <input type="text"  class="inputbox" name="keyword2" size="20" />
            <br /><br />
            <select class="inputbox" name="search_category">
              <option value="0"><?php echo JText::_('JM_SEARCH_ALL_CATEGORIES') ?></option>
              <?php 
            ...
            <select class="inputbox" name="search_limiter">
                <option value="anywhere"><?php echo JText::_('JM_SEARCH_ALL_PRODINFO') ?></option>
                <option value="name"><?php echo JText::_('JM_SEARCH_PRODNAME') ?></option>
                <option value="cp"><?php echo JText::_('JM_SEARCH_MANU_VENDOR') ?></option>
                <option value="desc"><?php echo JText::_('JM_SEARCH_DESCRIPTION') ?></option>
            </select>
            <br /><br />
			...
			<td valign="top">
				...
				<tr>
				<td>
				<?php echo JText::_('JM_SEARCH_TEXT2') ?>
        <br /><br />
        <?php echo JText::_('JM_SEARCH_TEXT1') ?>
       <br />
				</td>
				</tr>
				</table>
