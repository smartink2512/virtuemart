...
$formObj = &new formFactory( JText::_('JM_PRODUCT_DISCOUNT_ADDEDIT') );
//Then Start the form
$formObj->startForm();
...
<table class="adminform">
    ...
    <tr> 
      <td width="24%"><div align="right"><?php echo JText::_('JM_PRODUCT_DISCOUNT_AMOUNT') ?>:</div></td>
      <td width="76%"> 
        <input type="text" class="inputbox" name="amount" value="<?php $db->sp("amount") ?>" />
        <?php echo vmToolTip( JText::_('JM_PRODUCT_DISCOUNT_AMOUNT_TIP') ); ?>
      </td>
    </tr>
    <tr> 
      <td width="24%"><div align="right"><?php echo JText::_('JM_PRODUCT_DISCOUNT_AMOUNTTYPE') ?>:</div></td>
      <td width="76%"> 
        <input type="radio" class="inputbox" name="is_percent" value="1" <?php if($db->sf("is_percent")==1) echo "checked=\"checked\""; ?> />
        <?php echo JText::_('JM_PRODUCT_DISCOUNT_ISPERCENT') ?>&nbsp;&nbsp;&nbsp;
        ...
        <?php echo JText::_('JM_PRODUCT_DISCOUNT_ISTOTAL') ?>
      </td>
    </tr>
    <tr> 
      <td width="24%"><div align="right"><?php echo JText::_('JM_PRODUCT_DISCOUNT_STARTDATE') ?>:</div></td>
      <td width="76%"> 
        ...
        <?php echo vmToolTip( JText::_('JM_PRODUCT_DISCOUNT_STARTDATE_TIP') ); ?>
      </td>
    </tr>
    <tr> 
      <td width="24%"><div align="right"><?php echo JText::_('JM_PRODUCT_DISCOUNT_ENDDATE') ?>:</div></td>
      <td width="76%"> 
        ...
        <?php echo vmToolTip( JText::_('JM_PRODUCT_DISCOUNT_ENDDATE_TIP') ); ?>
      </td>
    </tr>
    <tr> 
