...
$mainframe->setPageTitle( JText::_('JM_ADD_SHIPTO_1') ." ".JText::_('JM_ADD_SHIPTO_2') );
...
if( stristr( $next_page, 'checkout' ) !== false ) {
	...
	$pathway[] = $vm_mainframe->vmPathwayItem( JText::_('JM_USER_FORM_SHIPTO_LBL'), $sess->url( SECUREURL."index.php?page=$next_page") );
	$pathway[] = $vm_mainframe->vmPathwayItem( JText::_('JM_SHOPPER_FORM_SHIPTO_LBL') );
}
