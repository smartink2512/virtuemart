...
$columns = Array(  "#" => "width=\"20\"", 
					...
					JText::_('VM_SHIPPING_RATE_LIST_CARRIER_LBL') => '',
					JText::_('VM_SHIPPING_RATE_LIST_RATE_NAME') => '',
					JText::_('VM_SHIPPING_RATE_LIST_RATE_WSTART') => '',
					JText::_('VM_SHIPPING_RATE_LIST_RATE_WEND') => '',
