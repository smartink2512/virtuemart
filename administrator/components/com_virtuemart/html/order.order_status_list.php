...
$listObj->writeSearchHeader(JText::_('JM_ORDER_STATUS_LIST_MNU'), "", $modulename, "order_status_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					JText::_('JM_ORDER_STATUS_LIST_NAME') => '',
					JText::_('JM_ORDER_STATUS_LIST_CODE') => '',
