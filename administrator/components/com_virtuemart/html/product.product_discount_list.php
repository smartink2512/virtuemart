...
$listObj->writeSearchHeader(JText::_('JM_PRODUCT_DISCOUNT_LIST_LBL'), IMAGEURL."ps_image/percentage.png", $modulename, "product_discount_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					JText::_('JM_PRODUCT_DISCOUNT_AMOUNT') => '',
					JText::_('JM_PRODUCT_DISCOUNT_AMOUNTTYPE') => '',
					JText::_('JM_PRODUCT_DISCOUNT_STARTDATE') => '',
					JText::_('JM_PRODUCT_DISCOUNT_ENDDATE') => '',
...
while ($db->next_record()) {
    ...
    $tmp_cell = $db->f("is_percent")=='1' ? JText::_('JM_PRODUCT_DISCOUNT_ISPERCENT') : JText::_('JM_PRODUCT_DISCOUNT_ISTOTAL');
	$listObj->addCell( $tmp_cell );
