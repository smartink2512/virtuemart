...
$title = '<img src="'. JM_ADMIN_ICON_URL.'icon_48/jm_store_48.png" align="absmiddle" border="0" alt="Store" />'.'&nbsp;&nbsp;&nbsp;'. JText::_('JM_STORE_FORM_LBL');
  ...
  <table class="adminform">
    <tr> 
 		<td width="50%" valign="top"><br />
		  ...
		  <legend><?php echo JText::_('JM_STORE_MOD') ?></legend>
	 		<table class="adminform">
			    ...
			    <tr class="row0"> 
			      <td class="labelcell"><?php echo JText::_('JM_STORE_FORM_ZIP') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="zip" value="<?php $db->sp("zip") ?>" size="10" />
			      </td>
			    </tr>
			    <tr class="row1"> 
			      <td class="labelcell"><?php echo JText::_('JM_STORE_FORM_PHONE') ?>:</td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="vendor_phone" value="<?php $db->sp("vendor_phone") ?>" size="16" />
			      </td>
			    </tr>
			    <tr class="row0"> 
			      <td class="labelcell"><?php echo JText::_('JM_STORE_ADDRESS_FORMAT') ?>:<br />
					<?php
					echo vmToolTip(JText::_('JM_STORE_ADDRESS_FORMAT_TIP') . ':<br />
			        		<strong>{storename}</strong>: '.JText::_('JM_STORE_FORM_STORE_NAME').'<br />
			        		<strong>{address_1}</strong>: '.JText::_('JM_STORE_FORM_ADDRESS_1').'<br />
			        		<strong>{address_2}</strong>: '.JText::_('JM_STORE_FORM_ADDRESS_2').'<br />
			        		<strong>{state}</strong>: '.JText::_('JM_STORE_FORM_STATE').'<br />
			        		<strong>{statename}</strong>: '.JText::_('JM_STATE_LIST_2_CODE').'<br />
			        		<strong>{city}</strong>: '.JText::_('JM_STORE_FORM_CITY').'<br />
			        		<strong>{zip}</strong>: '.JText::_('JM_STORE_FORM_ZIP').'<br />
			        		<strong>{country}</strong>: '.JText::_('JM_STORE_FORM_COUNTRY').'<br />
			        		<strong>{phone}</strong>: '.JText::_('JM_STORE_FORM_PHONE').'<br />
			        		<strong>{fax}</strong>: '.JText::_('JM_STORE_FORM_FAX').'<br />
			        		<strong>{email}</strong>: '.JText::_('JM_STORE_FORM_EMAIL').'<br />
			        		<strong>{url}</strong>: '.JText::_('JM_PRODUCT_FORM_URL').'<br />
			        		');
			        ?>
			        </td>
			    ...
			    <tr class="row1"> 
			      <td class="labelcell"><?php echo JText::_('JM_STORE_DATE_FORMAT') ?>:
				  </td>
			      <td width="78%" > 
		  ...
		  <legend><?php echo JText::_('JM_STORE_FORM_LBL') ?></legend>
	    	  <table class="adminform">
	    		<tr class="row0"> 
			      <td class="labelcell"><?php echo JText::_('JM_STORE_FORM_FULL_IMAGE') ?>:</td>
			      <td width="78%" ><?php  
			    ...
			    <tr class="row1"> 
			      <td class="labelcell"><?php echo JText::_('JM_STORE_FORM_UPLOAD') ?>:</td>
			      <td width="78%" > 
			        <input type="file" name="vendor_full_image" size="16" />
			      </td>
			    </tr>
			    <tr class="row0"> 
			      <td class="labelcell"><?php echo JText::_('JM_STORE_FORM_MPOV') ?>: </td>
			      <td width="78%" > 
			        <input type="text" class="inputbox" name="vendor_min_pov" value="<?php $db->sp("vendor_min_pov") ?>" size="6" />
			      </td>
			    </tr>
			    <tr class="row1"> 
			      <td class="labelcell"><?php echo JText::_('JM_FREE_SHIPPING_AMOUNT') ?>: </td>
			      <td width="78%" > 
    	...
    	<td width="50%" valign="top"><br />
	      ...
	      <br />
	      <fieldset><legend><?php echo JText::_('JM_CURRENCY_DISPLAY') ?></legend>
	      <table class="adminform"><?php
				...
				?>
		    <tr class="row0"> 
		      <td class="labelcell"><?php echo JText::_('JM_STORE_FORM_CURRENCY') ?>: </td>
		      <td width="78%" > 
		        <?php $ps_html->list_currency("vendor_currency", $db->sf("vendor_currency")) ?>
		      </td>
		    </tr>
		    <tr class="row1">
		      <td class="labelcell"><?php echo JText::_('JM_CURRENCY_SYMBOL') ?>: </td>
		      <td>
		    ...
		    <tr class="row0">
		      <td class="labelcell"><?php echo JText::_('JM_CURRENCY_DECIMALS') ?>: </td>
		    ...
		    <tr class="row1">
		      <td class="labelcell"><?php echo JText::_('JM_CURRENCY_DECIMALSYMBOL') ?>: </td>
		    ...
		    <tr class="row0">
		      <td class="labelcell"><?php echo JText::_('JM_CURRENCY_THOUSANDS') ?>: </td>
		    ...
		    <tr class="row1">
		      <td class="labelcell"><?php echo JText::_('JM_CURRENCY_POSITIVE_DISPLAY') ?>: </td>
		      <td>
		        <?php 
		        ps_html::dropdown_display( 'display_style[5]', $currency_display['positive'], $currency_style_positive );
				echo vmToolTip( JText::_('JM_CURRENCY_POSITIVE_DISPLAY_TOOLTIP') ) ?>
		      </td>
		    </tr>
		    <tr class="row0">
		      <td class="labelcell"><?php echo JText::_('JM_CURRENCY_NEGATIVE_DISPLAY') ?>: </td>
		      <td>
		        <?php
		        ps_html::dropdown_display( 'display_style[6]', $currency_display['negative'], $currency_style_negative );
				echo vmToolTip( JText::_('JM_CURRENCY_NEGATIVE_DISPLAY_TOOLTIP') ) 
				?>
		      </td>
		    </tr>
		    <tr class="row1">
			    <td class="labelcell"><?php echo JText::_('JM_STORE_FORM_ACCEPTED_CURRENCIES') ?>:</td>
			    <td><?php 
			    	...
			    	echo ' '.vmToolTip( JText::_('JM_STORE_FORM_ACCEPTED_CURRENCIES_TIP') );
			     ?></td>
		    </tr>
		    </table>
		    </fieldset>
...
<fieldset>
	<legend><?php echo JText::_('JM_STORE_FORM_DESCRIPTION') ?></legend>
	<?php
	editorArea( 'editor1', $db->f("vendor_store_desc"), 'vendor_store_desc', '400', '200', '70', '15' );
    ?>
</fieldset>
<fieldset>
	<legend><?php echo JText::_('JM_STORE_FORM_TOS') ?></legend>
    <?php
