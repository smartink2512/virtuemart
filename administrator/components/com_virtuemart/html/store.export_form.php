...
$formObj = &new formFactory( JText::_('JM_EXPORT_MODULE_FORM_LBL') );
//Then Start the form
$formObj->startForm();
...
$tabs->startTab( JText::_('JM_EXPORT_MODULE_FORM_LBL'), 'global-page');
?>
<table class="adminform">
    ...
    <tr class="row1"> 
      <td class="labelcell"><?php echo JText::_('JM_EXPORT_MODULE_FORM_NAME') ?>:</td>
      <td width="69%" > 
      <?php if ($db->f('iscore')) {
      	$db->sp('export_name');
      } else {?>
   ...
   <tr class="row0"> 
      <td class="labelcell"><?php echo JText::_('JM_EXPORT_MODULE_FORM_DESC') ?>:</td>
      <td width="69%" > 
      <?php if ($db->f('iscore')) {
    ...
    <tr class="row1">
      ...
      echo JText::_('JM_EXPORT_CLASS_NAME');
          ?>
      </td>
      <td width="69%">
      <?php if ($db->f('iscore')) {
      	...
      	echo mm_ToolTip( JText::_('JM_EXPORT_CLASS_NAME_TIP') ); 
      }?>
      </td>
    </tr>
...
echo '<br />
<strong>'.JText::_('JM_EXPORT_CONFIG').':';
echo mm_ToolTip( JText::_('JM_EXPORT_CONFIG_TIP') )
	?>
<br />
