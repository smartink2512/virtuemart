...
$listObj->writeSearchHeader(JText::_('JM_CREDITCARD_LIST_LBL'), JM_ADMIN_ICON_URL .'icon_48'.DS.'jm_credit_48.png', $modulename, "creditcard_list");
...
$columns = Array(  "#" => "width=\"20\"", 
					...
					JText::_('JM_CREDITCARD_NAME') => '',
					JText::_('JM_CREDITCARD_CODE') => '',
