...
//     var $vendor_image_path   		= '';
    ...
    function __construct(&$db) {
		...
		$this->setLoggable();
		$this->setTranslatable(array('vendor_store_name','vendor_phone','vendor_store_desc','vendor_terms_of_service','vendor_legal_info','vendor_url', 'vendor_letter_css', 'vendor_letter_header_html', 'vendor_letter_footer_html'));
