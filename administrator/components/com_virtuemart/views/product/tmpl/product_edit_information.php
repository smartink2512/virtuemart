                            ...
                            <table class="adminlist">
								...
								foreach ($this->product_childs as $child) {
                                    ...
                                    <tr class="row<?php echo $i ?>">
                                        ...
                                        <td><input type="text" class="inputbox" name="childs[<?php echo $child->virtuemart_product_id ?>][mprices][product_price][]" size="10" value="<?php echo $child->product_price ?>"/>
                                            <input type="hidden" name="childs[<?php echo $child->virtuemart_product_id ?>][mprices][virtuemart_product_price_id][]" value="<?php echo $child->virtuemart_product_price_id?>" />
                                        </td>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        // that it can be called when adding new productPriceBody
        jQuery("#xxproductPriceBody").bind("sortupdate", function (event, ui) {
    ...
    jQuery(document).ready(function ($) {
        ...
        jQuery("#xxmainPriceTable").delegate(".vmicon-16-price-remove", "click", function () {
            ...
            var numRows = jQuery('#mainPriceTable tr').length;
            if (numRows == 1) {
                // if only one row is left, then cannot remove
                //jQuery(this).removeClass("vmicon-16-price-remove");
