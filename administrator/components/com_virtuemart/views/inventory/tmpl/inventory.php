...
if(JRequest::getInt('allproducts', 1) == 0) {
	$link = JRoute::_("index.php?option=".$option."&view=inventory&task=inventory");
	echo JHTML::_('link', $link, JText::_('VM_LIST_ALL_PRODUCTS'), array('onClick' =>'document.adminForm.allproducts.value=1;document.adminForm.submit();return false;'));
	echo '&nbsp;&nbsp;|&nbsp;&nbsp;';
	...
	echo '&nbsp;&nbsp;|&nbsp;&nbsp;';
	echo JHTML::_('link', $link, JText::_('VM_HIDE_OUT_OF_STOCK'), array('onClick' => 'document.adminForm.allproducts.value=0;document.adminForm.submit();return false;'));
}
...
<input type="hidden" name="allproducts" value="<?php echo JRequest::getInt('allproducts', 1); ?>" />
