...
<fieldset>
	...
	<tr>
		...
		<?php echo vHtml::tooltip(vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_ENABLE_TIP'), vmText::_('COM_VIRTUEMART_ADMIN_CFG_FEED_ENABLE_TIP')); ?>
	...
	<tr>
		...
		echo vHtml::_('Select.genericlist', $options, 'feed_description_type', 'size=1', 'value', 'text', $this->config->get('feed_description_type'));
		?>
	    </td>
	</tr>
	<tr>
