...
<table class="admintable">
    <tr>
	<td class="key"><?php echo vmText::_('COM_VIRTUEMART_UPDATE_CHECK_VERSION_INSTALLED'); ?></td>
	<td>
    ...
    <tr>
	<td class="key"><?php echo vmText::_('COM_VIRTUEMART_UPDATE_CHECK_LATEST_VERSION'); ?></td>
	<td>
	    <?php
		...
		&nbsp;[<?php echo vmText::_('COM_VIRTUEMART_UPDATE_CHECK_CHECKNOW'); ?>]</a>
		<?php
	    }
	    ?>
	    <?php
		...
		if (version_compare($this->latestVersion, VmConfig::getInstalledVersion(), '>') == 1) {
		    ?>
	    <input name="downloadbutton" id="downloadbutton" type="submit" value="<?php echo vmText::_('COM_VIRTUEMART_UPDATE_CHECK_DLUPDATE'); ?>" style="<?php echo $downloadbutton_style ?>font-weight:bold;" />
		    <?php
		}
		else {
		    // need something in the lanuage file here
		    echo '&nbsp;&nbsp;' . vmText::_('COM_VIRTUEMART_UPDATE_NONEWVERSION');
		}
	    }
	    ?>
	</td>
