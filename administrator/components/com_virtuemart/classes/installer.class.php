...
//		$extension_type = vmGet( $d, 'extension_type');
	...
	function remove($plugin_name, $folder) {
		...
		$xml_path = JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_jmart' . DS . 'plugins' . DS . $folder .  DS . $plugin_name . '.xml';
		jimport ( 'joomla.filesystem.file' );
		$path = JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_jmart'. DS . 'plugins' . DS . $folder;
