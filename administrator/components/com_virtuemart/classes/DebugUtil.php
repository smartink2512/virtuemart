...
/**
 * JMart debugging utility functions.
 *
 ...
 * JM_DEBUG_IP_ADDRESS is enabled.
 *
 * @return true if debug should be on for this client, false otherwise.
 */
function vmShouldDebug()
{
    if((DEBUG == '1') && ((JM_DEBUG_IP_ENABLED != '1') || ((JM_DEBUG_IP_ENABLED == '1') && (strcmp($_SERVER['REMOTE_ADDR'], JM_DEBUG_IP_ADDRESS) == 0))))
    {
        return true;
    }
