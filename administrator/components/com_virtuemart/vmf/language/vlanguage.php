...
class vLanguage {
	...
	public function __construct($lang = null, $debug = false)
	{
		...
		$filename = VMPATH_ROOT . "/language/overrides/$lang.override.ini";
		...
		$paths[0] = VMPATH_SITE . "/language/overrides/$lang.localise.php";
		$paths[1] = VMPATH_ADMIN . "/language/overrides/$lang.localise.php";
		$paths[2] = VMPATH_SITE . "/language/$lang/$lang.localise.php";
		$paths[3] = VMPATH_ADMIN . "/language/$lang/$lang.localise.php";
		...
		//vmdebug('__construct vLanguage ',$class);
	...
	public static function getInstance($lang, $debug = false)
	{
		...
		{
			self::$languages[$lang . $debug] = new vLanguage($lang, $debug);
		}
	 ...
	 * @since   11.1
	 */
	public static function exists($lang, $basePath = VMPATH_BASE)
	{
		static $paths = array();
	 ...
	 * @since   11.1
	 */
	public function load($extension = 'joomla', $basePath = VMPATH_BASE, $lang = null, $reload = false, $default = false)
	{
	...
	{
		$path = self::getLanguagePath(VMPATH_BASE, $lang);
		$file = $lang . '.xml';
	 ...
	 * @since   11.1
	 */
	public static function getKnownLanguages($basePath = VMPATH_BASE)
	{
	 ...
	 * @since   11.1
	 */
	public static function getLanguagePath($basePath = VMPATH_BASE, $language = null)
	{
