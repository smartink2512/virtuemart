...
class ps_order_edit {
	...
	**************************************************************************/
	...
	function pane_content($tab) {
        ...
        <tr>
          <th><?php echo($VM_LANG->_VM_ORDER_EDIT_EDIT_ORDER); ?></th>
        </tr>
      </table>
      <table class="adminlist">
		    <tr>
      		...
      		<th width="5%" align="left"><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_QUANTITY ?></th>
      		<th width="5%" align="left" colspan="2"><?php echo $VM_LANG->_VM_ORDER_EDIT_ACTIONS ?></th>
    		</tr>
    		<?php
    		$dbt = new ps_DB;
    		$db = new ps_DB;
    		...
    		while ($dbt->next_record()){
      		...
      		<tr class="<?php echo $bgcolor; ?>" valign="top">
            	...
            	<td align="left">
            		<input type="image" title="<?php echo $VM_LANG->_PHPSHOP_UPDATE ?>" 
            		src="<?php echo VM_THEMEURL ?>images/edit_f2.gif" border="0"  alt="<?php echo $VM_LANG->_PHPSHOP_UPDATE ?>" />
            ...
            <td>
          		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            		<input type="image" title="<?php echo $VM_LANG->_PHPSHOP_DELETE ?>" src="<?php echo IMAGEURL ?>ps_image/delete_f2.gif" border="0"  alt="<?php echo $VM_LANG->_PHPSHOP_DELETE ?>" />
      ...
      <table class="adminlist">
		  <tr>
      		<th><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_SHIPPING . " & " . $VM_LANG->_PHPSHOP_PAYMENT_METHOD_LIST_DISCOUNT ?></th>
      		<th width="5%" align="left"> &nbsp; </th>
      		<th width="5%" align="left" colspan="1"><?php echo $VM_LANG->_VM_ORDER_EDIT_ACTIONS ?></th>
    		</tr>
  			<?php
			if($db->f('ship_method_id') == "" OR preg_match('/^standard_shipping/', $db->f('ship_method_id'))) {
    		?>
      		<tr>
        		<td align="right"><strong><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_SHIPPING ?>: &nbsp;</strong></td>
        		<td>
          		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <td>
      		...
      		<tr>
        		<td align="right"><strong><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_SHIPPING_TAX ?>: </strong></td>
        		<td>
          		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
    		...
    		?>
      		<tr>
        		<td align="right"><strong><?php echo $VM_LANG->_PHPSHOP_COUPON_DISCOUNT ?>: </strong></td>
        		<td>
          		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            ...
            <td>
      		...
      		<tr>
        		<td align="right"><strong><?php echo $VM_LANG->_PHPSHOP_PAYMENT_METHOD_LIST_DISCOUNT ?>: </strong></td>
        		<td>
          		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
      ...
      <table class="adminlist">
		    <tr>
      		<th><?php echo $VM_LANG->_PHPSHOP_USER_FORM_BILLTO_LBL . " & " . $VM_LANG->_PHPSHOP_USER_FORM_SHIPTO_LBL  ?></th>
      		<th width="5%" align="left"> &nbsp; </th>
      		<th width="5%" align="left" colspan="1"><?php echo $VM_LANG->_VM_ORDER_EDIT_ACTIONS ?></th>
    		</tr>
    		<tr>
      		<td align="right"><strong><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_BILL_TO_LBL ?>: </strong></td>
      		<td align="right">
        		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
          		<select name="bill_to">
            		<?php
          ...
          <td>
    		...
    		<tr>
      		<td align="right"><strong><?php echo $VM_LANG->_PHPSHOP_ORDER_PRINT_SHIP_TO_LBL ?>: </strong></td>
      		<td align="right">
        		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
          		<select name="ship_to">
            		<?php
	...
	function delete_product() {
		...
		$vmLogger->info( $VM_LANG->_VM_ORDER_EDIT_PRODUCT_DELETED );
	}
	...
	function update_quantity() {
		...
		$vmLogger->info( $VM_LANG->_VM_ORDER_EDIT_QUANTITY_UPDATED );
	...
	function add_product() {
		...
		if ($add_product_validate == 1) {
         ...
         $dbp = new ps_DB;
			...
			$vmLogger->info( $VM_LANG->_VM_ORDER_EDIT_PRODUCT_ADDED );
		}
	...
	function display_form_add_product() {
		...
		$html_entete .= '<br /><br /><table class="adminlist"><tr><th>' . $VM_LANG->_VM_ORDER_EDIT_ADD_PRODUCT . '</th></tr></table>';
		$html_entete .= '<table class="adminlist"><tr>';
		$html_entete .= '<th>' . $VM_LANG->_PHPSHOP_ORDER_PRINT_NAME . '</th>';
		...
		<input type="submit" value="' . $VM_LANG->_VM_ORDER_EDIT_RETURN_PARENTS . '" />
		...
		$html_entete .= '<th>' . $VM_LANG->_PHPSHOP_PRODUCT_FORM_CUSTOM_ATTRIBUTE_LIST . '</th>';
		$html_entete .= '<th>' . $VM_LANG->_PHPSHOP_PRODUCT_FORM_ATTRIBUTE_LIST . '</th>';
		$html_entete .= '<th align="left">' . $VM_LANG->_PHPSHOP_ORDER_PRINT_QUANTITY . '</th>';
		...
		$html_table .= '<td><input type="submit" value="' . $VM_LANG->_VM_ORDER_EDIT_ADD . '" /></td></tr></table>';
	...
	function list_products($product_id) {
		...
		$display .= '<option value="-1">' . $VM_LANG->_VM_ORDER_EDIT_CHOOSE_PRODUCT . '</option>';
